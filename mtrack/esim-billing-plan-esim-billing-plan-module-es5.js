...
var EsimBillingPlanPageModule = /** @class */ (function () {
    function EsimBillingPlanPageModule() {
    }
    ...
    return EsimBillingPlanPageModule;
}());
...
var EsimBillingPlanPage = /** @class */ (function () {
    function EsimBillingPlanPage(platform, loadingController, ajaxService, router, modalController, alertController, commonService, formBuilder) {
    ...
    EsimBillingPlanPage.prototype.getsimprovider = function () {
        var _this = this;
    ...
    EsimBillingPlanPage.prototype.createForm = function () {
    ...
    EsimBillingPlanPage.prototype.clear = function () {
        this.hideSerialNo = false;
    ...
    EsimBillingPlanPage.prototype.SubmitData = function () {
        var _this = this;
        var data;
        data = {
            planid: "",
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/saveEsimBillingPlan";
    ...
    EsimBillingPlanPage.prototype.edit = function () {
        var _this = this;
        var data;
        data = {
    ...
    EsimBillingPlanPage.prototype.setValue = function () {
    ...
    EsimBillingPlanPage.prototype.delete = function () {
        var _this = this;
        var arr = [];
        arr.push({
            provider: this.selectedRow.provider,
    ...
    EsimBillingPlanPage.prototype.getdatas = function () {
        var _this = this;
        this.page = [];
    ...
    EsimBillingPlanPage.prototype.deleteModel = function () {
    ...
    EsimBillingPlanPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    EsimBillingPlanPage.prototype.ngOnInit = function () {
    ...
    EsimBillingPlanPage.prototype.ionViewWillEnter = function () {
        this.getdatas();
        this.getsimprovider();
        this.clear();
    };
    EsimBillingPlanPage.ctorParameters = function () { return [
...
//# sourceMappingURL=esim-billing-plan-esim-billing-plan-module-es5.js.map