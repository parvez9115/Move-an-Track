...
var SimChangeProviderPageModule = /** @class */ (function () {
    function SimChangeProviderPageModule() {
    }
    ...
    return SimChangeProviderPageModule;
}());
...
var SimChangeProviderPage = /** @class */ (function () {
    function SimChangeProviderPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, ete) {
    ...
    SimChangeProviderPage.prototype.createForm = function () {
        this.simchangeForm = this.formBuilder.group({
            fileupload: [""],
        });
    };
    SimChangeProviderPage.prototype.clear = function () {
        this.simchangeForm.patchValue({
            fileupload: "",
        });
    };
    SimChangeProviderPage.prototype.onFileChange = function (ev) {
        var _this = this;
    ...
    SimChangeProviderPage.prototype.Submit = function () {
        var _this = this;
    ...
    SimChangeProviderPage.prototype.ngOnInit = function () {
    ...
    SimChangeProviderPage.ctorParameters = function () { return [
...
//# sourceMappingURL=sim-change-provider-sim-change-provider-module-es5.js.map