...
var AddDeviceComponent = /** @class */ (function () {
    function AddDeviceComponent(platform, formBuilder, modalController, ajaxService, commonService, alertController) {
    ...
    AddDeviceComponent.prototype.cancelBtn = function () {
    ...
    AddDeviceComponent.prototype.submitBtn = function () {
        var _this = this;
        this.commonService.presentLoader();
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/addnewdevice";
        var body = {
        ...
        this.ajaxService.ajaxPostWithBody(url, body).subscribe(function (res) {
            if (res.message == "Device Added Successfully") {
                _this.modalController.dismiss(res.message);
    ...
    AddDeviceComponent.ctorParameters = function () { return [
...
var DeviceReplaceDetailsPageModule = /** @class */ (function () {
    function DeviceReplaceDetailsPageModule() {
    }
    ...
    return DeviceReplaceDetailsPageModule;
}());
...
var DeviceReplaceDetailsPage = /** @class */ (function () {
    function DeviceReplaceDetailsPage(platform, formBuilder, modalController, alertController, commonService, ajaxService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.alertController = alertController;
    ...
    DeviceReplaceDetailsPage.prototype.createForm = function () {
        this.returnForm = this.formBuilder.group({
            boxno: [""],
            imeino: [""],
        });
    };
    DeviceReplaceDetailsPage.prototype.clear = function () {
    ...
    DeviceReplaceDetailsPage.prototype.history = function (d) {
        var _this = this;
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.historyvalue = res;
            _this.SearchData(d);
        });
    };
    DeviceReplaceDetailsPage.prototype.addDevice = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            if (data.data == "Device Added Successfully") {
                                _this.commonService.showConfirm(data.data);
                            }
                        });
    ...
    DeviceReplaceDetailsPage.prototype.replaceModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceReplaceDetailsPage.prototype.delete = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
    ...
    DeviceReplaceDetailsPage.prototype.SearchData = function (d) {
        var _this = this;
        if (d == "history") {
    ...
    DeviceReplaceDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    DeviceReplaceDetailsPage.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    ...
    DeviceReplaceDetailsPage.prototype.ionViewWillEnter = function () {
        this.clear();
    };
    DeviceReplaceDetailsPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"] },
    ...
    return DeviceReplaceDetailsPage;
}());
...
var ReplaceComponent = /** @class */ (function () {
    function ReplaceComponent(platform, formBuilder, modalController, ajaxService, commonService, alertController) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    ReplaceComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    ReplaceComponent.prototype.addDevice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ReplaceComponent.prototype.submitBtn = function () {
        var _this = this;
        this.commonService.presentLoader();
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/replacenewdevice";
        var body = {
    ...
    ReplaceComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
...
//# sourceMappingURL=device-replace-details-device-replace-details-module-es5.js.map