...
var CertificateInvoiceDetailsPageModule = /** @class */ (function () {
    function CertificateInvoiceDetailsPageModule() {
    }
    ...
    return CertificateInvoiceDetailsPageModule;
}());
...
var CertificateInvoiceDetailsPage = /** @class */ (function () {
    function CertificateInvoiceDetailsPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService, ete, router) {
    ...
    CertificateInvoiceDetailsPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    CertificateInvoiceDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    CertificateInvoiceDetailsPage.prototype.logScrolling = function (ev) {
    ...
    CertificateInvoiceDetailsPage.prototype.clear = function () {
        var now = new Date();
    ...
    CertificateInvoiceDetailsPage.prototype.fileclear = function () {
        this.SalesinvoiceForm.patchValue({
            fileupload: "",
        });
    };
    CertificateInvoiceDetailsPage.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    CertificateInvoiceDetailsPage.prototype.getDealer = function () {
        var _this = this;
    ...
    CertificateInvoiceDetailsPage.prototype.pendinginvoice = function () {
        var _this = this;
    ...
    CertificateInvoiceDetailsPage.prototype.invoicepopup = function () {
    ...
    //   });
    // };
    CertificateInvoiceDetailsPage.prototype.onFileChange = function (ev) {
        var _this = this;
    ...
    CertificateInvoiceDetailsPage.prototype.add = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                ...
                if (this.SalesinvoiceForm.value.fileupload == "") {
                    ...
                    if (this.dataString.length == 0) {
                        ...
                        if (this.name == true && this.excellKeyValid == true) {
                            ...
                            url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + "/esim/getcertificatezohobookproductdetails";
    ...
    CertificateInvoiceDetailsPage.prototype.invoice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CertificateInvoiceDetailsPage.prototype.getdatas = function () {
        var _this = this;
        this.commonService.presentLoader();
    ...
    CertificateInvoiceDetailsPage.prototype.receivedpopup = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CertificateInvoiceDetailsPage.prototype.editinvoice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CertificateInvoiceDetailsPage.prototype.detailspop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    CertificateInvoiceDetailsPage.prototype.Download = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var link;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CertificateInvoiceDetailsPage.prototype.imeipop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CertificateInvoiceDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    CertificateInvoiceDetailsPage.prototype.newfunc = function () {
    ...
    CertificateInvoiceDetailsPage.prototype.ngOnInit = function () {
    ...
    CertificateInvoiceDetailsPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    CertificateInvoiceDetailsPage.prototype.ionViewWillEnter = function () {
        this.clear();
        this.getDealer();
        this.getdatas();
        this.pendinginvoice();
    };
    CertificateInvoiceDetailsPage.ctorParameters = function () { return [
    ...
    return CertificateInvoiceDetailsPage;
}());
    ...
    ReceivedDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            console.log(res);
            {
                ...
                var imeiArray = JSON.parse(_this.receivedetail.imei);
                var imeiValue = imeiArray[0].imei;
...
//# sourceMappingURL=certificate-invoice-details-certificate-invoice-details-module-es5.js.map