...
let SktExcellPageModule = class SktExcellPageModule {
};
...
let SktExcellPage = class SktExcellPage {
    constructor(commonService, ajaxService, formBuilder, platform) {
            ...
            reader.onload = (event) => {
                ...
                if (String(Object.keys(jsonData)[0]) == "Sheet1") {
                    for (let i = 0; i < jsonData["Sheet1"].length; i++) {
                        let newData = {};
                        newData["StudentName"] = String(jsonData["Sheet1"][i]["Student Name"] || "");
                        if (isNaN(jsonData["Sheet1"][i]["Roll No"]) &&
                            String(jsonData["Sheet1"][i]["Roll No"] || "") != "") {
                            this.commonService.showConfirm("Roll Number Only Enter Numeric Value");
                            this.clear();
                            break;
                        }
                        newData["RollNo"] = String(jsonData["Sheet1"][i]["Roll No"] || "");
                        newData["ParentName"] = String(jsonData["Sheet1"][i]["Parent Name"] || "");
                        newData["ParentMobileNumber"] = String(jsonData["Sheet1"][i]["Parent Mobile Number"] || "");
                        newData["ParentEmail"] = String(jsonData["Sheet1"][i]["Parent Email"] || "");
        ...
        if (this.selectedValue == "Old") {
            if (this.excelform.value.pickup.length == "" ||
                ...
                if (this.dataString.length == 0) {
                    ...
                    if (this.name == true && this.excellKeyValid == true) {
                        ...
                        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/student/upload/old/excel";
            ...
            if (this.dataString.length == 0) {
                ...
                if (this.name == true && this.excellKeyValid == true) {
                    ...
                    const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/student/upload/new/excel";
                    this.ajaxService.ajaxPostWithBody(url, data).subscribe((res) => {
                        this.commonService.dismissLoader();
                        this.clear();
                        this.commonService.showConfirm(res.message);
...
//# sourceMappingURL=skt-skt-excell-skt-excell-module-es2015.js.map