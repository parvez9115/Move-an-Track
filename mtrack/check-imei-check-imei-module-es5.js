...
var CheckImeiPageModule = /** @class */ (function () {
    function CheckImeiPageModule() {
    }
...
var CheckImeiPage = /** @class */ (function () {
    function CheckImeiPage(alertController, commonService, ajaxService, location, platform, formBuilder) {
    ...
    CheckImeiPage.prototype.closePage = function () {
        this.location.back();
    };
    CheckImeiPage.prototype.delete_imei = function (ImeiDetail, type) {
                                            ...
                                            if (type == "imei") {
                                                ...
                                                _this.ajaxService.ajaxDeleteWithString(url).subscribe(function (res) {
                                                    ...
                                                    if (res.message == "success") {
                                                        _this.reportData = "";
                                                        _this.commonService.presentToast("Successfully deleted");
                                                ...
                                                var url2 = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
                                                    "/global/delete/company?companyId=" +
                                                    ImeiDetail.companyId;
                                                _this.ajaxService.ajaxDeleteWithString(url2).subscribe(function (res) {
                                                    if (res.error.text == "deleted") {
                                                        _this.getCompanyID();
                                                        _this.showCompany = false;
                                                    ...
                                                    _this.numberSearch.reset();
                                                });
                                            }
                                        }
                                        else {
                                            _this.commonService.presentToast("dealer password is wrong");
                                        }
                                    },
                                },
                            ],
    ...
    CheckImeiPage.prototype.submit = function () {
        var _this = this;
        if (this.numberSearch.value.commonNumber.length == 15) {
            ...
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
                ...
                _this.numberSearch.reset();
                if (res.length == 0) {
                    _this.commonService.presentToast("Imei not available");
                }
            });
        }
            ...
            var url2 = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
                ...
                this.numberSearch.value.commonNumber;
            this.ajaxService.ajaxGet(url2).subscribe(function (res) {
                if (res.contact == "-" || Object.keys(res).length == 0) {
                    _this.commonService.presentToast("Mobile number not available");
                    _this.mobileNumber = "";
                    _this.commonService.dismissLoader();
                }
                else {
                    _this.mobileNumber = res;
                    _this.commonService.dismissLoader();
                }
                _this.numberSearch.reset();
            });
            ...
            this.ajaxService.ajaxGet(url2).subscribe(function (res) {
                if (res) {
                    ...
                    _this.commonService.presentToast("Company not available");
                }
                _this.numberSearch.reset();
            });
        }
    ...
    CheckImeiPage.prototype.deleteCompany = function (comp) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    CheckImeiPage.prototype.doInfinite = function (event) {
        var _this = this;
        //console.log("event trigger")
        setTimeout(function () {
            var _a;
            //console.log(this.commonData)
            (_a = _this.displayData).push.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.commonData.slice(_this.currentPage * _this.displayCount, (_this.currentPage + 1) * _this.displayCount)));
            _this.currentPage++;
            event.target.complete();
            if (_this.displayData.length == _this.commonData.length) {
                event.target.disabled = true;
            }
            //console.log("DISPLAY DATA----------------------\n", this.displayData)
        }, 500);
    };
    CheckImeiPage.prototype.setDisplayData = function () {
    ...
    CheckImeiPage.prototype.getCompanyID = function () {
        var _this = this;
        this.commonService.presentLoader();
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.commonData = res;
            _this.companyName = res;
            _this.commonService.dismissLoader();
            _this.setDisplayData();
        });
    };
    CheckImeiPage.prototype.getImeiMobileNumber = function (data) {
    ...
    CheckImeiPage.prototype.ionViewWillEnter = function () {
        this.mobileNumber = "";
        this.reportData = "";
    };
    CheckImeiPage.prototype.ngOnInit = function () {
        this.getCompanyID();
    ...
    CheckImeiPage.ctorParameters = function () { return [
...
//# sourceMappingURL=check-imei-check-imei-module-es5.js.map