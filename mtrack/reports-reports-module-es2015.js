...
let MapModalComponent = class MapModalComponent {
    constructor(modalController, mapService, ajaxService) {
    ...
    getFromAddress(lat, lng) {
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/login/company/latlngtoaddress/" + lat + "/" + lng + "/" + localStorage.corpId;
...
/* harmony import */ var ionic_selectable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ionic-selectable */ "./node_modules/ionic-selectable/esm2015/ionic-selectable.min.js");
...
let ReportsPage = class ReportsPage {
    constructor(ajaxService, modalController, activatedRoute, platform, menuController) {
        this.ajaxService = ajaxService;
        this.modalController = modalController;
