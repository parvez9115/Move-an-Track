...
var DeviceCommandsPageRoutingModule = /** @class */ (function () {
    function DeviceCommandsPageRoutingModule() {
    }
    ...
    return DeviceCommandsPageRoutingModule;
}());
...
var DeviceCommandsPageModule = /** @class */ (function () {
    function DeviceCommandsPageModule() {
    }
    ...
    return DeviceCommandsPageModule;
}());
...
var DeviceCommandsPage = /** @class */ (function () {
    function DeviceCommandsPage(formBuilder, ajaxService, commonService, router) {
    ...
    DeviceCommandsPage.prototype.getBack = function () {
        this.router.navigateByUrl('/tabs-login/new-dashboard');
    };
    DeviceCommandsPage.prototype.onCompanyTrigger = function ($event, companyList) {
        var _this = this;
        this.getCompany = true;
        var selectedCompany = this.deviceCommand.value.companyId;
        var userId = {
            companyid: selectedCompany.companyId
        };
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["serverUrl"].web + '/api/vts/superadmin/company/assets/' + JSON.stringify(userId);
        this.ajaxService.ajaxGet(url)
            .subscribe(function (res) {
            _this.companyVehicle = res;
        });
    };
    DeviceCommandsPage.prototype.clearMsgBox = function () {
    ...
    DeviceCommandsPage.prototype.sendCommand = function () {
        var _this = this;
        var commandValue = '';
        ...
        if (commandValue != '') {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["serverUrl"].Admin + '/api/device/command';
            this.commonService.presentLoader();
            this.ajaxService.ajaxPostMethod(url, JSON.stringify(deviceConfig))
                .subscribe(function (res) {
                if (res.error.text == "pending" || "Sended") {
                    _this.commonService.presentToast('Command sent');
                    _this.deviceCommand.reset();
                    _this.commonService.dismissLoader();
                }
                else {
                    _this.commonService.presentToast('Command not worked!');
                    _this.commonService.dismissLoader();
                }
            });
        }
    ...
    DeviceCommandsPage.prototype.getCompanyList = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["serverUrl"].web + '/global/getcompanylist?suffix=' + localStorage.companySuffix;
        this.ajaxService.ajaxGet(url)
            .subscribe(function (res) {
            _this.companyList = res;
        });
    };
    DeviceCommandsPage.prototype.getVehiclelist = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["serverUrl"].web + '/global/getlistofvehiclesinfo?companyId=' + this.deviceCommand.value.companyId.companyName;
        this.ajaxService.ajaxGet(url)
            .subscribe(function (res) {
            _this.companyVehicle = res;
            if (res.length > 0) {
                _this.getCompany = true;
            }
            else {
                _this.commonService.presentToast('No vehicle in this company');
            }
        });
    };
    DeviceCommandsPage.prototype.getCommands = function (commands) {
    ...
    DeviceCommandsPage.prototype.validateCommand = function () {
        if (this.deviceCommand.value.commandsType == "other") {
    ...
    DeviceCommandsPage.prototype.getDefaultcommands = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["serverUrl"].web + '/login/getPreferences?key=commands&companyId=' + this.companyDetail.companyID;
        this.ajaxService.ajaxGetPerference(url)
            .subscribe(function (res) {
            _this.commandsData = res;
        });
    };
    DeviceCommandsPage.prototype.ngOnInit = function () {
        this.companyDetail = {
    ...
    DeviceCommandsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=device-commands-device-commands-module-es5.js.map