...
var CertificateGenerationComponent = /** @class */ (function () {
    function CertificateGenerationComponent(formBuilder, platform, modalController, ajaxService, commonService) {
    ...
    CertificateGenerationComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    CertificateGenerationComponent.prototype.clear = function () {
    ...
    CertificateGenerationComponent.prototype.creatFrom = function () {
    ...
    CertificateGenerationComponent.prototype.getdetails = function () {
        this.certificatedetails.patchValue({
    ...
    CertificateGenerationComponent.prototype.submit = function () {
        var _this = this;
        var data = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/global/saveCertificateDetails";
    ...
    CertificateGenerationComponent.prototype.clickToDownload = function () {
    ...
    CertificateGenerationComponent.prototype.ngOnInit = function () {
        this.creatFrom();
    ...
    CertificateGenerationComponent.ctorParameters = function () { return [
    ...
    return CertificateGenerationComponent;
}());
...
var EsimRenewalPageModule = /** @class */ (function () {
    function EsimRenewalPageModule() {
    }
...
var EsimRenewalPage = /** @class */ (function () {
    function EsimRenewalPage(platform, formBuilder, modalController, ajaxService, alertController, commonService, ete) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    EsimRenewalPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    EsimRenewalPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    EsimRenewalPage.prototype.logScrolling = function (ev) {
    ...
    EsimRenewalPage.prototype.clear = function () {
        this.show = false;
    };
    ...
    // }
    EsimRenewalPage.prototype.openModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var selectdata, arr, isSameDealerId, i, i, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(isSameDealerId && selectdata.length > 0)) return [3 /*break*/, 3];
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            if (data.data.data == "Renewal Request Saved Successfully") {
                                ...
                                _this.show = false;
                                _this.renewalstage = parseInt(data.data.renewalno) + 1;
    ...
    EsimRenewalPage.prototype.renewalconfirmModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1, alert_2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimRenewalPage.prototype.renewalinvoicepop = function () {
        var _this = this;
        if (this.zohocount != 0) {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/getrenewalzohobookproductdetails";
            this.ajaxService.ajaxPostWithBody(url, data).subscribe(function (res) {
                _this.commonService.dismissLoader();
    ...
    EsimRenewalPage.prototype.invoice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimRenewalPage.prototype.customFilter = function (c) {
        this.color = c;
        if (this.color != undefined) {
            this.getData(this.renewal);
        }
    };
    EsimRenewalPage.prototype.getData = function (d) {
        var _this = this;
        if (d == undefined) {
            this.renewal = 1;
        }
    ...
    EsimRenewalPage.prototype.viewModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    EsimRenewalPage.prototype.CommentModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isModalOpened, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    EsimRenewalPage.prototype.myGridOnRowSelect = function (event) {
        console.log(event);
    ...
    EsimRenewalPage.prototype.myGridOnRowclick = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    EsimRenewalPage.prototype.newfunc = function () {
    ...
    EsimRenewalPage.prototype.getmessage = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
    ...
    EsimRenewalPage.prototype.certificateprintpage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimRenewalPage.prototype.clickToDownload = function () {
        // this.generatedcertificate();
        var printWindow = window.open("height=1000,width=900");
        printWindow.document.write("<html>");
        // printWindow.document.write("<body>");
    ...
    //   });
    // }
    EsimRenewalPage.prototype.CertificateModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isModalOpened, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimRenewalPage.prototype.ngOnInit = function () {
        var now = new Date();
    ...
    EsimRenewalPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    EsimRenewalPage.prototype.ionViewWillEnter = function () {
        this.data = undefined;
    ...
    EsimRenewalPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
    ...
    EsimTopupPopupComponent.prototype.submitBtn = function () {
        ...
        this.ajaxService.ajaxPostWithBody(url, arr).subscribe(function (res) {
            ...
            if (res.message == "Topup Request Saved Successfully") {
                ...
                _this.commonService.showConfirm(res.data);
                _this.modalController.dismiss();
                _this.button = false;
            }
        });
...
var RenewalRequestComponent = /** @class */ (function () {
    function RenewalRequestComponent(platform, formBuilder, modalController, ajaxService, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    RenewalRequestComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    RenewalRequestComponent.prototype.createForm = function () {
        this.requestForm = this.formBuilder.group({
            validity: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
    };
    RenewalRequestComponent.prototype.submitBtn = function () {
        var _this = this;
        this.commonService.presentLoader();
        this.button = true;
        var arr = [];
    ...
    RenewalRequestComponent.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    ...
    RenewalRequestComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
    ...
    return RenewalRequestComponent;
}());
...
var ShowHistoryComponent = /** @class */ (function () {
    function ShowHistoryComponent(formBuilder, modalController, ajaxService, commonService) {
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
        this.commonService = commonService;
    ...
    ShowHistoryComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    ShowHistoryComponent.prototype.getdatas = function () {
        var _this = this;
    ...
    ShowHistoryComponent.prototype.ngOnInit = function () {
        this.getdatas();
    };
    ShowHistoryComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
        { type: src_app_services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"] }
...
//# sourceMappingURL=esim-renewal-esim-renewal-module-es5.js.map