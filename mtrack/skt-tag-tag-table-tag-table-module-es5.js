...
var TagTablePage = /** @class */ (function () {
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
                                                "/tag/deletetag?tagId=" +
                                                _this.selectedRow.tagId;
                                            _this.ajaxService.ajaxDeleteWithString(url).subscribe(function (res) {
                                                if (res.message == "Deleted Successfully") {
                                                    _this.commonService.presentToast("Tag Details Deleted successfully");
    ...
    TagTablePage.prototype.getDatas = function () {
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            ...
            for (var i = 0; i < detail.length; i++) {
                _this.pdfdatas.push([detail[i].tagId, detail[i].tagType]);
            }
    ...
    TagTablePage.prototype.ionViewWillEnter = function () {
        this.getDatas();
    };
