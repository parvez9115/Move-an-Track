...
var CommentComponent = /** @class */ (function () {
    ...
    CommentComponent.prototype.submitBtn = function () {
        ...
        if (this.nexttab == 6) {
            ...
            this.ajaxService
                .ajaxPostWithString(url, JSON.stringify(data_1))
                .subscribe(function (res) {
...
var DeviceStatusUpdatePageModule = /** @class */ (function () {
    function DeviceStatusUpdatePageModule() {
    }
    ...
    return DeviceStatusUpdatePageModule;
}());
...
var DeviceStatusUpdatePage = /** @class */ (function () {
    function DeviceStatusUpdatePage(platform, formBuilder, ajaxService, commonService, modalController, alertController) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.ajaxService = ajaxService;
        this.commonService = commonService;
    ...
    DeviceStatusUpdatePage.prototype.clear = function () {
        this.statusform.patchValue({
            imeino: "",
        });
        this.show = false;
    };
    DeviceStatusUpdatePage.prototype.cardclear = function () {
    ...
    DeviceStatusUpdatePage.prototype.cardclear1 = function () {
    ...
    DeviceStatusUpdatePage.prototype.checkstatus = function () {
    ...
    DeviceStatusUpdatePage.prototype.deleteMode = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.tableData[0].cardstatus != "")) return [3 /*break*/, 3];
    ...
    DeviceStatusUpdatePage.prototype.Statusupdate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isModalOpened, modal, isModalOpened, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.tableData[0].cardactivationdate == "")) return [3 /*break*/, 4];
                    ...
                    case 4:
                        if (!(this.tableData[0].cardstatus != "")) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.modalController.getTop()];
                    case 5:
                        isModalOpened = _a.sent();
                        return [4 /*yield*/, this.modalController.create({
    ...
    DeviceStatusUpdatePage.prototype.requestdateupdate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    DeviceStatusUpdatePage.prototype.Simupdate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isModalOpened, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceStatusUpdatePage.prototype.Comment = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isModalOpened, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceStatusUpdatePage.prototype.onFileChange = function (ev, update) {
        var _this = this;
        if (update == "status update") {
            ...
            if (this.name == true) {
                ...
                reader_1.onload = function (event) {
                    ...
                    for (var i = 0; i < jsonData_1["Sheet1"].length; i++) {
                        var xlsxData = {};
                        xlsxData["imeino"] = jsonData_1["Sheet1"][i]["imeino"].toString();
                        xlsxData["cardactivationdate"] =
                            jsonData_1["Sheet1"][i]["cardactivationdate"].toString();
                        if (jsonData_1["Sheet1"][i]["cardenddate"] != undefined) {
                            xlsxData["cardenddate"] =
                                jsonData_1["Sheet1"][i]["cardenddate"].toString();
                        }
                        xlsxData["cardstatus"] =
                            jsonData_1["Sheet1"][i]["cardstatus"].toString();
                        xlsxData["comment"] = jsonData_1["Sheet1"][i]["comment"].toString();
                        json.push(xlsxData);
                    }
                    _this.dataStringstatusupdate = json;
            ...
            if (this.name == true) {
                ...
                reader_2.onload = function (event) {
                    ...
                    workBook_2 = xlsx__WEBPACK_IMPORTED_MODULE_9__["read"](data, { type: "binary" });
                    ...
                    var json = [];
                    for (var i = 0; i < jsonData_2["Sheet1"].length; i++) {
                        var xlsxData = {};
                        xlsxData["imeino"] = jsonData_2["Sheet1"][i]["imeino"].toString();
                        xlsxData["comment"] = jsonData_2["Sheet1"][i]["comment"].toString();
                        json.push(xlsxData);
                    }
                    _this.dataStringstatusupdate = json;
                    _this.output = _this.dataString.slice(0, 300).concat("...");
            ...
            if (this.name == true) {
                ...
                reader_3.onload = function (event) {
                    ...
                    workBook_3 = xlsx__WEBPACK_IMPORTED_MODULE_9__["read"](data, { type: "binary" });
                    ...
                    var json = [];
                    for (var i = 0; i < jsonData_3["Sheet1"].length; i++) {
                        var xlsxData = {};
                        xlsxData["imeino"] = jsonData_3["Sheet1"][i]["imeino"].toString();
                        xlsxData["comment"] = jsonData_3["Sheet1"][i]["comment"].toString();
                        json.push(xlsxData);
                    }
                    _this.dataStringstatusupdate = json;
                    _this.output = _this.dataString.slice(0, 300).concat("...");
            ...
            if (this.name == true) {
                ...
                reader_4.onload = function (event) {
                    ...
                    workBook_4 = xlsx__WEBPACK_IMPORTED_MODULE_9__["read"](data, { type: "binary" });
                    ...
                    var json = [];
                    for (var i = 0; i < jsonData_4["Sheet1"].length; i++) {
                        var xlsxData = {};
                        xlsxData["imeino"] = jsonData_4["Sheet1"][i]["imeino"].toString();
                        xlsxData["cardactivationdate"] =
                            jsonData_4["Sheet1"][i]["cardactivationdate"].toString();
                        if (jsonData_4["Sheet1"][i]["cardenddate"] != undefined) {
                            xlsxData["cardenddate"] =
                                jsonData_4["Sheet1"][i]["cardenddate"].toString();
                        }
                        xlsxData["cardstatus"] =
                            jsonData_4["Sheet1"][i]["cardstatus"].toString();
                        xlsxData["comment"] = jsonData_4["Sheet1"][i]["comment"].toString();
                        json.push(xlsxData);
                    }
                    _this.dataStringca = json;
                    _this.output = _this.dataString.slice(0, 300).concat("...");
    ...
    DeviceStatusUpdatePage.prototype.sendToServer = function (data, renewals) {
        var _this = this;
    ...
    DeviceStatusUpdatePage.prototype.Submit = function () {
        var _this = this;
        if (this.tab == 6) {
            this.show = false;
            this.commonService.presentLoader();
            ...
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
                if (res[0].message == "") {
                    ...
                    _this.show = false;
                    _this.commonService.dismissLoader();
                    _this.commonService.showConfirm(res[0].message);
                }
            });
        }
        else {
    ...
    DeviceStatusUpdatePage.prototype.getdatas = function (d) {
        this.page = [];
        if (d == undefined) {
            this.tab = 1;
            localStorage.setItem("tab", "1");
    ...
    DeviceStatusUpdatePage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    DeviceStatusUpdatePage.prototype.ngOnInit = function () {
    ...
    DeviceStatusUpdatePage.prototype.ionViewWillEnter = function () { };
    DeviceStatusUpdatePage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
var RequestdateUpdateComponent = /** @class */ (function () {
    function RequestdateUpdateComponent(platform, formBuilder, modalController, ajaxService, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    RequestdateUpdateComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    RequestdateUpdateComponent.prototype.createForm = function () {
        var now = new Date();
    ...
    RequestdateUpdateComponent.prototype.submitBtn = function () {
        var _this = this;
        if (this.selected == 6) {
            var data;
            data = {
            ...
            this.commonService.presentLoader();
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimCARequestDate";
            ...
            this.commonService.presentLoader();
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimRenewalRequestDate";
            this.ajaxService.ajaxPostWithBody(url, data).subscribe(function (res) {
                _this.commonService.dismissLoader();
    ...
    RequestdateUpdateComponent.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    ...
    RequestdateUpdateComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
    ...
    return RequestdateUpdateComponent;
}());
...
var StatusUpdateComponent = /** @class */ (function () {
    function StatusUpdateComponent(platform, formBuilder, modalController, ajaxService, alertController, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    StatusUpdateComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    StatusUpdateComponent.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    StatusUpdateComponent.prototype.Submit = function () {
        var _this = this;
        if (this.nexttab == 6) {
            var data = {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/esim/saveEsimCAStatus";
            this.ajaxService
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/esim/saveEsimRenewalStatus";
            this.ajaxService
                .ajaxPostWithBody(url, JSON.stringify(data_1))
                .subscribe(function (res) {
                if (res.message == "Esim Renewal Status Saved Successfully") {
                    _this.commonService.showConfirm(res.message);
                    _this.modalController.dismiss({ data: "saved success" });
    ...
    StatusUpdateComponent.prototype.setValue = function () {
    ...
    StatusUpdateComponent.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    ...
    StatusUpdateComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
...
//# sourceMappingURL=device-status-update-device-status-update-module-es5.js.map