...
let InventoryDetailsPageModule = class InventoryDetailsPageModule {
};
...
let InventoryDetailsPage = class InventoryDetailsPage {
    constructor(location, ajaxService, platform, modalController, commonService, alertController) {
    ...
    Addtracknow() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/tracknow/generateBulkTrackNow";
...
InventoryDetailsPage.ctorParameters = () => [
...
let InventoryPopupComponent = class InventoryPopupComponent {
...
InventoryPopupComponent.ctorParameters = () => [
...
let ViewCommentsComponent = class ViewCommentsComponent {
    constructor() { }
    ngOnInit() { }
};
...
//# sourceMappingURL=inventory-details-inventory-details-module-es2015.js.map