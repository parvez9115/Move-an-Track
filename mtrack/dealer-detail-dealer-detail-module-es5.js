...
var DealerDetailPageModule = /** @class */ (function () {
    function DealerDetailPageModule() {
    }
...
var DealerDetailPage = /** @class */ (function () {
    function DealerDetailPage(formBuilder, modalController, ajaxService, commonService) {
        var _this = this;
    ...
    DealerDetailPage.prototype.clear = function () {
    ...
    DealerDetailPage.prototype.reset = function () {
        this.DealerForm.patchValue({
            SerialNo: "",
        });
    };
    DealerDetailPage.prototype.getdealerlist = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
    ...
    DealerDetailPage.prototype.createForm = function () {
    ...
    DealerDetailPage.prototype.submitBtn = function () {
        var _this = this;
    ...
    DealerDetailPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
        this.show = true;
    };
    DealerDetailPage.prototype.SearchData = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.tableData = res;
            if (res.length == 0) {
                _this.commonService.showConfirm("Dealer Details not available");
                _this.show = false;
            }
            else {
                _this.details = res[0];
    ...
    DealerDetailPage.prototype.ngOnInit = function () {
        this.getdealerlist();
        this.createForm();
    };
    DealerDetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=dealer-detail-dealer-detail-module-es5.js.map