...
var CameraPage = /** @class */ (function () {
    function CameraPage(commonServices, modalCtrl, router) {
        this.commonServices = commonServices;
        this.modalCtrl = modalCtrl;
        this.router = router;
    }
    CameraPage.prototype.addDevice = function () {
    ...
    CameraPage.prototype.videoSteam = function (data) {
        if (data.devStatus == 0) {
    ...
    CameraPage.prototype.doRefresh = function () {
    ...
    CameraPage.prototype.addDevThroughWifi = function () {
        Android.wifiAccess();
    };
