...
var AddDealerDetailsComponent = /** @class */ (function () {
    function AddDealerDetailsComponent(platform, formBuilder, modalController, ajaxService, commonService, alertController) {
    ...
    AddDealerDetailsComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    AddDealerDetailsComponent.prototype.createForm = function () {
    ...
    AddDealerDetailsComponent.prototype.dealer = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/global/getesimdealerlist";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.dealerlist = res;
        });
    };
    AddDealerDetailsComponent.prototype.add = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web +
    ...
    AddDealerDetailsComponent.prototype.edit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AddDealerDetailsComponent.prototype.setValue = function () {
    ...
    AddDealerDetailsComponent.prototype.ngOnInit = function () {
        this.createForm();
        this.dealer();
    ...
    AddDealerDetailsComponent.ctorParameters = function () { return [
    ...
    return AddDealerDetailsComponent;
}());
...
var WhitelistingMasterDetailPageModule = /** @class */ (function () {
    function WhitelistingMasterDetailPageModule() {
    }
    ...
    return WhitelistingMasterDetailPageModule;
}());
...
var WhitelistingMasterDetailPage = /** @class */ (function () {
    function WhitelistingMasterDetailPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, ete) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.alertController = alertController;
    ...
    WhitelistingMasterDetailPage.prototype.getdatas = function (d) {
        var _this = this;
        if (d == undefined) {
            this.tab = "Sensorise";
        }
    ...
    WhitelistingMasterDetailPage.prototype.addModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    WhitelistingMasterDetailPage.prototype.editModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isModalOpened, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.selectedRow != "")) return [3 /*break*/, 4];
    ...
    WhitelistingMasterDetailPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    WhitelistingMasterDetailPage.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    };
    WhitelistingMasterDetailPage.prototype.ionViewWillEnter = function () {
        this.getdatas();
    };
    WhitelistingMasterDetailPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"] },
    ...
    return WhitelistingMasterDetailPage;
}());
...
//# sourceMappingURL=whitelisting-master-detail-whitelisting-master-detail-module-es5.js.map