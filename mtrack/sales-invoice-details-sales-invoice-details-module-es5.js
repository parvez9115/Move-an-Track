...
var ReceivedDetailsComponent = /** @class */ (function () {
    ...
    ReceivedDetailsComponent.prototype.submitBtn = function () {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimSalesInvoiceDetails";
        this.ajaxService
            .ajaxPostWithString(url, JSON.stringify(data))
            .subscribe(function (res) {
            if (JSON.parse(res).message == "Sales Invoice Detail Saved Successfully") {
                _this.commonService.showConfirm("Sales Invoice Detail Saved Successfully");
                _this.modalController.dismiss({
                    data: "Sales Invoice Detail Saved Successfully",
                });
            }
            else if (res.message == "Sales Invoice Detail Not Saved Successfully") {
                _this.commonService.showConfirm("Sales Invoice Detail Not Saved Successfully");
            }
            else {
    ...
    ReceivedDetailsComponent.prototype.ngOnInit = function () {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/getSingleSalesEsimInvoice?headerid=" + this.value;
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            console.log(res);
            {
                ...
                _this.receiveForm.patchValue({
                    ...
                    totalsuppliedunits: _this.receivedetail.totalsuppliedunits,
                    balanceunits: _this.receivedetail.balanceunits,
                });
            }
        });
    };
...
var SalesInvoiceDetailsPageModule = /** @class */ (function () {
    function SalesInvoiceDetailsPageModule() {
    }
    ...
    return SalesInvoiceDetailsPageModule;
}());
...
var SalesInvoiceDetailsPage = /** @class */ (function () {
    function SalesInvoiceDetailsPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService, ete, router) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.alertController = alertController;
    ...
    SalesInvoiceDetailsPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    SalesInvoiceDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    SalesInvoiceDetailsPage.prototype.logScrolling = function (ev) {
    ...
    SalesInvoiceDetailsPage.prototype.clear = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    SalesInvoiceDetailsPage.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    SalesInvoiceDetailsPage.prototype.getDealer = function () {
        var _this = this;
    ...
    SalesInvoiceDetailsPage.prototype.getserviceprovider = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + "/esim/getServiceProvider";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.provider = res;
        });
    };
    SalesInvoiceDetailsPage.prototype.getModellist = function () {
        var _this = this;
    ...
    SalesInvoiceDetailsPage.prototype.pendinginvoice = function () {
        var _this = this;
    ...
    SalesInvoiceDetailsPage.prototype.invoicepopup = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SalesInvoiceDetailsPage.prototype.add = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.commonService.presentLoader();
                url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + "/esim/getsaleszohobookproductdetails";
    ...
    SalesInvoiceDetailsPage.prototype.invoice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SalesInvoiceDetailsPage.prototype.edit = function () {
        var _this = this;
        this.button = true;
        var data;
        data = {
        ...
        this.editdata = data;
        this.commonService.presentLoader();
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + "/esim/geteditsaleszohobookproductdetails";
        this.ajaxService.ajaxPostWithBody(url, data).subscribe(function (res) {
            _this.commonService.dismissLoader();
            if (Array.isArray(res)) {
                _this.editinvoicedata = res;
                _this.clear();
                _this.button = false;
                _this.editinvoice();
            }
    ...
    SalesInvoiceDetailsPage.prototype.editinvoice = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SalesInvoiceDetailsPage.prototype.setValue = function () {
    ...
    SalesInvoiceDetailsPage.prototype.getdatas = function () {
        var _this = this;
        this.commonService.presentLoader();
    ...
    SalesInvoiceDetailsPage.prototype.receivedpopup = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SalesInvoiceDetailsPage.prototype.detailspop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SalesInvoiceDetailsPage.prototype.Download = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var link;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SalesInvoiceDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    SalesInvoiceDetailsPage.prototype.newfunc = function () {
        var data = this.tableData;
    ...
    SalesInvoiceDetailsPage.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    ...
    SalesInvoiceDetailsPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    SalesInvoiceDetailsPage.prototype.ionViewWillEnter = function () {
        this.clear();
        this.getDealer();
        this.getdatas();
        this.getModellist();
    ...
    SalesInvoiceDetailsPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"] },
    ...
    return SalesInvoiceDetailsPage;
}());
...
//# sourceMappingURL=sales-invoice-details-sales-invoice-details-module-es5.js.map