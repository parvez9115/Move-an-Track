...
var BroadcastSmsPageModule = /** @class */ (function () {
    function BroadcastSmsPageModule() {
    }
...
var BroadcastSmsPage = /** @class */ (function () {
    function BroadcastSmsPage(modalController, formBuilder, ajaxService, ete, commonService, platform) {
    ...
    BroadcastSmsPage.prototype.btnOnClick = function () {
    ...
    BroadcastSmsPage.prototype.broadCast = function () {
    ...
    BroadcastSmsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
    };
    BroadcastSmsPage.prototype.ngAfterViewInit = function () {
        this.getDatas();
    };
    BroadcastSmsPage.prototype.getDatas = function () {
        var _this = this;
        this.companyDetail = {
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.broadOdj = res;
            for (var i = 0; i < _this.broadOdj.length; i++) {
                _this.pdfdata.push([_this.broadOdj[i].category, _this.broadOdj[i].fromMobile, _this.broadOdj[i].toMobile, _this.broadOdj[i].msg, _this.broadOdj[i].eventTimeStamp, _this.broadOdj[i].serverTimeStamp]);
            }
            ...
            _this.source = { localdata: _this.broadOdj };
            _this.dataAdapter = new jqx.dataAdapter(_this.source);
            _this.columns = [
                { text: 'Category', datafield: 'category', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'From Mobile', datafield: 'fromMobile', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'To Mobile', datafield: 'toMobile', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Message', datafield: 'msg', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Event Time', datafield: 'eventTimeStamp', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Server Time', datafield: 'serverTimeStamp', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
            ];
            _this.myGrid.updatebounddata();
            _this.myGrid.unselectrow;
        });
    };
    BroadcastSmsPage.prototype.refresh = function () {
        this.getDatas();
        this.commonService.presentToast("Data refreshed successfully.");
    };
    BroadcastSmsPage.prototype.ngOnInit = function () {
    ...
    BroadcastSmsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=skt-broad-broadcast-sms-broadcast-sms-module-es5.js.map