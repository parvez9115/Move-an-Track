...
var DetailsComponent = /** @class */ (function () {
    ...
    DetailsComponent.prototype.createForm = function () {
    ...
    DetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/getSingleEsimInvoice?headerid=" + this.value;
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            console.log(res);
            {
                _this.detail = res;
                _this.detailForm.patchValue({
                    serviceprovider: _this.detail.serviceprovider,
                    invoiceno: _this.detail.invoiceno,
                    invoiceamount: _this.detail.invoiceamount,
                });
                _this.getdatas();
            }
        });
...
var EsimPurchaseDetailsPageModule = /** @class */ (function () {
    function EsimPurchaseDetailsPageModule() {
    }
    ...
    return EsimPurchaseDetailsPageModule;
}());
...
var EsimPurchaseDetailsPage = /** @class */ (function () {
    function EsimPurchaseDetailsPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService, ete) {
    ...
    EsimPurchaseDetailsPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    EsimPurchaseDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    EsimPurchaseDetailsPage.prototype.logScrolling = function (ev) {
    ...
    EsimPurchaseDetailsPage.prototype.clear = function () {
        var now = new Date();
    ...
    EsimPurchaseDetailsPage.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    EsimPurchaseDetailsPage.prototype.add = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/saveEsimPurchaseInvoiceHeader";
                        this.ajaxService.ajaxPostWithFile(url, testData).subscribe(function (res) {
                            ...
                            if (res.message == "Purchase Invoice Saved Successfully") {
                                _this.commonService.showConfirm("Purchase Invoice Saved Successfully");
                                _this.clear();
                                _this.tableData = res;
                                _this.button = false;
                                ...
                                _this.commonService.showConfirm("Purchase Invoice Detail Not Saved Successfully");
                                _this.button = false;
                            }
                            else {
                                _this.button = false;
                                _this.commonService.showConfirm("Invoice No is already persiste");
                            }
                        });
                        return [2 /*return*/];
                }
    ...
    EsimPurchaseDetailsPage.prototype.edit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var file, data, testData, api, blob, default_file, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimPurchaseDetailsPage.prototype.setValue = function () {
        this.button = false;
    ...
    EsimPurchaseDetailsPage.prototype.getdatas = function () {
        var _this = this;
        this.commonService.presentLoader();
    ...
    EsimPurchaseDetailsPage.prototype.paypopup = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimPurchaseDetailsPage.prototype.detailspop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    EsimPurchaseDetailsPage.prototype.Download = function () {
    ...
    EsimPurchaseDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    EsimPurchaseDetailsPage.prototype.getserviceprovider = function () {
        var _this = this;
    ...
    EsimPurchaseDetailsPage.prototype.newfunc = function () {
    ...
    EsimPurchaseDetailsPage.prototype.ngOnInit = function () {
    ...
    EsimPurchaseDetailsPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    EsimPurchaseDetailsPage.prototype.ionViewWillEnter = function () {
        this.clear();
        this.getdatas();
        this.getserviceprovider();
    };
    EsimPurchaseDetailsPage.ctorParameters = function () { return [
    ...
    return EsimPurchaseDetailsPage;
}());
...
var PayDetailsComponent = /** @class */ (function () {
    function PayDetailsComponent(platform, formBuilder, modalController, ajaxService, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    PayDetailsComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    PayDetailsComponent.prototype.submitBtn = function () {
        var _this = this;
        this.button = true;
        var data;
        data = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimPurchaseInvoiceDetails";
        this.ajaxService
            .ajaxPostWithString(url, JSON.stringify(data))
            .subscribe(function (res) {
            if (JSON.parse(res).message ==
                "Purchase Invoice Detail Saved Successfully") {
                _this.commonService.showConfirm("Purchase Invoice Detail Saved Successfully");
                ...
                _this.commonService.showConfirm("Your Paid Amount is greater than invoice amount");
                _this.button = false;
            }
        });
    };
    PayDetailsComponent.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    PayDetailsComponent.prototype.reset = function () {
    ...
    PayDetailsComponent.prototype.ngOnInit = function () {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/getSingleEsimInvoice?headerid=" + this.value;
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            console.log(res);
            {
                _this.paydetail = res;
                _this.productionForm.patchValue({
                    serviceprovider: _this.paydetail.serviceprovider,
                    invoiceno: _this.paydetail.invoiceno,
                    invoiceamount: _this.paydetail.invoiceamount,
                    balanceamount: _this.paydetail.balanceamount,
                    totalamountpaid: _this.paydetail.totalamountpaid,
                });
            }
        });
    };
    PayDetailsComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
...
//# sourceMappingURL=esim-purchase-details-esim-purchase-details-module-es5.js.map