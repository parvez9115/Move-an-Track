...
let EsimAddSaleComponent = class EsimAddSaleComponent {
    ...
    submitBtn() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/saveEsimSales";
...
EsimAddSaleComponent.ctorParameters = () => [
...
let EsimPrintPopupComponent = class EsimPrintPopupComponent {
    constructor(platform, formBuilder, modalController, ajaxService, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
    ...
    getaddress() {
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getStickerHeaderDetails";
        this.ajaxService.ajaxGet(url).subscribe((res) => {
            this.commonService.dismissLoader();
    ...
    getimei() {
        ...
        this.ajaxService.ajaxGet(url).subscribe((res) => {
            this.commonService.dismissLoader();
            this.imeivalue = res;
            this.printvalue = this.selectedRow;
            this.splitvalue = this.selectedRow.boxno.slice(13);
            this.sno();
            this.getaddress();
            setTimeout(() => {
                this.printModel();
    ...
    sno() {
        ...
        for (let i = 1; i <= this.imeivalue.length; i++) {
...
EsimPrintPopupComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
...
let EsimSalesDetailPageModule = class EsimSalesDetailPageModule {
};
...
let EsimSalesDetailPage = class EsimSalesDetailPage {
...
EsimSalesDetailPage.ctorParameters = () => [
...
let EsimViewSerialDeatilsComponent = class EsimViewSerialDeatilsComponent {
...
EsimViewSerialDeatilsComponent.ctorParameters = () => [
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
//# sourceMappingURL=esim-sales-detail-esim-sales-detail-module-es2015.js.map