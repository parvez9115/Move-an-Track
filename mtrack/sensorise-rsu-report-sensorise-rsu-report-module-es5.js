...
var SensoriseRsuReportPageModule = /** @class */ (function () {
    function SensoriseRsuReportPageModule() {
    }
    ...
    return SensoriseRsuReportPageModule;
}());
...
var SensoriseRsuReportPage = /** @class */ (function () {
    function SensoriseRsuReportPage(platform, modalController, alertController, commonService, ajaxService, formBuilder, ete) {
    ...
    SensoriseRsuReportPage.prototype.createForm = function () {
        var now = new Date();
    ...
    SensoriseRsuReportPage.prototype.clear = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    SensoriseRsuReportPage.prototype.Submit = function () {
        var _this = this;
        this.show = false;
    ...
    SensoriseRsuReportPage.prototype.newfunc = function () {
    ...
    SensoriseRsuReportPage.prototype.ngOnInit = function () {
    ...
    SensoriseRsuReportPage.prototype.ionViewWillEnter = function () {
        this.rsuform.reset();
        this.clear();
    };
    SensoriseRsuReportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=sensorise-rsu-report-sensorise-rsu-report-module-es5.js.map