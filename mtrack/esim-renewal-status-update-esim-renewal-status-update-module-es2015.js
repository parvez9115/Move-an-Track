...
let AddEsimRenewalStatusUpdateComponent = class AddEsimRenewalStatusUpdateComponent {
    ...
    edit() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimRenewalStatus";
        this.ajaxService
...
AddEsimRenewalStatusUpdateComponent.ctorParameters = () => [
...
let EsimRenewalStatusUpdatePageModule = class EsimRenewalStatusUpdatePageModule {
};
...
let EsimRenewalStatusUpdatePage = class EsimRenewalStatusUpdatePage {
...
EsimRenewalStatusUpdatePage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
...
let RenewalBulkstatusComponent = class RenewalBulkstatusComponent {
    constructor(platform, formBuilder, modalController, ajaxService, alertController, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
    ...
    submit() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/saveEsimBulkRenewalStatus";
        this.ajaxService
            .ajaxPostWithBody(url, JSON.stringify(data))
            .subscribe((res) => {
            if (res.message == "Esim Renewal Status Saved Successfully") {
...
RenewalBulkstatusComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
...
let RenewalHistoryDetailsComponent = class RenewalHistoryDetailsComponent {
...
RenewalHistoryDetailsComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
    { type: src_app_services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"] }
...
//# sourceMappingURL=esim-renewal-status-update-esim-renewal-status-update-module-es2015.js.map