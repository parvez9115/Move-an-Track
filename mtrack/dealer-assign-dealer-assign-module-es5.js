...
var DealerAssignPageModule = /** @class */ (function () {
    function DealerAssignPageModule() {
    }
...
var DealerAssignPage = /** @class */ (function () {
    function DealerAssignPage(platform, formBuilder, modalController, alertController, commonService, ajaxService) {
    ...
    DealerAssignPage.prototype.createForm = function () {
        this.assignForm = this.formBuilder.group({
            company: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
    };
    DealerAssignPage.prototype.clear = function () {
        this.assignForm.patchValue({
            company: "",
        });
        this.getdatas();
    };
    DealerAssignPage.prototype.getdatas = function () {
        var _this = this;
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            ...
            _this.source = { localdata: _this.tableData.vehicledetail };
    ...
    DealerAssignPage.prototype.saveModel = function () {
    ...
    DealerAssignPage.prototype.save = function () {
        var _this = this;
    ...
    DealerAssignPage.prototype.removeModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DealerAssignPage.prototype.remove = function () {
        var _this = this;
        var selectdata = this.myGrid.getselectedrowindexes();
        var arr = [];
        for (var i = 0; i < selectdata.length; i++) {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
            ...
            this.tableData.company;
        this.ajaxService.ajaxDeleteWithBody(url, arr).subscribe(function (res) {
    ...
    DealerAssignPage.prototype.myGridOnRowclick = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    DealerAssignPage.prototype.myGridOnRowSelect = function (event) {
    ...
    DealerAssignPage.prototype.ngOnInit = function () {
    ...
    DealerAssignPage.prototype.ngAfterViewInit = function () {
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    DealerAssignPage.prototype.ionViewWillEnter = function () {
        this.getdatas();
    };
    DealerAssignPage.ctorParameters = function () { return [
...
//# sourceMappingURL=dealer-assign-dealer-assign-module-es5.js.map