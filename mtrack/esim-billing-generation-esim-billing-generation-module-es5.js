...
var EsimBillingGenerationPageModule = /** @class */ (function () {
    function EsimBillingGenerationPageModule() {
    }
    ...
    return EsimBillingGenerationPageModule;
}());
...
/* harmony import */ var jqwidgets_ng_jqxgrid__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! jqwidgets-ng/jqxgrid */ "./node_modules/jqwidgets-ng/fesm5/jqwidgets-ng-jqxgrid.js");
...
var EsimBillingGenerationPage = /** @class */ (function () {
    function EsimBillingGenerationPage(loadingController, ajaxService, formBuilder, commonService) {
        var _this = this;
        ...
        this.show = false;
        this.getplanname = function (event) {
            if (event.value)
                _this.BillinggenForm.value.provider = event.value;
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
                "/esim/getProviderBillingPlan?provider=" +
                _this.BillinggenForm.value.provider;
            _this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
                _this.Planname = res;
                if (_this.Planname.length == 0) {
                    _this.showplaname = false;
                }
                else {
                    _this.reset();
                    _this.showplaname = true;
                }
            });
        };
        this.getaccountno = function (event) {
            if (event.value)
                _this.BillinggenForm.value.planname = event.value;
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
                "/esim/getProviderAccountNo?provider=" +
                _this.BillinggenForm.value.provider;
            _this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
                _this.Accountno = res;
                if (_this.Accountno.length == 0) {
                    _this.showaccountno = false;
                }
                else {
                    _this.resets();
                    _this.showaccountno = true;
                }
            });
        };
    }
    EsimBillingGenerationPage.prototype.createForm = function () {
        var now = new Date();
    ...
    EsimBillingGenerationPage.prototype.clear = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    EsimBillingGenerationPage.prototype.reset = function () {
        this.BillinggenForm.patchValue({
            planname: "",
        });
    };
    EsimBillingGenerationPage.prototype.resets = function () {
        this.BillinggenForm.patchValue({
            accountno: "",
        });
    };
    EsimBillingGenerationPage.prototype.getsimprovider = function () {
        var _this = this;
    ...
    EsimBillingGenerationPage.prototype.gettotalamount = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
    ...
    EsimBillingGenerationPage.prototype.SearchData = function () {
        var _this = this;
        this.page = [];
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getEsimBillingGeneration";
    ...
    EsimBillingGenerationPage.prototype.ngOnInit = function () {
        this.createForm();
    };
    EsimBillingGenerationPage.prototype.ionViewWillEnter = function () {
        this.getsimprovider();
        this.clear();
    };
    EsimBillingGenerationPage.ctorParameters = function () { return [
    ...
    return EsimBillingGenerationPage;
}());
...
//# sourceMappingURL=esim-billing-generation-esim-billing-generation-module-es5.js.map