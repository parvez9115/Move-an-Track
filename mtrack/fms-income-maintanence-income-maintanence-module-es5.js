...
var IncomeMaintanencePageModule = /** @class */ (function () {
    function IncomeMaintanencePageModule() {
    }
    ...
    return IncomeMaintanencePageModule;
}());
...
var IncomeMaintanencePage = /** @class */ (function () {
    function IncomeMaintanencePage(platform) {
        this.platform = platform;
        this.app = { logo: 'logo.png' };
    }
    IncomeMaintanencePage.prototype.ngOnInit = function () {
    ...
    IncomeMaintanencePage.ctorParameters = function () { return [
...
//# sourceMappingURL=fms-income-maintanence-income-maintanence-module-es5.js.map