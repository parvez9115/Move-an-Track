...
var RsuHistoryComponent = /** @class */ (function () {
    function RsuHistoryComponent(ajaxService, router, formBuilder, commonService, modalController) {
    ...
    RsuHistoryComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    RsuHistoryComponent.prototype.getdatas = function () {
        var _this = this;
    ...
    RsuHistoryComponent.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
        this.show = true;
    };
    RsuHistoryComponent.prototype.ngOnInit = function () {
        this.getdatas();
    };
    RsuHistoryComponent.ctorParameters = function () { return [
...
var SensoriseRsuStatusPageModule = /** @class */ (function () {
    function SensoriseRsuStatusPageModule() {
    }
    ...
    return SensoriseRsuStatusPageModule;
}());
...
var SensoriseRsuStatusPage = /** @class */ (function () {
    function SensoriseRsuStatusPage(platform, modalController, alertController, commonService, ajaxService, ete) {
    ...
    SensoriseRsuStatusPage.prototype.export = function () {
        var _this = this;
    ...
    SensoriseRsuStatusPage.prototype.clear = function () {
        this.myGrid.clearselection();
    };
    SensoriseRsuStatusPage.prototype.getDatas = function () {
        var _this = this;
        this.page = [];
        this.commonService.presentLoader();
    ...
    SensoriseRsuStatusPage.prototype.myGridOnRowclick = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    SensoriseRsuStatusPage.prototype.rsuhistory = function () {
    ...
    SensoriseRsuStatusPage.prototype.myGridOnRowSelect = function (event) {
    ...
    SensoriseRsuStatusPage.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    };
    SensoriseRsuStatusPage.prototype.ionViewWillEnter = function () {
        this.getDatas();
        this.clear();
    };
    SensoriseRsuStatusPage.ctorParameters = function () { return [
...
//# sourceMappingURL=sensorise-rsu-status-sensorise-rsu-status-module-es5.js.map