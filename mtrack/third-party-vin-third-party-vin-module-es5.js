...
var ThirdPartyVinPageModule = /** @class */ (function () {
    function ThirdPartyVinPageModule() {
    }
    ...
    return ThirdPartyVinPageModule;
}());
...
var ThirdPartyVinPage = /** @class */ (function () {
    function ThirdPartyVinPage(ajaxService, platform, modalController, alertController, commonService, formBuilder) {
    ...
    ThirdPartyVinPage.prototype.clear = function () {
    ...
    ThirdPartyVinPage.prototype.getlist = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/getThirdparty";
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            console.log(res);
            _this.serverlist = res;
        });
    };
    ThirdPartyVinPage.prototype.onSubmit = function () {
        var _this = this;
        this.show = false;
        ...
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            ...
            _this.show = true;
            _this.urlform.patchValue({
                thirdpartyurl: _this.apiurl.thirdpartyurl,
            });
            _this.tableData = _this.apiurl.thirdpartyvins;
            _this.getdata();
        });
    };
    ThirdPartyVinPage.prototype.refresh = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
            "/global/getThirdpartyVinsAndUrl?thirdpartyservers=" +
    ...
    ThirdPartyVinPage.prototype.add = function () {
        var _this = this;
        var data;
        data = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/saveThirdpartyVins";
        this.ajaxService
            .ajaxPostWithString(url, JSON.stringify(data))
            .subscribe(function (res) {
            if (JSON.parse(res).message == "third party vin saved successfully") {
                _this.commonService.presentToast("Third Party Vin saved successfully");
                _this.onSubmit();
    ...
    ThirdPartyVinPage.prototype.addModel = function () {
    ...
    ThirdPartyVinPage.prototype.delete = function () {
        var _this = this;
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/DeleteThirdpartyVins";
        this.ajaxService.ajaxPostWithString(url, arr).subscribe(function (response) {
            ...
            if (res.message == "third party vins removed successfully") {
                _this.commonService.showConfirm("Third Party Vins Removed Successfully");
                _this.clear();
                // this.refresh();
                // this.myGrid.clearselection();
    ...
    ThirdPartyVinPage.prototype.deleteModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ThirdPartyVinPage.prototype.myGridOnRowSelect = function (event) {
    ...
    ThirdPartyVinPage.prototype.getdata = function () {
    ...
    ThirdPartyVinPage.prototype.ngOnInit = function () {
    ...
    ThirdPartyVinPage.prototype.ionViewWillEnter = function () {
        this.thirdpartyform.reset();
        this.urlform.reset();
        this.show = false;
    };
    ThirdPartyVinPage.ctorParameters = function () { return [
...
//# sourceMappingURL=third-party-vin-third-party-vin-module-es5.js.map