...
@Component({
  ...
  templateUrl: './view-serial-details.component.html',
  styleUrls: ['./view-serial-details.component.scss'],
})
export class ViewSerialDetailsComponent implements OnInit {
  ...
  cancelBtn() {
   ...
   ngOnInit() {
    const url = serverUrl.web +'/sensorise/getSensoriseSerialNoImeiNo?companyid='+localStorage.getItem('corpId')+'&serialno='+this.value;
