...
var BulkTopupComponent = /** @class */ (function () {
    function BulkTopupComponent(platform, formBuilder, modalController, ajaxService, commonService) {
    ...
    BulkTopupComponent.prototype.createForm = function () {
        var now = new Date();
    ...
    BulkTopupComponent.prototype.clear = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    BulkTopupComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    BulkTopupComponent.prototype.submitBtn = function () {
        var _this = this;
        var arr = [];
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/saveEsimBulkTopupStatus";
    ...
    BulkTopupComponent.prototype.getdatas = function () {
    ...
    BulkTopupComponent.prototype.ngOnInit = function () {
        this.createForm();
    ...
    BulkTopupComponent.ctorParameters = function () { return [
...
var DeviceTopupStatusUpdatePageModule = /** @class */ (function () {
    function DeviceTopupStatusUpdatePageModule() {
    }
    ...
    return DeviceTopupStatusUpdatePageModule;
}());
...
var DeviceTopupStatusUpdatePage = /** @class */ (function () {
    function DeviceTopupStatusUpdatePage(ajaxService, router, formBuilder, commonService, modalController, platform, ete) {
        this.ajaxService = ajaxService;
        this.router = router;
        this.formBuilder = formBuilder;
        this.commonService = commonService;
    ...
    DeviceTopupStatusUpdatePage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    DeviceTopupStatusUpdatePage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    DeviceTopupStatusUpdatePage.prototype.logScrolling = function (ev) {
    ...
    DeviceTopupStatusUpdatePage.prototype.getdatas = function () {
        var _this = this;
    ...
    DeviceTopupStatusUpdatePage.prototype.openModel = function (row) {
    ...
    DeviceTopupStatusUpdatePage.prototype.bulkstatusModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    DeviceTopupStatusUpdatePage.prototype.myGridOnRowclick = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    DeviceTopupStatusUpdatePage.prototype.myGridOnRowSelect = function (event) {
    ...
    DeviceTopupStatusUpdatePage.prototype.newfunc = function () {
    ...
    DeviceTopupStatusUpdatePage.prototype.ngOnInit = function () { };
    DeviceTopupStatusUpdatePage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    DeviceTopupStatusUpdatePage.prototype.ionViewWillEnter = function () {
    ...
    DeviceTopupStatusUpdatePage.ctorParameters = function () { return [
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
    ...
    return DeviceTopupStatusUpdatePage;
}());
...
var ExtendCommentComponent = /** @class */ (function () {
    ...
    ExtendCommentComponent.prototype.submitBtn = function () {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimTopupStatus";
...
//# sourceMappingURL=device-topup-status-update-device-topup-status-update-module-es5.js.map