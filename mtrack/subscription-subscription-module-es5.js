...
var SubscriptionReportComponent = /** @class */ (function () {
    function SubscriptionReportComponent(ete, modalController, platform, commonService) {
        this.ete = ete;
    ...
    SubscriptionReportComponent.prototype.updateSubscription = function (data) {
    ...
    SubscriptionReportComponent.prototype.exportToExcel = function () {
        var reportData = {
            title: 'Subscription',
            data: this.pdfdatas,
            headers: this.head
    ...
    SubscriptionReportComponent.prototype.createPdf = function () {
        var _this = this;
        var doc = new jspdf__WEBPACK_IMPORTED_MODULE_6__["jsPDF"]('landscape', "px", 'a1');
    ...
    SubscriptionReportComponent.prototype.doInfinite = function (event) {
        var _this = this;
        var data = [];
        console.log("event trigger");
        setTimeout(function () {
            var _a;
            console.log(_this.subcription);
            (_a = _this.subcription).push.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.showList.slice(_this.currentPage * _this.count, (_this.currentPage + 1) * _this.count)));
            _this.currentPage++;
    ...
    SubscriptionReportComponent.prototype.setDisplayData = function () {
    ...
    SubscriptionReportComponent.prototype.ionViewWillEnter = function () {
    ...
    SubscriptionReportComponent.prototype.ngOnChanges = function () {
    ...
    SubscriptionReportComponent.prototype.ngOnInit = function () {
    ...
    SubscriptionReportComponent.ctorParameters = function () { return [
    ...
    return SubscriptionReportComponent;
}());
...
var SubscriptionPage = /** @class */ (function () {
    function SubscriptionPage(commonService, ajaxService, countries, router, modalController, ete, platform) {
        this.commonService = commonService;
    ...
    SubscriptionPage.prototype.getExpriyDates = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + '/login/getPreferences?key=subcriptionDropdown&companyId=""';
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            console.log(res);
            _this.subscriptionDates = res;
        });
    };
    SubscriptionPage.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SubscriptionPage.prototype.submit = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + '/global/getExpiryList';
        var jsonData = {
    ...
    SubscriptionPage.prototype.addDays = function (dateObj, numDays) {
    ...
    SubscriptionPage.prototype.subscriptionData = function (ev) {
        var data = Number(ev.detail.value);
        var t = new Date();
        var currentmonth = t.getMonth() + 1;
        var todayDate = t.getFullYear() + '-' + currentmonth + '-' + t.getDate();
