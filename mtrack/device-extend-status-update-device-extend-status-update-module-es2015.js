...
let BulkExtendComponent = class BulkExtendComponent {
    ...
    submitBtn() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/saveEsimBulkExtendOneYearStatus";
...
BulkExtendComponent.ctorParameters = () => [
...
let DeviceExtendStatusUpdatePageModule = class DeviceExtendStatusUpdatePageModule {
};
...
let DeviceExtendStatusUpdatePage = class DeviceExtendStatusUpdatePage {
...
DeviceExtendStatusUpdatePage.ctorParameters = () => [
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
...
let ExtendCommentComponent = class ExtendCommentComponent {
    ...
    submitBtn() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimExtendOneYearStatus";
...
//# sourceMappingURL=device-extend-status-update-device-extend-status-update-module-es2015.js.map