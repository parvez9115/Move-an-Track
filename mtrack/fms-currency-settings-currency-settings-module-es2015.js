...
let CurrencySettingsPageModule = class CurrencySettingsPageModule {
};
...
let CurrencySettingsPage = class CurrencySettingsPage {
    ...
    submitBtn() {
        ...
        if (!this.value) {
            ...
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].fmsUrl + '/currency/fmsSaveCurrencySettings';
...
CurrencySettingsPage.ctorParameters = () => [
...
//# sourceMappingURL=fms-currency-settings-currency-settings-module-es2015.js.map