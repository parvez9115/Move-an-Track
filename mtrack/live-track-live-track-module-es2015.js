...
let AkmessagesComponent = class AkmessagesComponent {
    constructor() {
...
const routes = [{ path: "", component: _components_akmessages_akmessages_component__WEBPACK_IMPORTED_MODULE_8__["AkmessagesComponent"] }];
...
let liveTrackPage = class liveTrackPage {
    constructor(formBuilder, ajaxService, router, commonService) {
    ...
    onSubmit() {
        ...
        this.ajaxService.ajaxPostWithString(url, data).subscribe((response) => {
            ...
            if (this.Data.message == "Link Not Available") {
                ...
                localStorage.setItem("staticIOData", JSON.stringify(this.Data.staticIODatas));
                setTimeout(() => {
