...
@Component({
  ...
  templateUrl: './ais-dashboard.page.html',
  styleUrls: ['./ais-dashboard.page.scss'],
})
export class AisDashboardPage implements OnInit {
  dashboard;
  total;
  myPlatform;
...
res = {"count":{"total":"100","open":"20","escalated":"10","resolved":"70"},
...
{"alertid":"52887578738","regno":"TN 22 BW 8905","drivername":"Gokul","driverno":"8736886876","status":"open"}]}}
  ...
  vehicleOdometer(data) {
   ...
   vehicleSummaries(statusType, categories, data, color) {
    ...
    var table = async function (datas){
      if(datas != ''){
        const pmodal = await modal.create({
