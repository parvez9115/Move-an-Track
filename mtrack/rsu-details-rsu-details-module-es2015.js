...
let RenewalDetailsComponent = class RenewalDetailsComponent {
    ...
    submit() {
        ...
        if (this.value) {
            ...
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + '/sensorise/SensoriseICCIDDetailSave';
    ...
    editmethod() {
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + '/sensorise/getSensoriseICCIDDetail?companyid=apm&iccid=' + this.value;
...
RenewalDetailsComponent.ctorParameters = () => [
...
let RSUDetailsPageModule = class RSUDetailsPageModule {
};
...
let RSUDetailsPage = class RSUDetailsPage {
    ...
    submitBtn() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + '/sensorise/saveSensoriseRSURequest?companyid=apm&branchid=apm&dealer=' + localStorage.getItem('userName') + '&rsustatus=';
...
//# sourceMappingURL=rsu-details-rsu-details-module-es2015.js.map