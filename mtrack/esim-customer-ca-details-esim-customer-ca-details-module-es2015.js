...
let AssignDealerComponent = class AssignDealerComponent {
    ...
    getdata() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getAssignimei";
    ...
    getdealer() {
        ...
        const companyUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/getdealerlist?suffix=" + suffix;
...
AssignDealerComponent.ctorParameters = () => [
...
let CertificateCreationComponent = class CertificateCreationComponent {
    constructor(formBuilder, platform, modalController, document, ajaxService, commonService) {
        this.formBuilder = formBuilder;
        this.platform = platform;
        this.modalController = modalController;
    ...
    submit() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/saveCertificateDetails";
...
CertificateCreationComponent.ctorParameters = () => [
...
let CompanyCreationComponent = class CompanyCreationComponent {
    ...
    newFleetCreation(res) {
        if (res) {
            if (res.Message === "Company added successfully.") {
                ...
                const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/newFleetCreation";
    ...
    newCompanyCreation(data) {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/companyCreation";
    ...
    onSubmit() {
        if (this.addCompany.controls.companyId.value == "") {
            ...
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/site/NewVehicleCreation";
            this.ajaxService.ajaxPostWithBody(url, data).subscribe((res) => {
    ...
    getCompanyID() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/global/getdealercompanylist?suffix=" + this.suffix;
        this.ajaxService.ajaxGet(url).subscribe((res) => {
...
CompanyCreationComponent.ctorParameters = () => [
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
...
let ConfirmPopupComponent = class ConfirmPopupComponent {
    constructor(ajaxService, router, commonService, formBuilder, modalController) {
        this.ajaxService = ajaxService;
        this.router = router;
        this.commonService = commonService;
        this.formBuilder = formBuilder;
...
let CustomerRenewalRequestComponent = class CustomerRenewalRequestComponent {
    constructor(platform, formBuilder, modalController, ajaxService, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
...
CustomerRenewalRequestComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
...
let DealerlistComponent = class DealerlistComponent {
...
DealerlistComponent.ctorParameters = () => [
...
let EndUserCreationComponent = class EndUserCreationComponent {
    constructor(ajaxService, router, commonService, formBuilder, modalController) {
        this.ajaxService = ajaxService;
        this.router = router;
        this.commonService = commonService;
...
EndUserCreationComponent.ctorParameters = () => [
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: src_app_services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let EsimCustomerCaDetailsPageModule = class EsimCustomerCaDetailsPageModule {
};
...
let EsimCustomerCaDetailsPage = class EsimCustomerCaDetailsPage {
    constructor(platform, formBuilder, modalController, ajaxService, commonService, ete, alertController) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    bukinvoicepop() {
        if (this.zohocount != 0) {
            ...
            this.header = data;
            this.commonService.presentLoader();
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getrenewalzohobookproductdetails";
            this.ajaxService.ajaxPostWithBody(url, data).subscribe((res) => {
                this.commonService.dismissLoader();
    ...
    invoicepop() {
        if (this.zohocount != 0) {
            ...
            this.header = data;
            this.commonService.presentLoader();
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getextendoneyearzohobookproductdetails";
            this.ajaxService.ajaxPostWithBody(url, data).subscribe((res) => {
                this.commonService.dismissLoader();
                if (Array.isArray(res)) {
                    this.invoicedata = res;
    ...
    TopupCheck() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/saveEsimTopupCheck";
        this.ajaxService.ajaxPostWithBody(url, arr).subscribe((res) => {
    ...
    topupinvoicepop() {
        if (this.zohocount != 0) {
            ...
            this.header = data;
            this.commonService.presentLoader();
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/gettopupzohobookproductdetails";
            this.ajaxService.ajaxPostWithBody(url, data).subscribe((res) => {
                this.commonService.dismissLoader();
                if (Array.isArray(res)) {
                    this.invoicedata = res;
...
EsimCustomerCaDetailsPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
...
let RequestPageComponent = class RequestPageComponent {
    constructor(platform, formBuilder, modalController, ajaxService, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
...
RequestPageComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
...
let StatusDetailsComponent = class StatusDetailsComponent {
    constructor(formBuilder, modalController, ajaxService, commonService) {
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
...
StatusDetailsComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
    { type: src_app_services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"] }
...
let AssigndealerPipe = class AssigndealerPipe {
...
//# sourceMappingURL=esim-customer-ca-details-esim-customer-ca-details-module-es2015.js.map