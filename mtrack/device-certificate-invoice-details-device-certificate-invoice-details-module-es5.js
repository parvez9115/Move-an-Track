...
var DeviceCertificateInvoiceDetailsPageModule = /** @class */ (function () {
    function DeviceCertificateInvoiceDetailsPageModule() {
    }
    ...
    return DeviceCertificateInvoiceDetailsPageModule;
}());
...
var DeviceCertificateInvoiceDetailsPage = /** @class */ (function () {
    function DeviceCertificateInvoiceDetailsPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService, ete) {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    DeviceCertificateInvoiceDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    DeviceCertificateInvoiceDetailsPage.prototype.logScrolling = function (ev) {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.clear = function () {
        var now = new Date();
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.fileclear = function () {
        this.SalesinvoiceForm.patchValue({
            fileupload: "",
        });
    };
    DeviceCertificateInvoiceDetailsPage.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.getDealer = function () {
        var _this = this;
    ...
    //   });
    // };
    DeviceCertificateInvoiceDetailsPage.prototype.onFileChange = function (ev) {
        var _this = this;
        ...
        if (this.name == true) {
            ...
            reader_1.onload = function (event) {
                ...
                workBook_1 = xlsx__WEBPACK_IMPORTED_MODULE_10__["read"](data, { type: "binary" });
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.add = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.SalesinvoiceForm.value.fileupload == "")) return [3 /*break*/, 1];
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + "/esim/saveEsimCertificateInvoiceHeader";
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.edit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.SalesinvoiceForm.value.fileupload == "")) return [3 /*break*/, 5];
                        this.button = true;
                        this.showplaname = true;
                        file = this.uploader;
                        data = {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.setValue = function () {
        this.showplaname = true;
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.getdatas = function () {
        var _this = this;
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.receivedpopup = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.detailspop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.Download = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var link;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.imeipop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    DeviceCertificateInvoiceDetailsPage.prototype.newfunc = function () {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.ngOnInit = function () {
    ...
    DeviceCertificateInvoiceDetailsPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    DeviceCertificateInvoiceDetailsPage.prototype.ionViewWillEnter = function () {
        this.clear();
        this.getDealer();
        this.getdatas();
    };
    DeviceCertificateInvoiceDetailsPage.ctorParameters = function () { return [
    ...
    return DeviceCertificateInvoiceDetailsPage;
}());
...
var ReceivedDetailsComponent = /** @class */ (function () {
    ...
    ReceivedDetailsComponent.prototype.submitBtn = function () {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimCertificateInvoiceDetails";
        this.ajaxService
            .ajaxPostWithString(url, JSON.stringify(data))
            .subscribe(function (res) {
            if (JSON.parse(res).message ==
                "Certificate Invoice Detail Saved Successfully") {
                _this.commonService.showConfirm("Certificate Invoice Detail Saved Successfully");
                ...
                _this.commonService.showConfirm("Certificate Invoice Detail Not Saved Successfully");
            }
            else {
...
//# sourceMappingURL=device-certificate-invoice-details-device-certificate-invoice-details-module-es5.js.map