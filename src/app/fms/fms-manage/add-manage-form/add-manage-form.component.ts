...
@Component({
  selector: 'app-add-manage-form',
  templateUrl: './add-manage-form.component.html',
  styleUrls: ['./add-manage-form.component.scss'],
})
...
@Input() myGrid;
  ...
  assign() {
    ...
    const assignImeiTocom = {
      ...
      "imei": JSON.stringify(this.fleetLogin.value.imei),
      "checked": "false",
      "simno": JSON.stringify(this.fleetLogin.value.serialNo),
  ...
  vehicleDetails() {
    ...
    var addDetails = {
      ...
      "emailId": unCheckedValues.toString(), "imeiNo": "",
