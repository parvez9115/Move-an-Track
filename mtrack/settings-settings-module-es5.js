...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(commonService, ajaxService, route, platform, alertController) {
    ...
    SettingsPage.prototype.inItLoader = function (changer) {
    ...
    SettingsPage.prototype.changeMap = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(localStorage.mapAllowed != "undefined")) return [3 /*break*/, 5];
                        map = JSON.parse(localStorage.mapAllowed);
                        if (!(map[0].toLowerCase() == "googlemap")) return [3 /*break*/, 3];
                                ...
                                buttons: [{
                                        ...
                                        handler: function (data) {
                                            if (localStorage.map == "GoogleMap") {
                                                _this.googleMap = true;
                                            }
                                            else {
                                                _this.googleMap = false;
                                            }
                                        }
                                    },
                                    {
    ...
    SettingsPage.prototype.watchModeNeed = function (selected, status, event, json) {
        var _this = this;
        var powercut = '';
        var enginStatus = '';
        var sos = '';
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/api/vts/company/assets/update/watchmode";
        var body = {
            "vin": this.data.vin,
        ...
        this.ajaxService.ajaxPutMethod(url, body)
            ...
            _this.data["watchmode"] = statusUpdate;
            localStorage.setItem("selectedVin", JSON.stringify(_this.data));
            var data = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["storageVariable"].upDatedJsonData;
            data.liveDatas[_this.data.vin]["watchmode"] = statusUpdate;
        });
    };
    SettingsPage.prototype.toggleWatchmode = function (event) {
        var _this = this;
        var statusBitWatchmode = 0;
        ...
        this.ajaxService.ajaxPutMethod(url, body)
            ...
            if (res.length > 1) {
                ...
                if (_this.watchStatus == true) {
                    statusBitWatchmode = 1;
                }
                _this.data["watchmode"] = statusBitWatchmode;
                localStorage.setItem("selectedVin", JSON.stringify(_this.data));
                var data = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["storageVariable"].upDatedJsonData;
                data.liveDatas[_this.data.vin]["watchmode"] = statusBitWatchmode;
            }
            else {
                _this.watchStatus = !_this.watchStatus;
                _this.commonService.dismissLoader();
                _this.commonService.presentToast('Invalid credential');
            }
            _this.watchModeUpdate();
        });
    };
    SettingsPage.prototype.notificationSetting = function (enDis) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url, alert_2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!this.notification) return [3 /*break*/, 1];
                        url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/api/vts/update/company/settings/" + localStorage.corpId + "/pushNotificationStatus/Enable";
                        this.ajaxService.ajaxGetWithString(url)
                            .subscribe(function (res) {
                            _this.commonService.presentToast("Your notification enabled " + res);
                        });
                        return [3 /*break*/, 4];
                    case 1: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [{
                                ...
                                },
                                {
                                    text: 'Confirm',
                                    handler: function (data) {
                                        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/api/vts/update/company/settings/" + localStorage.corpId + "/pushNotificationStatus/Disable";
                                        _this.ajaxService.ajaxGetWithString(url)
                                            .subscribe(function (res) {
                                            _this.commonService.presentToast("Your notification disable " + res);
                                        });
                                    }
                                }]
                        })];
    ...
    SettingsPage.prototype.watchModeUpdate = function () {
        ...
        if (this.data.hasOwnProperty("watchmode") && this.data.watchmode == 0) {
            ...
            this.watchStatus = true;
            for (var i = 0; i < this.data.watchmode.toString().length; i++) {
