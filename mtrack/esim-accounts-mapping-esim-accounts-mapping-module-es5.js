...
var EsimAccountsMappingPageModule = /** @class */ (function () {
    function EsimAccountsMappingPageModule() {
    }
    ...
    return EsimAccountsMappingPageModule;
}());
...
var EsimAccountsMappingPage = /** @class */ (function () {
    function EsimAccountsMappingPage(loadingController, ajaxService, router, alertController, commonService, formBuilder) {
    ...
    EsimAccountsMappingPage.prototype.getsimprovider = function () {
        var _this = this;
    ...
    EsimAccountsMappingPage.prototype.onFileChange = function (ev) {
        var _this = this;
        ...
        if (this.name == true) {
            ...
            reader_1.onload = function (event) {
                ...
                for (var i = 0; i < jsonData_1["Sheet1"].length; i++) {
                    var newData = {};
                    newData["simno"] = jsonData_1["Sheet1"][i]["simno"].toString();
                    json.push(newData);
                }
    ...
    EsimAccountsMappingPage.prototype.createForm = function () {
    ...
    EsimAccountsMappingPage.prototype.clear = function () {
    ...
    EsimAccountsMappingPage.prototype.SubmitData = function () {
        var _this = this;
        ...
        if (this.dataString.length == 0) {
            ...
            if (this.name == true && this.excellKeyValid == true) {
                ...
                this.dataString.map(function (d) {
                    data.push({
                        provider: _this.accountmapForm.value.provider,
                        accountno: _this.accountmapForm.value.accountno,
                        simno: d.simno,
                        createdby: localStorage.getItem("userName"),
                    });
                });
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/saveEsimAccountMapping";
    ...
    EsimAccountsMappingPage.prototype.getdatas = function () {
        var _this = this;
        this.page = [];
        this.commonService.presentLoader();
    ...
    EsimAccountsMappingPage.prototype.ngOnInit = function () {
        this.createForm();
    };
    EsimAccountsMappingPage.prototype.ionViewWillEnter = function () {
        this.getdatas();
        this.getsimprovider();
        this.clear();
    };
    EsimAccountsMappingPage.ctorParameters = function () { return [
    ...
    return EsimAccountsMappingPage;
}());
...
//# sourceMappingURL=esim-accounts-mapping-esim-accounts-mapping-module-es5.js.map