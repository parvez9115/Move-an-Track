...
var ForgotpassdealerComponent = /** @class */ (function () {
    function ForgotpassdealerComponent(formBuilder, modalController, ajaxService, commonService) {
    ...
    ForgotpassdealerComponent.prototype.getBack = function () {
        this.modalController.dismiss();
    };
    ForgotpassdealerComponent.prototype.submitPass = function () {
        var _this = this;
        var body = {
        ...
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + "/login/company/branch/dealer/forgetpassword";
        this.ajaxService.ajaxPostWithString(url, body)
            .subscribe(function (res) {
            console.log(res);
            if (res) {
                _this.commonService.presentToast(res);
    ...
    ForgotpassdealerComponent.prototype.ngOnInit = function () {
    ...
    ForgotpassdealerComponent.ctorParameters = function () { return [
    ...
    return ForgotpassdealerComponent;
}());
...
var LoginPage = /** @class */ (function () {
    function LoginPage(router, platform, formBuilder, alertController, menuController, ajaxService, modalController, commonService) {
        var _this = this;
        this.router = router;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this.loginCrd.userId == null ||
                    ...
                    this.ajaxService.ajaxPostWithBody(url, this.loginCrd).subscribe(function (res) {
                        if (res !== undefined) {
                            if (res.message == "Invalid User") {
                                ...
                                // else
                                if (_this.loginCrd.userId.toLowerCase() === "psdn-sa") {
                                    _this.router.navigateByUrl("/tabs-login/esim-dealer-detail");
...
var LoginPage = /** @class */ (function () {
    function LoginPage(formBuilder, ajaxService, platform, router, modalController, commonService, websocketService, menuController, alertController, authService) {
        ...
        this.submitLogin = function () {
            var login_datas = {
                compName: _this.login.value.compName.toLowerCase(),
                password: _this.login.value.password.toLowerCase(),
                compId: _this.login.value.compId.toLowerCase(),
            };
            _this.login.patchValue(login_datas);
            ...
            _this.ajaxService.ajaxPostMethod(url, body).subscribe(function (res) {
                console.log(res);
                if (res != undefined) {
                    if (res.length > 1) {
                        ...
                        if (_this.isChecked) {
                            ...
                            var remValue = {
                                compName: _this.login.value.compName,
                                password: _this.login.value.password,
                                corpid: _this.login.value.compId,
                        ...
                        // this.router.navigateByUrl("/dashboard");
                        if (_this.myPlatform != "desktop" && _environments_environment__WEBPACK_IMPORTED_MODULE_3__["serverUrl"].web.includes("mvt")) {
                            ...
                            if (res[1]["initialPage"] == "dashboard" ||
                                ...
                                _this.router.navigateByUrl("fms-dashboard");
                                localStorage.setItem("fmscurrency", res[1]["currency"]);
                                _this.menuController.enable(true);
                            }
                            else if (res[1]["initialPage"].toString().toUpperCase() == "JOBCARD") {
                                _this.router.navigateByUrl("job-card-details");
                                _this.menuController.enable(true);
                            }
                            else {
                                _this.router.navigateByUrl("ais-dashboard");
                            }
                            sessionStorage.setItem("login", "false");
                            localStorage.setItem("login", "false");
                            _this.commonService.dismissLoader();
                        }
                        var url_1 = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["serverUrl"].web +
                            "/login/getPreferences?key=pdfDownloadLogo&companyId=" +
                            _this.login.value.compId;
                        _this.ajaxService.ajaxGetPerference(url_1).subscribe(function (res) {
        ...
        this.generateOTP = function (cntrl) {
            _this.generatedOTP = Math.floor(Math.random() * 9000) + 1000;
            if (/(android|iPhone|iPad|iPod)/i.test(navigator.userAgent)) {
                if (_this.login.value.compName === "9600696008" ||
                    _this.login.value.compName === "7010017783") {
        ...
        this.sendOTP = function () {
            _this.platform.ready().then(function () {
                _this.commonService.presentLoader();
                var messageData = _this.OTPmessage + encodeURIComponent(_this.generatedOTP);
                var smsAPI = localStorage.getItem("SMSAPI");
                smsAPI = smsAPI
                    .replace("smsAPIMobileNumber", encodeURIComponent(_this.login.value.compName))
                    .replace("smsAPIMessageContent", messageData);
                _this.ajaxService.ajaxGet(smsAPI).subscribe(function (res) {
                    console.log(res);
        ...
        this.verifyOTPMethod = function (userotp, phoneNum) {
            if (phoneNum === undefined || phoneNum === "") {
                ...
                if (userotp === "" || userotp === undefined) {
                    ...
                    _this.ajaxService.ajaxGetWithBody(url).subscribe(function (res) {
                        if (res == "Unchanged") {
        ...
        this.identifyCompany = function (data) {
            if (data.indexOf("Error") !== -1 || data !== null || data !== "null") {
                ...
                _this.ajaxService.ajaxGetWithString(url).subscribe(function (res) {
                    if (res == "Unchanged") {
                        _this.commonService.presentToast("contact support team");
                    }
                    else {
    ...
    LoginPage.prototype.change_demo = function () {
        if (this.serverName.includes("Live")) {
            ...
            var urlValue = "http://" + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["host"].demo + ":8081/fleettracking";
            //urlValue = "http://"+host.localIp;
            var cacheURL = "http://" + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["host"].demo + ":8091/Admin";
            var webSocketUrl = "ws://" + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["host"].demo + ":8091";
            //webSocketUrl = host.localIp;
            var adminSocketUrl = "ws://" + _environments_environment__WEBPACK_IMPORTED_MODULE_3__["host"].demo + ":8091";
                    ...
                    switch (_a.label) {
                        case 0:
                            if (!(window.location.hash == "#/tabs-login" ||
                                window.location.hash == "#/tabs-login/members/login")) return [3 /*break*/, 4];
                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                if (!(localStorage.getItem("exitPopup") == "false" ||
                                    localStorage.getItem("exitPopup") == null)) return [3 /*break*/, 3];
                                localStorage.setItem("exitPopup", "true");
    ...
    LoginPage.prototype.demo = function () {
        // this.appName = 'demo'
        _environments_environment__WEBPACK_IMPORTED_MODULE_3__["app"].entryPoint = "unknown";
    ...
    LoginPage.prototype.ngOnInit = function () {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_3__["app"].appName == "Armoron") {
            ...
            this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
                ...
                _this.armoronApp.countryCode =
                    res[_this.armoronApp.country]["countryCode"];
...
var StudentLoginComponent = /** @class */ (function () {
    function StudentLoginComponent(formBuilder, ajaxService, platform, router, device, udid, modalController, commonService, menuController, alertController, authService, firebaseX, network) {
        var _this = this;
        this.formBuilder = formBuilder;
        this.ajaxService = ajaxService;
        this.platform = platform;
        ...
        this.generateOTP = function (cntrl) {
            _this.generatedOTP = Math.floor(Math.random() * 9000) + 1000;
            if (/(android|iPhone|iPad|iPod)/i.test(navigator.userAgent)) {
                if (_this.login.value.mobileNo === "9600696008" ||
                    _this.login.value.mobileNo === "9962139968") {
                    _this.button = "Verify";
                }
                else {
                    _this.sendOtp();
    ...
    StudentLoginComponent.prototype.verifyPhoneNo = function () {
        var _this = this;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
    ...
    StudentLoginComponent.prototype.sendOtp = function () {
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            if (res.message == "sent") {
                _this.commonService.presentToast("Your OTP is " + _this.loginOtp);
                _this.button = "Verify";
            }
            else {
    ...
    StudentLoginComponent.prototype.pushNotificationConfig = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var pushDetails;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    if (_this.network.type !== "none") {
                        if (/(android)/i.test(navigator.userAgent)) {
                            _this.firebaseX
                                ...
                                var url = _environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/alert/pushnotification";
                                _this.ajaxService
