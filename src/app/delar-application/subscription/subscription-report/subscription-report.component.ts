...
import { RenewalPage } from '../renewal/renewal.page';
...
export class SubscriptionReportComponent implements OnInit {
  ...
  head = ['SNo', 'Company ID', 'Vin', 'Plate No', 'Company Name', 'Initial Trans', 'Last Trans', 'Contact No', 'Email', 'Imei No', 'SimCard No', 'Status', 'Suffix', 'Warranty ExpiryDate'];
