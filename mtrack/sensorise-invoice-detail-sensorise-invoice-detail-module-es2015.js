...
let SensoriseInvoiceDetailPageModule = class SensoriseInvoiceDetailPageModule {
};
...
let SensoriseInvoiceDetailPage = class SensoriseInvoiceDetailPage {
    constructor(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService, ete) {
        ...
        this.getproductlist = (event) => {
            if (event.value)
                this.PurchaseForm.value.actionname = event.value;
    ...
    action() {
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/sensorise/getSensoriseActionDetails";
    ...
    add() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/sensorise/saveSensoriseInvoiceDetails";
...
SensoriseInvoiceDetailPage.ctorParameters = () => [
...
//# sourceMappingURL=sensorise-invoice-detail-sensorise-invoice-detail-module-es2015.js.map