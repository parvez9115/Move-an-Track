...
var BackendServerCredentialPageModule = /** @class */ (function () {
    function BackendServerCredentialPageModule() {
    }
    ...
    return BackendServerCredentialPageModule;
}());
...
var BackendServerCredentialPage = /** @class */ (function () {
    function BackendServerCredentialPage(platform, formBuilder, modalController, alertController, commonService, ajaxService) {
    ...
    BackendServerCredentialPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    BackendServerCredentialPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    BackendServerCredentialPage.prototype.logScrolling = function (ev) {
    ...
    BackendServerCredentialPage.prototype.clear = function () {
    ...
    BackendServerCredentialPage.prototype.createForm = function () {
    ...
    BackendServerCredentialPage.prototype.add = function () {
    ...
    BackendServerCredentialPage.prototype.edit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BackendServerCredentialPage.prototype.setValue = function () {
        this.button = false;
    ...
    BackendServerCredentialPage.prototype.getdatas = function () {
        var _this = this;
        this.commonService.presentLoader();
    ...
    BackendServerCredentialPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    BackendServerCredentialPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    BackendServerCredentialPage.prototype.ionViewWillEnter = function () {
        this.clear();
        this.getdatas();
    };
    BackendServerCredentialPage.prototype.ngOnInit = function () {
    ...
    BackendServerCredentialPage.ctorParameters = function () { return [
    ...
    return BackendServerCredentialPage;
}());
...
//# sourceMappingURL=backend-server-credential-backend-server-credential-module-es5.js.map