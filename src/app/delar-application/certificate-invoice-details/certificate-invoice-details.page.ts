...
@Component({
  ...
  templateUrl: "./certificate-invoice-details.page.html",
  styleUrls: ["./certificate-invoice-details.page.scss"],
})
export class CertificateInvoiceDetailsPage implements OnInit {
    ...
    if (this.SalesinvoiceForm.value.fileupload == "") {
      ...
      if (this.dataString.length == 0) {
        ...
        if (this.name == true && this.excellKeyValid == true) {
          ...
          const url =
            serverUrl.web + "/esim/getcertificatezohobookproductdetails";
