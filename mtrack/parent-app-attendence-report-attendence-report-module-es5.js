...
var AttendenceReportPageModule = /** @class */ (function () {
    function AttendenceReportPageModule() {
    }
    ...
    return AttendenceReportPageModule;
}());
...
var AttendenceReportPage = /** @class */ (function () {
    function AttendenceReportPage(location, formBuilder, ajaxService, commonService, router) {
    ...
    AttendenceReportPage.prototype.initDateRange = function () {
        var today = new Date();
    ...
    AttendenceReportPage.prototype.ngOnInit = function () {
        this.initDateRange();
        this.daysArr = this.createCalendar(this.date);
        this.submit();
    };
    AttendenceReportPage.prototype.submit = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + ("/parentapp/attendance?stin=12345&period=" + this.currentDate);
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            var data = res;
            _this.next = false;
            _this.date = moment__WEBPACK_IMPORTED_MODULE_4__(_this.currentDate, 'YYYY MM');
            if (_this.currentDate !== "") {
                if (_this.currentDate == data.month) {
                    //form data
                    _this.dateForm.patchValue({
                        dateFrom: data.absent,
                        presentFrom: data.present,
                        holidayFrom: data.holiday,
                    });
                    _this.daysArr = _this.createCalendar(moment__WEBPACK_IMPORTED_MODULE_4__(_this.currentDate, 'YYYY MM'));
                }
            }
            else {
                _this.commonService.presentToast("Please try again later.");
            }
        });
    };
    AttendenceReportPage.prototype.locationBack = function () {
        this.router.navigateByUrl('student-overview');
    };
    AttendenceReportPage.prototype.createCalendar = function (month) {
        var firstDay = moment__WEBPACK_IMPORTED_MODULE_4__(month).startOf('M');
    ...
    AttendenceReportPage.prototype.nextMonth = function () {
        this.date.add(1, 'M');
        this.daysArr = this.createCalendar(this.date);
        this.next = true;
    };
    AttendenceReportPage.prototype.previousMonth = function () {
        this.date.subtract(1, 'M');
        this.daysArr = this.createCalendar(this.date);
        this.next = true;
    };
    AttendenceReportPage.prototype.isAbsent = function (day) {
        if (!day) {
            return false;
        }
        var absentArr = this.dateForm.value.dateFrom;
        var dayString = day ? day.format('YYYY-MM-DD') : '';
        if (this.dateForm.valid) {
            return absentArr.includes(dayString);
        }
        return false;
    };
    AttendenceReportPage.prototype.isPresent = function (day) {
        if (!day) {
            return false;
        }
        var presentArr = this.dateForm.value.presentFrom;
        var dayString = day ? day.format('YYYY-MM-DD') : '';
        if (this.dateForm.valid) {
    ...
    AttendenceReportPage.prototype.isHoliday = function (day) {
        if (!day) {
            return false;
        }
        var holidayArr = this.dateForm.value.holidayFrom;
        var dayString = day ? day.format('YYYY-MM-DD') : '';
        if (this.dateForm.valid) {
    ...
    AttendenceReportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=parent-app-attendence-report-attendence-report-module-es5.js.map