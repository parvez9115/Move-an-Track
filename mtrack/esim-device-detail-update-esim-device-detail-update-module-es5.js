...
var EsimDeviceDetailUpdatePageModule = /** @class */ (function () {
    function EsimDeviceDetailUpdatePageModule() {
    }
    ...
    return EsimDeviceDetailUpdatePageModule;
}());
...
var EsimDeviceDetailUpdatePage = /** @class */ (function () {
    function EsimDeviceDetailUpdatePage(ajaxService, router, commonService, modalController, formBuilder, platform) {
    ...
    EsimDeviceDetailUpdatePage.prototype.clear = function (data, renewals) {
        if (data == "ca update") {
    ...
    EsimDeviceDetailUpdatePage.prototype.clears = function () {
        this.caupdateform.patchValue({
            caupdate: "",
        });
    };
    EsimDeviceDetailUpdatePage.prototype.onFileChange = function (ev, update) {
        var _this = this;
            ...
            if (this.name == true) {
                ...
                reader_1.onload = function (event) {
                    ...
                    for (var i = 0; i < jsonData_1["Sheet1"].length; i++) {
                        jsonData_1["Sheet1"][i]["imeino"] =
                            jsonData_1["Sheet1"][i]["imeino"].toString();
            ...
            if (this.name == true) {
                ...
                reader_2.onload = function (event) {
                    ...
                    for (var i = 0; i < jsonData_2["Sheet1"].length; i++) {
                        jsonData_2["Sheet1"][i]["imeino"] =
                            jsonData_2["Sheet1"][i]["imeino"].toString();
                        jsonData_2["Sheet1"][i]["renewalrequestdate"] =
                            jsonData_2["Sheet1"][i]["renewalrequestdate"].toString();
                        json.push(jsonData_2["Sheet1"][i]);
                    }
                    _this.dataStringRenewal = json;
                    _this.output = _this.dataString.slice(0, 300).concat("...");
                    // this.sendToServer(dataString);
                };
            ...
            if (this.name == true) {
                ...
                reader_3.onload = function (event) {
                    ...
                    for (var i = 0; i < jsonData_3["Sheet1"].length; i++) {
                        jsonData_3["Sheet1"][i]["imeino"] =
                            jsonData_3["Sheet1"][i]["imeino"].toString();
                        jsonData_3["Sheet1"][i]["cardactivationdate"] =
                            jsonData_3["Sheet1"][i]["cardactivationdate"].toString();
                        jsonData_3["Sheet1"][i]["cardenddate"] =
                            jsonData_3["Sheet1"][i]["cardenddate"].toString();
                        jsonData_3["Sheet1"][i]["comment"] =
                            jsonData_3["Sheet1"][i]["comment"].toString();
                        json.push(jsonData_3["Sheet1"][i]);
                    }
            ...
            if (this.name == true) {
                ...
                reader_4.onload = function (event) {
                    ...
                    for (var i = 0; i < jsonData_4["Sheet1"].length; i++) {
                        jsonData_4["Sheet1"][i]["imeino"] =
                            jsonData_4["Sheet1"][i]["imeino"].toString();
                        jsonData_4["Sheet1"][i]["cardactivationdate"] =
                            jsonData_4["Sheet1"][i]["cardactivationdate"].toString();
                        jsonData_4["Sheet1"][i]["cardenddate"] =
                            jsonData_4["Sheet1"][i]["cardenddate"].toString();
                        jsonData_4["Sheet1"][i]["cardstatus"] =
                            jsonData_4["Sheet1"][i]["cardstatus"].toString();
                        jsonData_4["Sheet1"][i]["comment"] =
                            jsonData_4["Sheet1"][i]["comment"].toString();
                        json.push(jsonData_4["Sheet1"][i]);
                    }
    ...
    EsimDeviceDetailUpdatePage.prototype.sendToServer = function (data, renewals) {
        var _this = this;
        if (data == "ca update") {
            if (this.dataString.length == 0) {
                ...
                if (this.name == true && this.excellKeyValid == true) {
                    ...
                    var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/saveEsimDetailUpdate?renewalno=";
                    this.ajaxService
    ...
    EsimDeviceDetailUpdatePage.prototype.submit = function () {
        var _this = this;
    ...
    EsimDeviceDetailUpdatePage.prototype.ionViewWillEnter = function () {
        this.clear("ca update");
        this.clear("renewal update");
        this.clear();
        this.clears();
    };
    EsimDeviceDetailUpdatePage.prototype.ngOnInit = function () {
    ...
    EsimDeviceDetailUpdatePage.ctorParameters = function () { return [
    ...
    return EsimDeviceDetailUpdatePage;
}());
...
//# sourceMappingURL=esim-device-detail-update-esim-device-detail-update-module-es5.js.map