...
var DeviceRenewalInvoiceDetailsPageModule = /** @class */ (function () {
    function DeviceRenewalInvoiceDetailsPageModule() {
    }
    ...
    return DeviceRenewalInvoiceDetailsPageModule;
}());
...
var DeviceRenewalInvoiceDetailsPage = /** @class */ (function () {
    function DeviceRenewalInvoiceDetailsPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService, ete) {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    DeviceRenewalInvoiceDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    DeviceRenewalInvoiceDetailsPage.prototype.logScrolling = function (ev) {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.clear = function () {
        var now = new Date();
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.fileclear = function () {
        this.SalesinvoiceForm.patchValue({
            fileupload: "",
        });
    };
    DeviceRenewalInvoiceDetailsPage.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.getDealer = function () {
        var _this = this;
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.onFileChange = function (ev) {
        var _this = this;
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.add = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/saveEsimRenewalInvoiceHeader";
                        this.ajaxService.ajaxPostWithFile(url, testData).subscribe(function (res) {
                            if (res.message == "Renewal Invoice Saved Successfully") {
                                _this.commonService.showConfirm("Renewal Invoice Saved Successfully");
                                _this.clear();
                                _this.tableData = res;
                                ...
                                _this.commonService.showConfirm("Renewal Invoice Not Saved Successfully");
                                _this.button = false;
                                _this.clear();
                            }
                            else {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.edit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.setValue = function () {
        this.showplaname = true;
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.getdatas = function () {
        var _this = this;
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.receivedpopup = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.detailspop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.imeipop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.Download = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var link;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    DeviceRenewalInvoiceDetailsPage.prototype.newfunc = function () {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.ngOnInit = function () {
    ...
    DeviceRenewalInvoiceDetailsPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    DeviceRenewalInvoiceDetailsPage.prototype.ionViewWillEnter = function () {
        this.clear();
        this.getDealer();
        this.getdatas();
    };
    DeviceRenewalInvoiceDetailsPage.ctorParameters = function () { return [
    ...
    return DeviceRenewalInvoiceDetailsPage;
}());
...
//# sourceMappingURL=device-renewal-invoice-details-device-renewal-invoice-details-module-es5.js.map