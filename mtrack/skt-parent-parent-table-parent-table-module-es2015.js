...
let ParentTablePageModule = class ParentTablePageModule {
};
...
let ParentTablePage = class ParentTablePage {
    constructor(modalController, ajaxService, alertController, platform, commonService, ete) {
    ...
    getData() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/parent/parentdetails";
...
ParentTablePage.ctorParameters = () => [
...
//# sourceMappingURL=skt-parent-parent-table-parent-table-module-es2015.js.map