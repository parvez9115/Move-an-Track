...
var RSURequestPageModule = /** @class */ (function () {
    function RSURequestPageModule() {
    }
...
var RSURequestPage = /** @class */ (function () {
    function RSURequestPage(formBuilder, modalController, ajaxService, commonService) {
    ...
    RSURequestPage.prototype.clear = function () {
    ...
    RSURequestPage.prototype.getsalesDistributors = function () {
        var _this = this;
    ...
    RSURequestPage.prototype.getrequestList = function () {
        var _this = this;
        ...
        this.ajaxService.ajaxGetPerference(url)
            .subscribe(function (res) {
            _this.RequestList = res;
        });
    };
    RSURequestPage.prototype.createForm = function () {
    ...
    RSURequestPage.prototype.submitBtn = function () {
        var _this = this;
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + '/sensorise/saveSensoriseCARequest?companyid=apm&branchid=apm';
        this.ajaxService.ajaxPostWithBody(url, arr).subscribe(function (res) {
            if (res.message == "CA Request Saved Successfully") {
                _this.commonService.showConfirm('CA Request Saved Successfully');
    ...
    RSURequestPage.prototype.Approvevalue = function (event) {
        var _this = this;
        var selectdata = this.myGrid.getselectedrowindexes();
        var arr = [];
        for (var i = 0; i < selectdata.length; i++) {
        ...
        this.ajaxService.ajaxPostWithString(url, arr).subscribe(function (response) {
            ...
            if (res.message == "RSU Request Saved Successfully") {
                ...
                _this.commonService.showConfirm('Renewal Saved Successfully');
                _this.modalController.dismiss();
                _this.clear();
            }
            else {
    ...
    RSURequestPage.prototype.myGridOnRowSelect = function (event) {
    ...
    RSURequestPage.prototype.SearchData = function () {
        var _this = this;
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.tableData = res;
            if (res.length == 0) {
                _this.commonService.showConfirm("Rsu Request Detail not available");
                _this.show = false;
            }
            else {
                _this.show = true;
                ...
                _this.columns = [
                    { text: 'RSU Request ID', datafield: 'rsurequestid', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 210 },
                    { text: 'RSU Request Date', datafield: 'rsurequestdate', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 210 },
                    { text: 'RSU Request Status', datafield: 'rsustatus', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 210 },
                    ...
                    { text: 'Distributor', datafield: 'distributor', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 210 },
                    { text: 'SR Number', datafield: 'srno', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 210 },
                    { text: 'SR Date', datafield: 'srdate', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 210 },
                    { text: 'SR Status', datafield: 'srstatus', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 210 },
                ];
            }
        });
    };
    RSURequestPage.prototype.ngOnInit = function () {
    ...
    RSURequestPage.ctorParameters = function () { return [
...
//# sourceMappingURL=rsu-request-rsu-request-module-es5.js.map