...
var EsimDashboardPageModule = /** @class */ (function () {
    function EsimDashboardPageModule() {
    }
    ...
    return EsimDashboardPageModule;
}());
...
var EsimDashboardPage = /** @class */ (function () {
    function EsimDashboardPage(router, platform) {
        this.router = router;
    ...
    EsimDashboardPage.prototype.ngOnInit = function () {
    ...
    EsimDashboardPage.prototype.logOutFunction = function (router) {
    ...
    EsimDashboardPage.ctorParameters = function () { return [
...
//# sourceMappingURL=esim-dashboard-esim-dashboard-module-es5.js.map