...
var AddProductionComponent = /** @class */ (function () {
    function AddProductionComponent(formBuilder, modalController, ajaxService, commonService) {
        var _this = this;
    ...
    AddProductionComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    AddProductionComponent.prototype.submitBtn = function () {
        var _this = this;
        var data;
        data = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + '/sensorise/saveSensoriseProduction?companyid=' + localStorage.getItem('corpId') + '&branchid=' + localStorage.getItem('corpId');
        this.ajaxService.ajaxPostWithBody(url, data).subscribe(function (res) {
            if (res.message == "Production Saved Successfully") {
                _this.commonService.showConfirm('Production Added Succesfully');
    ...
    AddProductionComponent.prototype.click = function () {
        var _this = this;
        if (this.productionForm.value.imeiNo == '') {
            ...
            if (this.myGrid)
                this.myGrid['attrSource']['originaldata'].map(function (res) {
                    if (res.imei == _this.productionForm.value.imeiNo)
                        show_1 = false;
                });
            if (show_1) {
                {
                    var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + '/sensorise/getSingleSensoriseManufactureByImei?companyid=' + localStorage.getItem('corpId') + '&imei=' + this.productionForm.value.imeiNo;
    ...
    AddProductionComponent.prototype.deleteAnalogRow = function (row) {
        this.tableData.splice(row, 1);
        this.source = { localdata: this.tableData };
        this.Qty = this.tableData.length;
        this.dataAdapter = new jqx.dataAdapter(this.source);
    };
    AddProductionComponent.prototype.createForm = function () {
    ...
    AddProductionComponent.prototype.reset = function () {
        this.productionForm.patchValue({
            SerialNo: this.serial,
            imeiNo: "",
        });
    };
    AddProductionComponent.prototype.getModellist = function () {
        var _this = this;
    ...
    AddProductionComponent.prototype.ngOnInit = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + '/sensorise/generateSerialno?companyid=' + localStorage.getItem('corpId');
    ...
    AddProductionComponent.ctorParameters = function () { return [
...
var ProductionDetailsPageModule = /** @class */ (function () {
    function ProductionDetailsPageModule() {
    }
    ...
    return ProductionDetailsPageModule;
}());
...
var ProductionDetailsPage = /** @class */ (function () {
    function ProductionDetailsPage(platform, modalController, alertController, commonService, ajaxService) {
    ...
    ProductionDetailsPage.prototype.getDatas = function () {
        var _this = this;
    ...
    ProductionDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
    };
    ProductionDetailsPage.prototype.viewModel = function () {
    ...
    ProductionDetailsPage.prototype.openModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    ProductionDetailsPage.prototype.ngOnInit = function () {
        this.getDatas();
    };
    ProductionDetailsPage.ctorParameters = function () { return [
...
var ViewProductionComponent = /** @class */ (function () {
    function ViewProductionComponent(ajaxService, modalController) {
        this.ajaxService = ajaxService;
        this.modalController = modalController;
    }
    ViewProductionComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    ViewProductionComponent.prototype.ngOnInit = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + '/sensorise/getSensoriseProductionDetail?companyid=' + localStorage.getItem('corpId') + '&serialno=' + this.value;
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.tableData = res;
            _this.renderer = function (row, column, value) {
                if (value == "" || null || undefined || value == ",") {
            ...
            _this.columns = [
                ...
                { text: 'Imei Number', datafield: 'imei', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Vltd SNo', datafield: 'vltdsno', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
            ];
        });
    };
    ViewProductionComponent.ctorParameters = function () { return [
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return ViewProductionComponent;
}());
...
//# sourceMappingURL=production-details-production-details-module-es5.js.map