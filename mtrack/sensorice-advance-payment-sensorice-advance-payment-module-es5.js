...
var AddPopupComponent = /** @class */ (function () {
    function AddPopupComponent(platform, formBuilder, modalController, ajaxService, commonService, alertController) {
    ...
    AddPopupComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    AddPopupComponent.prototype.edit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/sensorise/saveSensoriseAdvancePaymentDetails";
    ...
    AddPopupComponent.prototype.add = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AddPopupComponent.prototype.setValue = function () {
    ...
    AddPopupComponent.ctorParameters = function () { return [
...
var SensoriceAdvancePaymentPageModule = /** @class */ (function () {
    function SensoriceAdvancePaymentPageModule() {
    }
    ...
    return SensoriceAdvancePaymentPageModule;
}());
...
var SensoriceAdvancePaymentPage = /** @class */ (function () {
    function SensoriceAdvancePaymentPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, ete) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.alertController = alertController;
    ...
    SensoriceAdvancePaymentPage.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    SensoriceAdvancePaymentPage.prototype.addModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    SensoriceAdvancePaymentPage.prototype.editModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isModalOpened, modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SensoriceAdvancePaymentPage.prototype.balanceamt = function () {
        var _this = this;
    ...
    SensoriceAdvancePaymentPage.prototype.getdatas = function (d) {
        var _this = this;
        if (d == undefined) {
            this.tab = "newcardpurchase";
            this.balanceamt();
    ...
    SensoriceAdvancePaymentPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    SensoriceAdvancePaymentPage.prototype.newfunc = function () {
    ...
    SensoriceAdvancePaymentPage.prototype.ngAfterViewInit = function () {
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    SensoriceAdvancePaymentPage.prototype.ngOnInit = function () {
    ...
    SensoriceAdvancePaymentPage.prototype.ionViewWillEnter = function () {
        this.getdatas();
    };
    SensoriceAdvancePaymentPage.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"] },
    ...
    return SensoriceAdvancePaymentPage;
}());
...
//# sourceMappingURL=sensorice-advance-payment-sensorice-advance-payment-module-es5.js.map