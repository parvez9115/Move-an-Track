...
let OdometerHistoryPageModule = class OdometerHistoryPageModule {
};
...
let OdometerHistoryPage = class OdometerHistoryPage {
    constructor(modalController, location, ajaxService) {
    ...
    getDatas() {
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + '/device/new/odometerdetails?vin=' + this.selectedVin;
...
OdometerHistoryPage.ctorParameters = () => [
...
//# sourceMappingURL=armoron-odometer-history-odometer-history-module-es2015.js.map