...
let DeviceExtendOneyearInvoiceDetailsPageModule = class DeviceExtendOneyearInvoiceDetailsPageModule {
};
...
let DeviceExtendOneyearInvoiceDetailsPage = class DeviceExtendOneyearInvoiceDetailsPage {
            ...
            if (this.extendform.value.fileupload == "") {
                ...
                if (this.dataString.length == 0) {
                    ...
                    if (this.name == true && this.excellKeyValid == true) {
                        ...
                        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/saveEsimExtendOneYearInvoiceHeader";
...
DeviceExtendOneyearInvoiceDetailsPage.ctorParameters = () => [
...
let ReceivedExtendDetailsComponent = class ReceivedExtendDetailsComponent {
    ...
    submitBtn() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimExtendOneYearInvoiceDetails";
        this.ajaxService
            .ajaxPostWithString(url, JSON.stringify(data))
            .subscribe((res) => {
            if (JSON.parse(res).message ==
                "Extend One Year Invoice Detail Saved Successfully") {
                this.commonService.showConfirm("Extend One Year Invoice Detail Saved Successfully");
                this.modalController.dismiss({
                ...
                this.commonService.showConfirm("Extend One Year Invoice Detail Saved Not Successfully");
            }
            else {
...
ReceivedExtendDetailsComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
...
let ViewExtendDetailsComponent = class ViewExtendDetailsComponent {
...
ViewExtendDetailsComponent.ctorParameters = () => [
...
//# sourceMappingURL=device-extend-oneyear-invoice-details-device-extend-oneyear-invoice-details-module-es2015.js.map