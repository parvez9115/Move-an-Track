...
var VehicleCreationPageRoutingModule = /** @class */ (function () {
    function VehicleCreationPageRoutingModule() {
    }
    ...
    return VehicleCreationPageRoutingModule;
}());
...
var VehicleCreationPageModule = /** @class */ (function () {
    function VehicleCreationPageModule() {
    }
    ...
    return VehicleCreationPageModule;
}());
...
var VehicleCreationPage = /** @class */ (function () {
    function VehicleCreationPage(ajaxService, router, commonService, formBuilder, modalController, alertController) {
    ...
    VehicleCreationPage.prototype.omit_special_char = function (event) {
        var k;
    ...
    VehicleCreationPage.prototype.clear = function () {
    ...
    VehicleCreationPage.prototype.reset = function () {
        this.vehicleCreation.patchValue({
            companyName: "",
        });
    };
    VehicleCreationPage.prototype.checkCompany = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.addModel = function () {
    ...
    VehicleCreationPage.prototype.checkImei = function () {
    ...
    VehicleCreationPage.prototype.getModelData = function () {
        this.model = this.modelTypes[this.vehicleCreation.value.manufacture];
    };
    VehicleCreationPage.prototype.getManufactures = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
    ...
    VehicleCreationPage.prototype.getModels = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.getModelType = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
    ...
    VehicleCreationPage.prototype.addcompany = function () {
    ...
    // }
    VehicleCreationPage.prototype.createForm = function () {
        this.vehicleCreation = this.formBuilder.group({
            // loginId: ['', ],
            password: [""],
            contact: [""],
    ...
    VehicleCreationPage.prototype.getFleetManager = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.getCompanyID = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.validContact = function () {
    ...
    VehicleCreationPage.prototype.getContactList = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.getImeiNO = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.getCountries = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
    ...
    VehicleCreationPage.prototype.getCountryCode = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
    ...
    VehicleCreationPage.prototype.getImeiDetails = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
    ...
    VehicleCreationPage.prototype.newSubmit = function () {
        var _this = this;
        this.button = true;
        ...
        var countryCode = this.countryCode[this.vehicleCreation.value.country] == undefined
            ? ""
            : this.countryCode[this.vehicleCreation.value.country];
        var region = this.region[this.vehicleCreation.value.country] == undefined
            ? ""
            : this.region[this.vehicleCreation.value.country];
        setTimeout(function () {
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/site/vehicleCreation";
            var dataJson = {
                ...
                simcardNo: _this.vehicleCreation.value.simNo == null
                    ? ""
                    : _this.vehicleCreation.value.simNo.toString(),
                emailId: _this.vehicleCreation.value.email == null
                    ? ""
                    : _this.vehicleCreation.value.email.toString(),
                providerName: localStorage.getItem("companyId"),
                password: _this.vehicleCreation.value.password == null
                    ? ""
                    : _this.vehicleCreation.value.password.toString(),
                provider: _this.vehicleCreation.value.provider == null
                    ? ""
                    : _this.vehicleCreation.value.provider.toString(),
                firstName: _this.vehicleCreation.value.companyName,
                contactNo: _this.vehicleCreation.value.ContactNumber == null
                    ? ""
                    : _this.vehicleCreation.value.ContactNumber.toString(),
                countryCode: countryCode,
                additionalSimcard1: _this.vehicleCreation.value.simNo2 == null
                    ? ""
                    : _this.vehicleCreation.value.simNo2.toString(),
                additionalProvider1: _this.vehicleCreation.value.provider2 == null
                    ? ""
                    : _this.vehicleCreation.value.provider2.toString(),
                userCountry: countryCode,
                manufactureName: _this.vehicleCreation.value.manufacture == null
                    ? ""
                    : _this.vehicleCreation.value.manufacture,
                modelName: _this.vehicleCreation.value.model == null
                    ? ""
                    : _this.vehicleCreation.value.model,
                dealerId: "3",
                companyName: _this.vehicleCreation.value.companyName,
                address: _this.vehicleCreation.value.address1 == null
                    ? ""
                    : _this.vehicleCreation.value.address1,
                city: _this.vehicleCreation.value.city == null
                    ? ""
                    : _this.vehicleCreation.value.city,
                companyAdminID: "",
                region: "Asia/Kolkata",
                categoryrole: "fleetmanager",
                userCity: _this.vehicleCreation.value.city == null
                    ? ""
                    : _this.vehicleCreation.value.city,
                useraddress1: _this.vehicleCreation.value.address1 == null
                    ? ""
                    : _this.vehicleCreation.value.address1,
                useraddress2: _this.vehicleCreation.value.address2 == null
                    ? ""
                    : _this.vehicleCreation.value.address2,
                ...
                odometer: JSON.stringify(_this.vehicleCreation.value.odometer),
            };
            // let dataJson = {
            ...
            //   "showHierarchy": false
            // }
            _this.ajaxService.ajaxPostWithBody(url, dataJson).subscribe(function (res) {
    ...
    VehicleCreationPage.prototype.submit = function () {
        var _this = this;
        this.getCompanyID();
            ...
            if (this.imeiNo[i] == this.vehicleCreation.value.imeiNo + "") {
                ...
                this.ajaxService.ajaxGet(url).subscribe(function (res) {
                    ...
                    var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
                        ...
                        _this.vehicleCreation.value.companyName +
                        "&imeiNo=" +
                        _this.vehicleCreation.value.imeiNo +
                        "&simcardNo=" +
                        _this.vehicleCreation.value.simNo.toString();
                    _this.ajaxService.ajaxGet(url).subscribe(function (res) {
                        ...
                        if (res.message == "Ok") {
                            ...
                            for (i = 0; i < _this.companyId.length; i++) {
                                ...
                                else if (_this.companyId.length == i + 1 &&
                                    _this.CompanyValid != true) {
    ...
    VehicleCreationPage.prototype.addTheCompany = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.newFleetCreation = function (res) {
        var _this = this;
        if (res.Message === "Company added successfully.") {
            ...
            this.ajaxService.ajaxPostWithBody(url, fleetData).subscribe(function (res) {
    ...
    VehicleCreationPage.prototype.newCompanyCreation = function (data) {
        var _this = this;
    ...
    VehicleCreationPage.prototype.alterNewCompanySuccess = function (res) {
        // res = JSON.parse(res);
    ...
    VehicleCreationPage.prototype.addTheImei = function () {
        var _this = this;
    ...
    VehicleCreationPage.prototype.assign = function () {
        ...
        this.ajaxService.ajaxPostWithBody(url, arrayData).subscribe(function (res) {
            console.log(res);
            res = res;
    ...
    VehicleCreationPage.prototype.vehicleDetails = function () {
        var _this = this;
        var userName = this.vehicleCreation.value.companyName == null
            ? this.vehicleCreation.value.companyName
            : this.vehicleCreation.value.companyName;
        ...
        this.ajaxService.ajaxPostWithString(url, addDetails).subscribe(function (res) {
            console.log(res);
            if (res === "persisted") {
                _this.commonService.presentToast("Vehicle added Successfully!");
                var smsUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
                    "/device/initial/smsCommands?imeiNo=" +
                    _this.vehicleCreation.value.imeiNo;
                _this.ajaxService.ajaxGet(smsUrl).subscribe(function (res) { });
                _this.router.navigateByUrl("/dashboard");
                _this.vehicleCreation.reset();
                _this.show = false;
    ...
    VehicleCreationPage.prototype.generateVin = function () {
        var _this = this;
        if (this.vehicleCreation.value.imeiNo != "" ||
            this.vehicleCreation.value.imeiNo != " ") {
            var vehicleVin_1 = this.vehicleCreation.value.companyName +
    ...
    VehicleCreationPage.prototype.ionViewWillEnter = function () {
    ...
    VehicleCreationPage.prototype.ngOnInit = function () {
    ...
    VehicleCreationPage.ctorParameters = function () { return [
...
//# sourceMappingURL=vehicle-creation-vehicle-creation-module-es5.js.map