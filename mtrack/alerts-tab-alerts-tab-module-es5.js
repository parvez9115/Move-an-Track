...
var AlertsTabPageModule = /** @class */ (function () {
    function AlertsTabPageModule() {
    }
...
var AlertsTabPage = /** @class */ (function () {
    function AlertsTabPage(platform, menuController, router) {
    ...
    AlertsTabPage.prototype.searchActivity = function (task) {
        if (task == "open") {
    ...
    AlertsTabPage.prototype.clickShowSearch = function () {
        this.showSearch = !this.showSearch;
    };
    AlertsTabPage.prototype.locationBack = function () {
        this.router.navigateByUrl("student-dashboard");
    };
    AlertsTabPage.prototype.scroll = function (event) {
    ...
    AlertsTabPage.prototype.totalAlerts = function (event) {
        this.totalAlert = event;
    };
    AlertsTabPage.prototype.ionViewDidEnter = function () {
    ...
    AlertsTabPage.ctorParameters = function () { return [
...
//# sourceMappingURL=alerts-tab-alerts-tab-module-es5.js.map