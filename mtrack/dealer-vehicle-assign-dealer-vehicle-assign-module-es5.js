...
var DealerAssignRouter = /** @class */ (function () {
    function DealerAssignRouter() {
    }
...
var DealerVehicleAssignPageModule = /** @class */ (function () {
    function DealerVehicleAssignPageModule() {
    }
    ...
    return DealerVehicleAssignPageModule;
}());
...
var DealerVehicleAssignPage = /** @class */ (function () {
    function DealerVehicleAssignPage(ajaxService, router, commonService, formBuilder, alertController, platform) {
    ...
    DealerVehicleAssignPage.prototype.updateAnswer = function (event, index, imei, imeiDetail) {
    ...
    DealerVehicleAssignPage.prototype.getsalesDealer = function () {
        var _this = this;
        this.showList = [];
        this.selectedArray = [];
        ...
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            _this.SalesDealer = res;
        });
    };
    DealerVehicleAssignPage.prototype.createForm = function () {
        this.dealerForm = this.formBuilder.group({
            salesDealer: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_7__["Validators"].required],
        });
    };
    DealerVehicleAssignPage.prototype.removeCheckedFromArray = function (checkbox) {
        return this.selectedArray.findIndex(function (category) {
            return category === checkbox;
        });
    };
    DealerVehicleAssignPage.prototype.Clear = function () {
    ...
    DealerVehicleAssignPage.prototype.submit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var text, alert_1, text, alert_2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.type == "Assign")) return [3 /*break*/, 3];
                        text = "Are you sure? You want to unassign this stock to your company ";
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (confirm) {
                                            ...
                                            for (var i = 0; i < _this.selectedArray.length; i++) {
                                                arr.push({
                                                    vin: _this.selectedArray[i].vin,
                                                    companyId: "apm-ca",
                                                    userId: localStorage.userName,
                                                });
                                            }
                                            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/login/DeleteDealerVehicles";
                                            _this.ajaxService
                                                ...
                                                if (responseData.message ==
                                                    ...
                                                    _this.commonService.showConfirm(responseData.message);
                                                }
                                            });
                                        },
                                    },
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 6];
                    case 3:
                        text = "Are you sure? You want to assign this stock to your company ";
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (confirm) {
                                            ...
                                            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/login/saveDealerVehicles";
    ...
    DealerVehicleAssignPage.prototype.emptyCheckedArray = function () {
        this.selectedArray = [];
    };
    DealerVehicleAssignPage.prototype.getCheckedBoxes = function () {
        console.log(this.selectedArray);
    };
    DealerVehicleAssignPage.prototype.Submit = function () {
        this.typeSelector(this.type);
    };
    DealerVehicleAssignPage.prototype.ionViewWillEnter = function () {
        this.showList = [];
        this.companyID = "";
        this.selectedArray = [];
        this.typeSelector(this.type);
    };
    DealerVehicleAssignPage.prototype.typeSelector = function (data) {
        var _this = this;
        ...
        if (this.dealerForm.value.salesDealer == "" ||
            ...
            var url_1 = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
                ("/login/" + param + "?" + query + "userid=" + localStorage.userName + "&dealer=" + this.dealerForm.value.salesDealer);
            this.ajaxService.ajaxGet(url_1).subscribe(function (res) {
                if (res) {
                    _this.commonService.dismissLoader();
                    _this.showList = res;
                }
    ...
    DealerVehicleAssignPage.prototype.uncheckAll = function () {
        for (var i = 0; i < this.checkboxes.length; i++) {
            this.checkboxes["_results"][i].checked = false;
        }
    };
    DealerVehicleAssignPage.prototype.ngOnInit = function () {
    ...
    DealerVehicleAssignPage.ctorParameters = function () { return [
    ...
    return DealerVehicleAssignPage;
}());
...
var SearchDealerAssignPipe = /** @class */ (function () {
    function SearchDealerAssignPipe() {
    }
    SearchDealerAssignPipe.prototype.transform = function (items, terms) {
        if (!items)
            return [];
        if (!terms)
            return items;
...
//# sourceMappingURL=dealer-vehicle-assign-dealer-vehicle-assign-module-es5.js.map