...
var EsimSalesInvoiceDetailsPageModule = /** @class */ (function () {
    function EsimSalesInvoiceDetailsPageModule() {
    }
    ...
    return EsimSalesInvoiceDetailsPageModule;
}());
...
var EsimSalesInvoiceDetailsPage = /** @class */ (function () {
    function EsimSalesInvoiceDetailsPage(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService, ete) {
        var _this = this;
        ...
        this.getdevicemodellist = function (event) {
            if (event.value)
                _this.SalesinvoiceForm.value.devicemodel = event.value;
        };
    }
    EsimSalesInvoiceDetailsPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    EsimSalesInvoiceDetailsPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    EsimSalesInvoiceDetailsPage.prototype.logScrolling = function (ev) {
    ...
    EsimSalesInvoiceDetailsPage.prototype.clear = function () {
        var now = new Date();
    ...
    EsimSalesInvoiceDetailsPage.prototype.createForm = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    EsimSalesInvoiceDetailsPage.prototype.getDealer = function () {
        var _this = this;
    ...
    EsimSalesInvoiceDetailsPage.prototype.getModellist = function () {
        var _this = this;
    ...
    EsimSalesInvoiceDetailsPage.prototype.add = function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + "/esim/saveEsimSalesInvoiceHeader";
                        this.ajaxService.ajaxPostWithFile(url, testData).subscribe(function (res) {
                            if (res.message == "Sales Invoice Saved Successfully") {
                                _this.commonService.showConfirm("Sales Invoice Saved Successfully");
                                _this.clear();
                                _this.tableData = res;
                                _this.button = false;
                                _this.getdatas();
                                ...
                                _this.commonService.showConfirm("Sales Invoice Not Saved Successfully");
                                _this.button = false;
                                _this.clear();
                            }
                            else {
    ...
    EsimSalesInvoiceDetailsPage.prototype.edit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var file, data, testData, api, blob, default_file, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimSalesInvoiceDetailsPage.prototype.setValue = function () {
    ...
    EsimSalesInvoiceDetailsPage.prototype.getdatas = function () {
        var _this = this;
    ...
    EsimSalesInvoiceDetailsPage.prototype.receivedpopup = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimSalesInvoiceDetailsPage.prototype.detailspop = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    EsimSalesInvoiceDetailsPage.prototype.Download = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var link;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    EsimSalesInvoiceDetailsPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
        this.show = true;
    };
    EsimSalesInvoiceDetailsPage.prototype.newfunc = function () {
    ...
    EsimSalesInvoiceDetailsPage.prototype.ngOnInit = function () {
    ...
    EsimSalesInvoiceDetailsPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    EsimSalesInvoiceDetailsPage.prototype.ionViewWillEnter = function () {
        this.clear();
        this.getDealer();
        this.getdatas();
        this.getModellist();
    };
    EsimSalesInvoiceDetailsPage.ctorParameters = function () { return [
    ...
    return EsimSalesInvoiceDetailsPage;
}());
...
//# sourceMappingURL=esim-sales-invoice-details-esim-sales-invoice-details-module-es5.js.map