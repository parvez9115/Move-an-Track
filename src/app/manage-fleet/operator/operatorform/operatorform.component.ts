  ...
  submit() {
    if (this.serviceName != "available") {
      var data = {
        ...
        optName: this.fleetLogin.value.operatorName,
        cntctNo: JSON.stringify(this.fleetLogin.value.contact),
        faxNo: "",
        addressLine1: this.fleetLogin.value.Address1,
        addressLine2: this.fleetLogin.value.city,
        country: this.fleetLogin.value.country,
        emailId: this.fleetLogin.value.email,
        emergencyContactName: "",
        emergencyContactNumber: this.fleetLogin.value.emergencyContact + "",
      ...
      this.ajaxService.ajaxPutMethod(url, data).subscribe((res) => {
        if (res == "Operator Mobile No Already Exists") {
          this.commonService.showConfirm("Operator Mobile No Already Exists");
      ...
      var details = {
        ...
        username: this.companyDetail.userId,
        optName: this.fleetLogin.value.operatorName,
        cntctNo: this.fleetLogin.value.contact.toString(),
        faxNo: this.value.telNo.toString(),
        addressLine1: this.fleetLogin.value.Address1,
        addressLine2: this.fleetLogin.value.city,
        country: this.fleetLogin.value.country,
        emailId: this.fleetLogin.value.email,
      ...
      this.ajaxService.ajaxPostWithString(url, details).subscribe((res) => {
        ...
        if (message.message == "Operator Mobile No Already Exists") {
          this.commonService.showConfirm("Operator Mobile No Already Exists");
        } else if (message.message == "Updated Successfully") {
        ...
        buttons: [
          ...
          },
          {
            ...
            handler: (data) => {
              ...
              const url =
                serverUrl.web +
                "/operator/deleteOperatorInfo?operatorID=" +
