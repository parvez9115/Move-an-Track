...
let AddEsimCaStatusUpdateComponent = class AddEsimCaStatusUpdateComponent {
    ...
    edit() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveEsimCAStatus";
        this.ajaxService
...
AddEsimCaStatusUpdateComponent.ctorParameters = () => [
...
let BsnlBulkComponent = class BsnlBulkComponent {
    ...
    submitBtn() {
        ...
        var data = [];
        this.value.map((d) => {
            data.push(Object.assign({}, d, { validityperiod: this.requestForm.value.validity }));
        });
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/esim/saveBulkBSNLCertificatedetails";
...
BsnlBulkComponent.ctorParameters = () => [
...
let BulkstatusComponent = class BulkstatusComponent {
    constructor(platform, formBuilder, modalController, ajaxService, alertController, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
    ...
    submit() {
        ...
        var data = [];
        this.value.map((d) => {
            data.push(Object.assign({}, d, { cardactivationdate: this.bulkStatusform.value.cardactivationdate, cardenddate: "", cardstatus: this.bulkStatusform.value.cardstatus, comment: this.bulkStatusform.value.comment }));
        });
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/saveEsimBulkCAStatus";
        this.ajaxService
            .ajaxPostWithBody(url, JSON.stringify(data))
            .subscribe((res) => {
            if (res.message == "Esim CA Status Saved Successfully") {
...
BulkstatusComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
...
let EsimCaReportPageModule = class EsimCaReportPageModule {
};
...
let EsimCaReportPage = class EsimCaReportPage {
    constructor(platform, formBuilder, modalController, ajaxService, commonService, ete) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
...
EsimCaReportPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
...
let HistoryDetailsComponent = class HistoryDetailsComponent {
...
HistoryDetailsComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
    { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
    { type: src_app_services_common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"] }
...
//# sourceMappingURL=esim-ca-report-esim-ca-report-module-es2015.js.map