...
var DiagnosisPage = /** @class */ (function () {
    function DiagnosisPage(platform) {
        this.platform = platform;
        this.app = { logo: 'logo.png' };
    }
    DiagnosisPage.prototype.ngOnInit = function () {
    ...
    DiagnosisPage.ctorParameters = function () { return [
...
var VtsDiagnosisComponent = /** @class */ (function () {
    function VtsDiagnosisComponent(ajaxService, commonService) {
    ...
    VtsDiagnosisComponent.prototype.submit = function (imei) {
        var _this = this;
        this.imeiNo = imei;
        this.show = false;
        var body = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + '/simcard/get/Diagnosis';
    ...
    VtsDiagnosisComponent.prototype.initializeItems = function () {
        this.imei;
    };
    VtsDiagnosisComponent.prototype.hide = function (ev) {
        ...
        if (val && val.trim() !== '') {
            ...
            this.imei = this.imei.filter(function (item) {
    ...
    VtsDiagnosisComponent.prototype.getImei = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + '/simcard/get/imei/list';
        this.ajaxService.ajaxGetWithString(url)
            .subscribe(function (res) {
            _this.imei = JSON.parse(res);
            //  this.showDatas = res.split(",");
            //  this.showDatas =["$", "500", "869247046192016", "89910473121803851084", "1", "0", "1", "*"]
            console.log(res);
        });
    };
    VtsDiagnosisComponent.prototype.ngOnInit = function () {
        this.getImei();
    };
    VtsDiagnosisComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=diagnosis-diagnosis-module-es5.js.map