...
var EsimDashboardsPageModule = /** @class */ (function () {
    function EsimDashboardsPageModule() {
    }
    ...
    return EsimDashboardsPageModule;
}());
...
var EsimDashboardsPage = /** @class */ (function () {
    function EsimDashboardsPage(ajaxService, router, platform) {
    ...
    EsimDashboardsPage.prototype.endisMapedDevice = function (d) {
        console.log(d);
        this.endis = d;
    };
    EsimDashboardsPage.prototype.ngAfterViewInit = function () { };
    EsimDashboardsPage.prototype.getSensoriseData = function () {
        var _this = this;
        var url = "https://mvt.apmkingstrack.com/fleettracking/esim/getServiceProvider";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.barRender = res;
        });
    };
    EsimDashboardsPage.prototype.ngOnInit = function () {
    ...
    EsimDashboardsPage.prototype.getDealers = function () {
        var _this = this;
    ...
    EsimDashboardsPage.prototype.deviceTotalActivatedCount = function (d) {
        this.deviceTotalActivatedCounts = d;
    };
    EsimDashboardsPage.prototype.Submit = function (data) {
        if (data == "sales") {
    ...
    EsimDashboardsPage.prototype.deviceTotalPurchaseCount = function (d) {
        this.deviceTotalPurchaseCounts = d;
    };
    EsimDashboardsPage.prototype.selectDealer = function (e, header) {
        if (header == "sensorise") {
    ...
    EsimDashboardsPage.prototype.daysDropDownClick = function (d, header) {
        if (header == "sensorise") {
    ...
    EsimDashboardsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=esim-dashboards-esim-dashboards-module-es5.js.map