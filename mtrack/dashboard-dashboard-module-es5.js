...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(ajaxService, router, commonService, websocketService, modalController, firebaseX, device, authenticationService, udid, platform, statusBar, network, menuController, alertController, appVersion, market, locat) {
        var _this = this;
        ...
        this.filterClick = function (filter) {
            _this.commonService.presentLoader();
            localStorage.setItem("filterActive", filter);
            _this.router.navigateByUrl("/tabs/gridview");
            _this.commonService.dismissLoader();
        };
    }
    DashboardPage.prototype.loadExternalScript = function () {
        var _this = this;
        return new Promise(function (resolve) {
            var scriptElement = document.createElement('script');
            scriptElement.src = "https://maps.googleapis.com/maps/api/js?key=" + _this.applicationSettings.GoogleMapKey;
    ...
    DashboardPage.prototype.wsResponse = function (json) {
        var e_1, _a;
        ...
        if (data) {
            ...
            for (var i = 0; i < Object.keys(json.statusCount).length; i++) {
                json['statusCount'][Object.keys(json.statusCount)[i]] = 0;
            }
            var data_1 = [];
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](Object.entries(json.liveDatas)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var _d = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_c.value, 2), key = _d[0], value = _d[1];
                    data_1.push(value["status"]);
            ...
            var updatedJson = void 0;
            if (localStorage.cacheAddress) {
                var cacheData = JSON.parse(localStorage.cacheAddress);
                var data_2 = this.commonService.updateCacheAddress(cacheData, json.liveDatas);
                updatedJson = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["storageVariable"].dashboardData;
                updatedJson["liveDatas"] = data_2.liveDatas;
            }
            else {
                updatedJson = json;
            }
    ...
    DashboardPage.prototype.updateData = function (json) {
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.statusColor), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
    ...
    DashboardPage.prototype.restartApp = function () {
    ...
    DashboardPage.prototype.pushNotificationConfig = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var pushDetails;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    if (_this.network.type !== "none") {
                        if (/(android)/i.test(navigator.userAgent)) {
                            _this.firebaseX.getToken()
                                ...
                                var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/alert/pushnotification";
                                _this.ajaxService.ajaxPostWithBody(url, pushDetails)
    ...
    DashboardPage.prototype.openDelarIntroModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(localStorage.delarIntro != "true")) return [3 /*break*/, 3];
    ...
    //   }
    // }
    DashboardPage.prototype.routerModal = function (count, type) {
        if (count > 0) {
    ...
    //   });
    // }
    DashboardPage.prototype.bellRouter = function () {
        this.router.navigateByUrl('/tabs/alerts/All');
    };
    DashboardPage.prototype.alertConfiguration = function () {
        var url2 = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + '/device/bikeappalerts' + localStorage.corpId;
    ...
    DashboardPage.prototype.appUpdate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var currentVersion, appSettingsVersion, alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        currentVersion = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["app"].appVersion;
                        appSettingsVersion = JSON.parse(localStorage.appSettings)['appComVersion'][_environments_environment__WEBPACK_IMPORTED_MODULE_2__["app"].appName];
                                ...
                                buttons: [{
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            ...
                                            _this.market.open(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["app"].package);
                                        }
                                    }]
                            })];
                    case 1:
    ...
    DashboardPage.prototype.ngOnInit = function () {
        ...
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/login/company/login";
        this.ajaxService.ajaxPostMethod(url, body)
            ...
            if (res != undefined) {
                if (_environments_environment__WEBPACK_IMPORTED_MODULE_2__["app"].entryPoint == 'unknown') {
                    ...
                    _this.entryPoint = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["app"].entryPoint;
                }
                _this.loginData = Object.keys(res[0]);
                ...
                if (data == false) {
                    ...
                    _this.ajaxService.ajaxGetWithString(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/login/test")
                        .subscribe(function (res) {
                        if (res == '["Hi Web....!"]')
        ...
        if (ele === null) {
            this.loadExternalScript().then(function () { console.warn("Init Map Loaded"); }).catch(function () { });
        }
        else if (ele.id !== this.applicationSettings.GoogleMapKey) {
            document.body.removeChild(ele);
            this.loadExternalScript().then(function () { console.warn("Map Key Changed"); }).catch(function () { });
        }
        var json = JSON.parse(localStorage.loginData);
    ...
    DashboardPage.prototype.alertCountHeader = function () {
        var _this = this;
        var basicAlertsAndCount = { 'Overspeed': '', 'Idle': '', 'Stop': '', 'Engine On': '' };
        var reqJson = {
            "userId": localStorage.getItem('userName'),
            "fromDate": this.todayDate,
            "toDate": this.todayDate
        };
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + '/alert/alertcounts?userId=' + localStorage.getItem('userName') + '&fromDate=' + this.todayDate + '&toDate=' + this.todayDate;
        this.ajaxService.ajaxGet(url)
            .subscribe(function (res) {
            basicAlertsAndCount = res;
            _this.totalAlertCount = 0;
            for (var i = 0; i < Object.keys(basicAlertsAndCount).length; i++) {
                _this.totalAlertCount += parseInt(Object.values(basicAlertsAndCount)[i]);
            }
        });
    };
    DashboardPage.prototype.backButtonExit = function () {
        var _this = this;
        ...
        this.subscription = this.platform.backButton.subscribeWithPriority(9999, function () {
            var thisKey = _this;
            var alertController = _this.alertController;
            var websocketService = _this.websocketService;
            var locat = _this.locat;
            document.addEventListener('backbutton', function (event) {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(window.location.hash == "#/tabs/members/dashboard")) return [3 /*break*/, 4];
    ...
    DashboardPage.prototype.totalVehicleCount = function () {
    ...
    DashboardPage.prototype.totalHrsDistributionChart = function (chartData, text, colors) {
    ...
    DashboardPage.prototype.totalHrsDistributionSummary = function (data) {
        var _this = this;
        var commonService = this.commonService;
        var firstChartWord = "";
        var secondChartWord = "";
        ...
        var chartData = [];
        var colors = ['#1eb15d', '#FF0000', '#1f5baa', '#000000', '#f28918'];
        ...
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/report/totalHrsDistribution";
        this.ajaxService.ajaxPostMethod(url, reqJson)
            ...
            _this.totalHrsDistributionChart(chartData, text, colors);
        });
    };
    DashboardPage.prototype.vehicleStatus = function (statusType, categories, data, color, format) {
        var count = 0;
    ...
    DashboardPage.prototype.overspeedStatus = function (data) {
        var _this = this;
        var overSpeedVehicleName = [];
        var overSpeedVehicleValue = [];
        var reqJson;
        var hoursOrDays = " kmph";
        var overSpeed = { 'TN 09 MK 8754': '', 'TN 09 MK 8654': '', 'TN 09 MK 8758': '', 'TN 09 MK 8750': '' };
        if (data.detail.value === "Yesterday") {
            hoursOrDays = " kmph";
            reqJson = {
                "userId": localStorage.getItem('userName'),
        ...
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/report/gettop5data";
        this.ajaxService.ajaxPostMethod(url, reqJson)
            .subscribe(function (res) {
            overSpeed = res;
            var sortable = [];
            for (var vehicle in overSpeed) {
            ...
            if (overSpeedVehicleValue.length == 0 || Object.keys(res).length == 0) {
                _this.OverspeedshowNodata = true;
                _this.Overspeedchartdata = false;
            }
            else {
                _this.OverspeedshowNodata = false;
                _this.Overspeedchartdata = true;
                _this.vehicleStatus("overspeedvehicles", overSpeedVehicleName, overSpeedVehicleValue, '#f58220', hoursOrDays);
            }
        });
    };
    DashboardPage.prototype.unUsedAssert = function (data) {
        var _this = this;
        var unUsedAssertName = [];
        var unUsedAssertValue = [];
        var reqJson;
        var hoursOrDays = " days";
        var unUsedAssert = { 'TN 09 MK 8754': '', 'TN 09 MK 8654': '', 'TN 09 MK 8758': '', 'TN 09 MK 8750': '' };
        if (data.detail.value === "Yesterday") {
            hoursOrDays = " hours";
            reqJson = {
                "userId": localStorage.getItem('userName'),
        ...
        this.ajaxService.ajaxPostMethod(url, reqJson)
            ...
            unUsedAssert = res;
            var sortable = [];
            for (var vehicle in unUsedAssert) {
            ...
            if (unUsedAssertValue.length == 0 || Object.keys(res).length == 0) {
                _this.unUsedAssertshowNodata = true;
                _this.unUsedAssertchartdata = false;
            }
            else {
                _this.unUsedAssertshowNodata = false;
                _this.unUsedAssertchartdata = true;
                _this.vehicleStatus("unUsedAssert", unUsedAssertName, unUsedAssertValue, '#8e4eeb', hoursOrDays);
            }
        });
    };
    DashboardPage.prototype.engineHours = function (data) {
        var _this = this;
        var engineHoursName = [];
        var engineHoursValue = [];
        var reqJson;
        var hoursOrDays = " hours";
        var engineHours = { '05': '', '21': '', '60': '', '90': '' };
        if (data.detail.value === "Yesterday") {
            hoursOrDays = " hours";
            reqJson = {
                "userId": localStorage.getItem('userName'),
        ...
        this.ajaxService.ajaxPostMethod(url, reqJson)
            ...
            engineHours = res;
            var sortable = [];
            for (var vehicle in engineHours) {
            ...
            if (engineHoursValue.length == 0 || Object.keys(res).length == 0) {
                _this.Top5EngineshowNodata = true;
                _this.Top5Enginechartdata = false;
            }
            else {
                _this.Top5EngineshowNodata = false;
                _this.Top5Enginechartdata = true;
                _this.vehicleStatus("engineHours", engineHoursName, engineHoursValue, '#1198aa', hoursOrDays);
            }
        });
    };
    DashboardPage.prototype.vehicleOdometer = function (data) {
        var _this = this;
        var vehicleOdometerName = [];
        var vehicleOdometerValue = [];
        var reqJson;
        var km = " km";
        var vehicleOdometer = { 'TN 09 MK 8754': '', 'TN 09 MK 8654': '', 'TN 09 MK 8758': '', 'TN 09 MK 8750': '' };
        if (data.detail.value === "Yesterday") {
            reqJson = {
                "userId": localStorage.getItem('userName'),
                "fromDate": this.yesterdayDate,
        ...
        this.ajaxService.ajaxPostMethod(url, reqJson)
            ...
            vehicleOdometer = res;
            var sortable = [];
            for (var vehicle in vehicleOdometer) {
            ...
            if (vehicleOdometerValue.length == 0 || Object.keys(res).length == 0) {
                _this.Top5odametershowNodata = true;
                _this.Top5odameterchartdata = false;
            }
            else {
                _this.Top5odametershowNodata = false;
                _this.Top5odameterchartdata = true;
                _this.vehicleStatus("vehicleOdometer", vehicleOdometerName, vehicleOdometerValue, '#27aae2', km);
            }
        });
    };
    DashboardPage.prototype.vehicleSummaries = function (statusType, categories, data, color) {
        var i = 0;
        var xText = "";
        var yText = "";
        var enabled = false;
        ...
        var labels123 = ['0', '54', '70', '80', '140', '180', '200', '240'];
        highcharts__WEBPACK_IMPORTED_MODULE_12__["chart"](statusType, {
            chart: {
    ...
    DashboardPage.prototype.alertsAndCounts = function (data) {
        var _this = this;
        var alertsType = [];
        var basicAlertsAndCount = { 'Overspeed': '', 'Idle': '', 'Stop': '', 'Engine On': '' };
        var alertsCount = [];
        ...
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + '/alert/alertcounts?userId=' + localStorage.getItem('userName') + '&fromDate=' + reqJson.fromDate + '&toDate=' + reqJson.toDate;
        this.ajaxService.ajaxGet(url)
            .subscribe(function (res) {
            if (Object.keys(res).length == 0) {
                _this.alertshowNodata = true;
                _this.alertChartdata = false;
            }
            else {
                _this.alertshowNodata = false;
                _this.alertChartdata = true;
                basicAlertsAndCount = res;
                //this.totalAlertCount = 0;
                for (var i = 0; i < Object.keys(basicAlertsAndCount).length; i++) {
                ...
                _this.vehicleSummaries('alertCountSummery', alertsType, alertsCount, "#f7b921");
            }
        });
    };
    DashboardPage.prototype.odometer = function (data) {
        var _this = this;
        var speedRatio = [];
        var odometer = {};
        var speedVehicle = [];
        ...
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["serverUrl"].web + "/report/ChartSummaryData";
        this.ajaxService.ajaxPostMethod(url, reqJson)
            .subscribe(function (res) {
            ////console.log(res);
            odometer = res;
            ...
            var sortKey = Object.keys(odometer);
            ...
            // }
            _this.odometerData = Object.values(odometer);
            speedVehicle = ['0-40', '40-80', '80-120', '120-160', '160-200', '200-240', '240-280', '280-320'];
            // speedRatio = [['', 0],['', 0] ,['', 0], ['', 0],['art745,art404', 2]]
            _this.vehicleSummaries("odometerSummery", speedVehicle, speedRatio, "#27aae2");
        });
    };
    DashboardPage.prototype.speedometer = function (data) {
        var _this = this;
        var speedRatio = [];
        var speedometer = {};
        var speedVehicle = [];
        ...
        this.ajaxService.ajaxPostMethod(url, reqJson)
            ...
            // }
            ////console.log(colors)
            var sortKey = Object.keys(speedometer);
            sortKey.sort(function (a, b) { return parseInt(a) - parseInt(b); });
            for (var i = 0; i < sortKey.length; i++) {
            ...
            var color = "#009933";
            _this.vehicleSummaries("speedometerSummery", speedVehicle, speedRatio, color);
        });
    };
    DashboardPage.prototype.unUsedVehicleStatus = function (data) {
        var _this = this;
        var speedRatio = [];
        var unUsedSummary = { "0-50": { "count": "String", "vehicle": "String" } };
        var speedVehicle = [];
        var reqJson;
        if (data.detail.value == "Current") {
            reqJson = {
        ...
        this.ajaxService.ajaxPostMethod(url, reqJson)
            .subscribe(function (res) {
            unUsedSummary = res;
            var sortKey = Object.keys(unUsedSummary);
            sortKey.sort(function (a, b) { return parseInt(a) - parseInt(b); });
            for (var i = 0; i < sortKey.length; i++) {
            ...
            // }
            _this.vehicleSummary3d('unUsedVehicleStatus', speedVehicle, speedRatio);
        });
    };
    DashboardPage.prototype.noOfDoorOpen = function (data) {
        var _this = this;
        var deviceDoorOpenName = [];
        var deviceDoorOpenValue = [];
        var reqJson;
        var km = " Times";
        var DoorOpen = { 'TN 09 MK 8754': '', 'TN 09 MK 8654': '', 'TN 09 MK 8758': '', 'TN 09 MK 8750': '' };
        if (data.detail.value === "Yesterday") {
            reqJson = {
                "userId": localStorage.getItem('userName'),
                "fromDate": this.yesterdayDate,
        ...
        this.ajaxService.ajaxPostMethod(url, reqJson)
            ...
            //   vehicleOdometerName.push(Object.keys(vehicleOdometer)[i]);
            // }
            _this.vehicleStatus("noOfDoorOpen", deviceDoorOpenName, deviceDoorOpenValue, '#FF851B', km);
        });
    };
    DashboardPage.prototype.noOfPowerFail = function (data) {
        var _this = this;
        var devicePowerFailName = [];
        var devicePowerFailValue = [];
        var reqJson;
        var km = " Times";
        var powerFail = { 'TN 09 MK 8754': '', 'TN 09 MK 8654': '', 'TN 09 MK 8758': '', 'TN 09 MK 8750': '' };
        if (data.detail.value === "Yesterday") {
            reqJson = {
                "userId": localStorage.getItem('userName'),
                "fromDate": this.yesterdayDate,
        ...
        this.ajaxService.ajaxPostMethod(url, reqJson)
            ...
            //   vehicleOdometerName.push(Object.keys(vehicleOdometer)[i]);
            // }
            _this.vehicleStatus("noOfPowerFail", devicePowerFailName, devicePowerFailValue, '#412525', km);
        });
    };
    DashboardPage.prototype.vehicleSummary3d = function (statusType, categories, data) {
        var router = this.router;
        var commonService = this.commonService;
        highcharts_highcharts_3d_src__WEBPACK_IMPORTED_MODULE_13___default()(highcharts__WEBPACK_IMPORTED_MODULE_12__);
        highcharts__WEBPACK_IMPORTED_MODULE_12__["chart"](statusType, {
...
var DealerIntroSlideComponent = /** @class */ (function () {
    function DealerIntroSlideComponent(modalController) {
        this.modalController = modalController;
    }
    DealerIntroSlideComponent.prototype.dismiss = function () {
        localStorage.setItem('delarIntro', "true");
        this.modalController.dismiss();
    };
    DealerIntroSlideComponent.prototype.ngOnInit = function () {
        this.logo = localStorage.companyLogo;
    };
    DealerIntroSlideComponent.ctorParameters = function () { return [
    ...
    return DealerIntroSlideComponent;
}());
...
var AddImeiCompanyPage = /** @class */ (function () {
    function AddImeiCompanyPage(alertController, commonService, ajaxService, modalController, router) {
        this.alertController = alertController;
        this.commonService = commonService;
        this.ajaxService = ajaxService;
        this.modalController = modalController;
    ...
    AddImeiCompanyPage.prototype.assignImeiToCompany = function (company) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                ...
                                buttons: [{
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            ...
                                            var assignImeiTocom = {
                                                "manufacture": _this.imeiDetails.manufacture,
                                                "provider": _this.imeiDetails.provider,
                                                "imei": _this.imeiDetails.imei,
                                                "checked": _this.imeiDetails.checked,
                                                "simno": _this.imeiDetails.simno,
                                                "modal": _this.imeiDetails.modal,
                                                //"$$hashKey": "object:8022",
                                            ...
                                            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + '/api/vts/superadmin/device';
                                            _this.ajaxService.ajaxPutMethod(url, arrayData)
                                                .subscribe(function (res) {
                                                console.log(res);
                                                res = JSON.parse(res);
                                                if (res.devicestatus === "persisted") {
                                                    ...
                                                    _this.router.navigateByUrl('/company-vehicle');
                                                    _this.modalController.dismiss();
                                                }
                                                else {
                                                    _this.commonService.presentToast('There was a problem to assign this Imei');
                                                }
                                            });
                                        }
                                    }]
    ...
    AddImeiCompanyPage.prototype.getBack = function () {
        this.modalController.dismiss();
    };
    AddImeiCompanyPage.prototype.searchStatus = function () {
        this.searchEnable = !this.searchEnable;
    };
    AddImeiCompanyPage.prototype.ionViewWillEnter = function () {
        this.commonService.dismissLoader();
    };
    AddImeiCompanyPage.prototype.ngOnInit = function () {
        this.showList = JSON.parse(localStorage.getItem('dashboardData'));
    };
    AddImeiCompanyPage.ctorParameters = function () { return [
...
var CompanyDetailsComponent = /** @class */ (function () {
    function CompanyDetailsComponent(ajaxService, modalController) {
        this.ajaxService = ajaxService;
        this.modalController = modalController;
        this.page = [];
    }
    CompanyDetailsComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    CompanyDetailsComponent.prototype.getdata = function () {
        var _this = this;
...
var CreateCompanyComponent = /** @class */ (function () {
    function CreateCompanyComponent(formBuilder, router, ajaxService, commonService, location, modalController) {
    ...
    CreateCompanyComponent.prototype.clear = function () {
        this.checkno.patchValue({
            phoneno: "",
        });
    };
    CreateCompanyComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    CreateCompanyComponent.prototype.getBack = function () {
        this.router.navigateByUrl("/dashboard");
    };
    CreateCompanyComponent.prototype.backbutton = function () {
        this.location.back();
    };
    CreateCompanyComponent.prototype.setValue = function () {
    ...
    CreateCompanyComponent.prototype.check = function () {
        var _this = this;
        if (this.checkno.value.phoneno.toString().length != 10) {
            ...
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
                if (res.message == "Available") {
                    _this.commonService.showConfirm("Available");
                    _this.clear();
                }
                else {
    ...
    CreateCompanyComponent.prototype.onadd = function () {
        var _this = this;
    ...
    CreateCompanyComponent.prototype.onedit = function () {
        var _this = this;
        if (this.addCompany.value.contactNo.toString().length != 10) {
            this.commonService.presentToast("Enter the 10 Digit Contact Number");
        }
        ...
        this.ajaxService.ajaxPostWithBody(url, dataJson).subscribe(function (res) {
            if (res.message == "updated successfully") {
                _this.commonService.showConfirm("Updated Successfully");
                _this.modalController.dismiss({
    ...
    CreateCompanyComponent.prototype.addTheCompany = function () {
        var _this = this;
        var adminData;
        var addCompany;
        if (src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["app"].appName != "Armoron") {
    ...
    CreateCompanyComponent.prototype.newFleetCreation = function (res) {
        var _this = this;
        if (res) {
    ...
    CreateCompanyComponent.prototype.newCompanyCreation = function (data) {
        var _this = this;
    ...
    CreateCompanyComponent.prototype.alterNewCompanySuccess = function (res) {
    ...
    CreateCompanyComponent.prototype.getCountries = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web +
    ...
    CreateCompanyComponent.prototype.getCountryCode = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web +
    ...
    CreateCompanyComponent.prototype.ionViewWillEnter = function () {
        this.addCompany.reset();
        this.clear();
...
var routes = [
    ...
    {
        path: 'add-company',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-company-add-company-module */ "add-company-add-company-module").then(__webpack_require__.bind(null, /*! ./add-company/add-company.module */ "./src/app/delar-application/dashboard/add-company/add-company.module.ts")).then(function (m) { return m.AddCompanyPageModule; }); }
    },
    {
        path: 'add-imei-company',
        loadChildren: function () { return __webpack_require__.e(/*! import() | add-imei-company-add-imei-company-module */ "add-imei-company-add-imei-company-module").then(__webpack_require__.bind(null, /*! ./add-imei-company/add-imei-company.module */ "./src/app/delar-application/dashboard/add-imei-company/add-imei-company.module.ts")).then(function (m) { return m.AddImeiCompanyPageModule; }); }
    }
];
...
var DashboardPage = /** @class */ (function () {
    function DashboardPage(ajaxService, platform, modalController, commonService) {
        this.ajaxService = ajaxService;
        this.platform = platform;
        this.modalController = modalController;
        this.commonService = commonService;
    ...
    DashboardPage.prototype.addModel = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    DashboardPage.prototype.editModel = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DashboardPage.prototype.viewModel = function (row) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DashboardPage.prototype.myGridOnRowSelect = function (event) {
...
var SearchFilterService = /** @class */ (function () {
    ...
    SearchFilterService.prototype.transform = function (items, terms) {
        if (!items)
            return [];
        if (!terms)
            return items;
        terms = terms.toLowerCase();
        return items.filter(function (showList) {
            if (showList != null) {
