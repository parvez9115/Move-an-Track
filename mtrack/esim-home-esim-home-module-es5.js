...
var DashboardgridComponent = /** @class */ (function () {
    function DashboardgridComponent(loadingCtrl, platform, formBuilder, modalController, alertController, commonService, ajaxService) {
    ...
    DashboardgridComponent_1 = DashboardgridComponent;
    DashboardgridComponent.prototype.cancel = function () {
        this.modalController.dismiss();
    };
    DashboardgridComponent.prototype.openModel = function (row) {
    ...
    DashboardgridComponent.prototype.showLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DashboardgridComponent.prototype.ngAfterViewChecked = function () {
        if (this.endis == false) {
        }
        // afterViewInit code.
        this.init();
    };
    DashboardgridComponent.prototype.enablebanner = function (d) {
        console.log(d);
        if (d == 0) {
            this.endis = true;
        }
    ...
    DashboardgridComponent.prototype.init = function () { };
    DashboardgridComponent.prototype.pendingCADashboard = function () {
        var _this = this;
        this.endis = false;
        this.page = [];
        this.showLoading();
    ...
    DashboardgridComponent.prototype.pendingRenewalDashboard = function () {
        var _this = this;
        this.page = [];
        this.renderer = function (row, column, value) {
            if (value == "" || null || undefined) {
    ...
    DashboardgridComponent.prototype.pendingExtra1YearDashboard = function () {
        var _this = this;
        this.page = [];
        this.showLoading();
        this.renderer = function (row, column, value) {
    ...
    DashboardgridComponent.prototype.pendingTopupDashboard = function () {
        var _this = this;
        this.page = [];
        this.renderer = function (row, column, value) {
            if (value == "" || null || undefined) {
    ...
    DashboardgridComponent.prototype.pendinginvoicesummary = function () {
        var _this = this;
        this.page = [];
        this.renderer = function (row, column, value) {
            if (value == "" || null || undefined) {
        ...
        this.showLoading();
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getDealerInvoiceSummary";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.page = ["100", "200", "500", "1000"];
            _this.loadingCtrl.dismiss();
            _this.enablebanner(res.length);
    ...
    DashboardgridComponent.prototype.pendingmonltyrenewalsummary = function () {
        var _this = this;
        this.page = [];
        this.renderer = function (row, column, value) {
            if (value == "" || null || undefined) {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getDealerInvoiceRenewalMonthSummary";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            var columngroups = [];
            if (Object.keys(res).length > 0) {
                res.month.map(function (m) {
                    columngroups.push({
                        text: m,
                        align: "center",
                        name: m,
                ...
                _this.myGrid.columngroups(columngroups);
                var arr = Object.keys(res.data[0]);
                arr = arr.filter(function (n) {
                    return n != "dealername";
                });
                console.log(arr);
                arr.map(function (filterData, i) {
    ...
    DashboardgridComponent.prototype.pendingmonltytopupsummary = function () {
        var _this = this;
        this.page = [];
        this.renderer = function (row, column, value) {
            if (value == "" || null || undefined) {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getDealerInvoiceTopupMonthSummary";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            var columngroups = [];
            if (Object.keys(res).length > 0) {
                res.month.map(function (m) {
    ...
    DashboardgridComponent.prototype.pendingmonltyextendsummary = function () {
        var _this = this;
        this.page = [];
        this.renderer = function (row, column, value) {
            if (value == "" || null || undefined) {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getDealerInvoiceExtendMonthSummary";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            var columngroups = [];
            if (Object.keys(res).length > 0) {
                res.month.map(function (m) {
    ...
    DashboardgridComponent.prototype.pendingmonltybsnlsummary = function () {
        var _this = this;
        this.page = [];
        this.renderer = function (row, column, value) {
            if (value == "" || null || undefined) {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/esim/getDealerInvoiceBSNLMonthSummary";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            var columngroups = [];
            if (Object.keys(res).length > 0) {
                res.month.map(function (m) {
    ...
    //   // })
    // }
    DashboardgridComponent.prototype.commentsData = function () {
        this.endis = false;
    ...
    DashboardgridComponent.prototype.ngOnChanges = function (changes) {
        if (this.dealer != "") {
            if (this.grid == 1) {
    ...
    DashboardgridComponent.prototype.myGridOnRowclick = function (event) {
    ...
    DashboardgridComponent.prototype.ionViewWillEnter = function () { };
    var DashboardgridComponent_1;
    DashboardgridComponent.ctorParameters = function () { return [
...
var EsimHomePageModule = /** @class */ (function () {
    function EsimHomePageModule() {
    }
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var smart_webcomponents_angular_dropdownlist__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! smart-webcomponents-angular/dropdownlist */ "./node_modules/smart-webcomponents-angular/fesm5/smart-webcomponents-angular-dropdownlist.js");
/* harmony import */ var src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/ajax.service */ "./src/app/services/ajax.service.ts");
/* harmony import */ var src_app_services_common_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/common.service */ "./src/app/services/common.service.ts");
...
var EsimHomePage = /** @class */ (function () {
    function EsimHomePage(ajaxService, platform, router, alertController, commonService) {
        this.ajaxService = ajaxService;
        this.platform = platform;
        this.router = router;
        this.alertController = alertController;
    ...
    EsimHomePage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    EsimHomePage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    EsimHomePage.prototype.logScrolling = function (ev) {
    ...
    EsimHomePage.prototype.dropDownData = function () {
        var _this = this;
        var url = "https://mvt.apmkingstrack.com/fleettracking/global/getesimdealerlist";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.data = res;
            _this.dropdownlistDealer.dataSource = res;
        });
    };
    EsimHomePage.prototype.ionViewWillEnter = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    ...
    EsimHomePage.prototype.ngOnInit = function () { };
    EsimHomePage.prototype.switchGrid = function (d) {
        this.dropDownData();
        this.showGrid = d;
    };
    EsimHomePage.prototype.switchtab = function (d) {
        this.tab = d;
    };
    EsimHomePage.prototype.handleChange = function (e) {
        this.dealer = e.value;
    };
    EsimHomePage.prototype.selectDealer = function (e) {
        this.dealer = this.dropdownlistDealer.value[0].value;
    };
    EsimHomePage.ctorParameters = function () { return [
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
...
//# sourceMappingURL=esim-home-esim-home-module-es5.js.map