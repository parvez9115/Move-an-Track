...
var CaReportPageModule = /** @class */ (function () {
    function CaReportPageModule() {
    }
...
var CaReportPage = /** @class */ (function () {
    function CaReportPage(formBuilder, modalController, ajaxService, commonService) {
        var _this = this;
    ...
    CaReportPage.prototype.clear = function () {
    ...
    CaReportPage.prototype.reset = function () {
        this.CAReportForm.patchValue({
            SerialNo: "",
        });
    };
    CaReportPage.prototype.resets = function () {
        this.CAReportForm.patchValue({
            InvoiceNo: "",
        });
    };
    CaReportPage.prototype.getcalist = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
    ...
    CaReportPage.prototype.createForm = function () {
    ...
    CaReportPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
        this.show = true;
    };
    CaReportPage.prototype.SearchData = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
    ...
    CaReportPage.prototype.ngOnInit = function () {
        this.getcalist();
        this.createForm();
    };
    CaReportPage.ctorParameters = function () { return [
...
//# sourceMappingURL=ca-report-ca-report-module-es5.js.map