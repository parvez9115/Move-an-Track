...
var BroadcastAdditionalComponent = /** @class */ (function () {
    function BroadcastAdditionalComponent(modalController, formBuilder, commonService, ajaxService) {
    ...
    BroadcastAdditionalComponent.prototype.onChangeHandler = function (event) {
    ...
    BroadcastAdditionalComponent.prototype.closeModel = function () {
    ...
    BroadcastAdditionalComponent.prototype.createform = function () {
    ...
    BroadcastAdditionalComponent.prototype.getTriptype = function () {
        var _this = this;
    ...
    BroadcastAdditionalComponent.prototype.getRoutename = function () {
        var _this = this;
    ...
    BroadcastAdditionalComponent.prototype.refresh = function () {
    };
    BroadcastAdditionalComponent.prototype.onSubmit = function (event) {
        var _this = this;
        var details = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/report/broadcastsms";
        this.ajaxService.ajaxPostWithString(url, details).subscribe(function (res) {
            if (res === "Success") {
                _this.commonService.presentToast('Data added succesfully');
                _this.broadcastdetails.reset();
    ...
    BroadcastAdditionalComponent.prototype.ngOnInit = function () {
        this.companyDetail = {
    ...
    BroadcastAdditionalComponent.ctorParameters = function () { return [
    ...
    return BroadcastAdditionalComponent;
}());
...
var ClassAdditionalComponent = /** @class */ (function () {
    function ClassAdditionalComponent(modalController, formBuilder, commonService, ajaxService) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.commonService = commonService;
        this.ajaxService = ajaxService;
    ...
    ClassAdditionalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    ClassAdditionalComponent.prototype.createForm = function () {
    ...
    ClassAdditionalComponent.prototype.onSubmit = function (ev) {
        var _this = this;
        var data = {
            "companyId": localStorage.getItem('corpId'),
            "branchId": localStorage.getItem('corpId'),
        ...
        this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) {
            if (res.message == "Added Successfully") {
                _this.commonService.presentToast('Class Details Added Successfully');
                _this.modalController.dismiss();
            }
            else if (res.message == "Updated Successfully") {
                _this.modalController.dismiss();
                _this.commonService.presentToast('Class Details Updated Successfully');
            }
            else {
    ...
    ClassAdditionalComponent.prototype.ngOnInit = function () {
        this.data = this.value;
        this.createForm();
        if (this.value) {
    ...
    ClassAdditionalComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    ...
    return ClassAdditionalComponent;
}());
...
var EnableAdditionalComponent = /** @class */ (function () {
    function EnableAdditionalComponent(modalController, alertController, formBuilder, ajaxService, http, commonService, platform) {
        this.modalController = modalController;
    ...
    EnableAdditionalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    EnableAdditionalComponent.prototype.createForm = function () {
    ...
    EnableAdditionalComponent.prototype.editForm = function () {
        if (this.value) {
    ...
    EnableAdditionalComponent.prototype.onSubmit = function (type) {
        var _this = this;
        var companyDetail = {
            branchID: localStorage.getItem("corpId"),
            companyID: localStorage.getItem("corpId"),
        ...
        if (this.serviceName != "available") {
            ...
            Object.keys(data_1).forEach(function (key) { return (data_1[key] == null || data_1[key] == "") && delete data_1[key]; });
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/schoolEnableDisable/addschooldisabledate";
            this.ajaxService.ajaxPostWithString(url, data_1).subscribe(function (res) {
                if (res === "Success") {
                    _this.commonService.presentToast("Added succesfully");
                    _this.enableLogin.reset();
                    _this.modalController.dismiss();
                }
            });
        }
            ...
            Object.keys(data_2).forEach(function (key) { return (data_2[key] == null || data_2[key] == "") && delete data_2[key]; });
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/schoolEnableDisable/updateschooldisabledate";
            this.ajaxService.ajaxPostWithString(url, data_2).subscribe(function (res) {
    ...
    EnableAdditionalComponent.prototype.delete = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.value) return [3 /*break*/, 3];
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            ...
                                            var deleteData = {
                                                tagID: _this.value.operatorID,
                                                compnyID: _this.companyDetail.companyID,
                                                branchID: _this.companyDetail.branchID,
                                                companyNme: _this.companyDetail.userId,
                                            };
    ...
    EnableAdditionalComponent.prototype.ngOnInit = function () {
    ...
    EnableAdditionalComponent.ctorParameters = function () { return [
    ...
    return EnableAdditionalComponent;
}());
...
var GateAdditionalComponent = /** @class */ (function () {
    function GateAdditionalComponent(modalController, formBuilder, commonService, ajaxService) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.commonService = commonService;
        this.ajaxService = ajaxService;
    ...
    GateAdditionalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    GateAdditionalComponent.prototype.createForm = function () {
    ...
    GateAdditionalComponent.prototype.required = function () {
        this.customData = !this.customData;
    };
    GateAdditionalComponent.prototype.onSubmit = function () {
        var _this = this;
        var data = {
            "companyId": localStorage.getItem('corpId'),
            "branchId": localStorage.getItem('corpId'),
        ...
        this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) {
            if (res.message == "Added Successfully") {
                _this.commonService.presentToast('Added Successfully');
                _this.modalController.dismiss();
            }
            else if (res.message == "Updated Successfully") {
                _this.modalController.dismiss();
    ...
    GateAdditionalComponent.prototype.ngOnInit = function () {
        this.createForm();
    ...
    GateAdditionalComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    ...
    return GateAdditionalComponent;
}());
...
var LatlongComponent = /** @class */ (function () {
    function LatlongComponent(mapService, geolocation, modelController, ajaxService, commonService) {
    ...
    LatlongComponent.prototype.getAddressLatlng = function (address) {
        var _this = this;
        if (address != "") {
            var data = parseFloat(address.split(",")[0]);
            if (data.toString() != "NaN") {
                ...
                this.ajaxService
                    ...
                    .subscribe(function (res) {
                    if (res.length > 0) {
                        var latLng = { lat: res[0].lat, lng: res[0].lon };
                        _this.mapService.setCenter(_this.map, {
                            lat: parseFloat(res[0].lat),
                            lng: parseFloat(res[0].lon),
                        });
                    }
                    else
                        _this.commonService.presentToast("Can't able to get your location");
                });
            }
        }
    };
    LatlongComponent.prototype.submit = function () {
    ...
    //   this.modelController.dismiss();
    // }
    LatlongComponent.prototype.cancelBtn = function () {
        this.modelController.dismiss();
    };
    LatlongComponent.prototype.createMap = function () {
        var _this = this;
        ...
        if (this.currentLocation == "") {
            this.geolocation
                ...
                _this.latitude = resp.coords.latitude.toFixed(2);
                _this.longitude = resp.coords.longitude.toFixed(2);
                _this.mapService.addMarker(_this.map, { lat: resp.coords.latitude, lng: resp.coords.longitude }, "LatLngPicker", "assets/vtstrackhisIcon/Idle.png");
                _this.mapService.createCircle(_this.map, { lat: resp.coords.latitude, lng: resp.coords.longitude }, 500, "Preferred");
                _this.mapService.fitBounds(_this.map, 2);
            })
    ...
    LatlongComponent.prototype.onClickLocationGetter = function () {
        var _this = this;
        this.map.on("click", function (evt) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var coordinates, latLng, geoBounds;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.mapService.clearLayers(this.map, [1, 2]);
                coordinates = evt.coordinate;
                latLng = Object(ol_proj__WEBPACK_IMPORTED_MODULE_5__["toLonLat"])([coordinates[0], coordinates[1]]);
                ...
                geoBounds = this.mapService.circleGeoZone();
                localStorage.setItem("latLongPickerGeoFence", geoBounds);
                return [2 /*return*/];
            });
        }); });
    };
    LatlongComponent.prototype.ngOnInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.createMap();
        }, 2000);
    };
    LatlongComponent.ctorParameters = function () { return [
...
var ParentAdditionalComponent = /** @class */ (function () {
    function ParentAdditionalComponent(modalController, formBuilder, ajaxService, commonService) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.ajaxService = ajaxService;
        this.commonService = commonService;
    }
    ParentAdditionalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    ParentAdditionalComponent.prototype.createForm = function () {
    ...
    ParentAdditionalComponent.prototype.onSubmit = function (ev) {
        var _this = this;
        if (this.update != "available") {
            this.addDatas = {
        ...
        this.ajaxService.ajaxPostMethod(url, this.addDatas).subscribe(function (res) {
            if (res.message == "Added Successfully") {
                _this.commonService.showConfirm("Parent Details Added Successfully");
                _this.modalController.dismiss();
            }
            else if (res.message == "Updated Successfully") {
                _this.commonService.showConfirm("Parent Details Updated Successfully");
                _this.modalController.dismiss();
            }
            else {
    ...
    ParentAdditionalComponent.prototype.ngOnInit = function () {
        this.companyDetail = {
            branchID: localStorage.getItem("corpId"),
            companyID: localStorage.getItem("corpId"),
            userId: localStorage.getItem("userName"),
    ...
    ParentAdditionalComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
        { type: src_app_services_common_service__WEBPACK_IMPORTED_MODULE_5__["CommonService"] }
    ...
    return ParentAdditionalComponent;
}());
...
var AddBusStopComponent = /** @class */ (function () {
    function AddBusStopComponent(modalController, ajaxService, platform, commonService) {
        this.modalController = modalController;
        this.ajaxService = ajaxService;
        this.platform = platform;
        this.commonService = commonService;
    ...
    AddBusStopComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    AddBusStopComponent.prototype.getData = function () {
        var _this = this;
    ...
    AddBusStopComponent.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
    };
    AddBusStopComponent.prototype.submit = function () {
        var _this = this;
        var data = [];
        this.tableData.map(function (d) {
            var id = d.id;
            delete d["trip"];
            delete d["createdby"];
            ...
            delete d["id"];
            data.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, d, { tripid: id, branchid: localStorage.getItem("corpId"), createdby: localStorage.getItem("corpId"), schoolid: localStorage.getItem("corpId"), routeid: _this.value.tripId.toString() }));
        });
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/routetrip/addDriverBusstop";
    ...
    AddBusStopComponent.prototype.ngOnInit = function () {
        this.companyDetail = {
            branchID: localStorage.getItem("corpId"),
            companyID: localStorage.getItem("corpId"),
            userId: localStorage.getItem("userName"),
    ...
    AddBusStopComponent.ctorParameters = function () { return [
...
var BusStopComponent = /** @class */ (function () {
    function BusStopComponent(modalController, sktService, formBuilder, commonService, platform, alertController, mapService, activatedRoute, ajaxService) {
        var _this = this;
        this.modalController = modalController;
        ...
        this.loadMap = function () {
            setTimeout(function () {
                if (localStorage.map === "GoogleMap") {
                    _this.map = _this.mapService.loadMap(_this.mapElement.nativeElement, { lat: 17.786351, lng: 78.09082 }, true, _this.popUp);
                }
                else {
                    _this.map = _this.mapService.loadMap(_this.mapElement.nativeElement, { lat: 17.786351, lng: 78.09082 }, true, _this.popUp);
                    _this.mapService.setCenter(_this.map, { lat: 17.786351, lng: 78.09082 });
                }
                _this.mapService.setCenter(_this.map, { lat: 17.786351, lng: 78.09082 });
            });
        };
        this.getLiveTrackIcon = function (color, path, plateNo) {
            ...
            var svg1 = '   <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="24.714mm" height="15.481mm" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"  ' +
                ...
                "     </g>  " +
                "   </svg>  ";
            var src = "data:image/svg+xml;charset=utf-8," + encodeURIComponent(svg1);
            return src;
        };
        if (localStorage.map == "GoogleMap") {
    ...
    BusStopComponent.prototype.getBack = function () {
        this.modalController.dismiss();
    };
    BusStopComponent.prototype.btnOnClick = function () {
    ...
    BusStopComponent.prototype.add = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BusStopComponent.prototype.editMode = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BusStopComponent.prototype.deleteMode = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        ...
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            var details = {
                                                companyId: _this.companyDetail.companyID,
                                                branchId: _this.companyDetail.branchID,
                                            };
                                            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["serverUrl"].web +
                                                "/routetrip/deleteBusstop?stopPointId=" +
                                                _this.selectedRow.stopPointId;
                                            _this.ajaxService
                                                .ajaxDeleteWithBody(url, details)
                                                .subscribe(function (res) {
                                                if (res.error.text == "success") {
                                                    _this.commonService.presentToast("Bus Stop Details Deleted successfully");
                                                    _this.modalController.dismiss();
                                                    _this.myGrid.clearselection();
                                                    _this.getData();
                                                }
    ...
    BusStopComponent.prototype.addbusstop = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    BusStopComponent.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
        this.loadMark();
    };
    BusStopComponent.prototype.getData = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["serverUrl"].web +
            ("/routetrip/getBusstop?schoolId=" + this.companyDetail.companyID + "&branchId=" + this.companyDetail.branchID + "&tripId=" + this.value.tripId);
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.obj = res;
            if (_this._routeDismiss)
                _this.loadMark();
            else
                _this.loadMap();
            _this.source = {
    ...
    BusStopComponent.prototype.ngAfterViewInit = function () {
    ...
    BusStopComponent.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    BusStopComponent.prototype.createLine = function (map, lineStringArray) {
        this.mapService.createLine(map, lineStringArray);
    };
    BusStopComponent.prototype.loadMark = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["serverUrl"].web +
            ("/routetrip/getBusstop?schoolId=" + this.companyDetail.companyID + "&branchId=" + this.companyDetail.branchID + "&tripId=" + this.value.tripId);
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.obj = res;
            _this.status == "ad";
            _this.mapService.clearClusteringMarkers(_this.map, [1]);
            var googleMapLatLng = [];
            var googleMapMarkerObj = [];
            if (_this.status != "Vin") {
                for (var i = 0; i < _this.obj; i++) {
                    _this.obj.push({
                        stopPointId: _this.obj[i].stopPointId,
                        arrivalTime: _this.obj[i].arrivalTime,
                        stopName: _this.obj[i].stopName,
                        latlng: _this.obj[i].latlng,
                    });
                }
                _this.obj.forEach(function (element, index) {
                    if (element.status !== "Yet_to_transmit") {
                        ...
                        var obj = {};
                        obj["img"] = _this.getLiveTrackIcon(_this.color[_this.selectedRow["latlng"] == element.latlng
                            ? "Stop"
                            : "Running"], _this.vehicleModel["BUS"], element.stopName);
                        ...
                        if (index != 0) {
                            var prevLatLng = {
                                lat: JSON.parse(_this.obj[index - 1].latlng.split(",")[0]),
                                lng: JSON.parse(_this.obj[index - 1].latlng.split(",")[1].trim(" ")),
                            };
                            var lineArray = [prevLatLng, latLng];
                        }
                        _this.liveTrackModel = _this.getLiveTrackIcon(_this.color["Running"], _this.vehicleModel["GENERATOR"], element.stopName);
                ...
                if (localStorage.map == "GoogleMap") {
                    _this.mapService.addClusteringMarkers(_this.map, googleMapLatLng, googleMapMarkerObj);
                }
            }
            else if (_this.status == "Vin") {
                ...
                for (var i = 0; i < element.length; i++) {
                    if (element[i].status !== "Yet_to_transmit") {
                        ...
                        var obj = {};
                        obj["img"] = _this.getLiveTrackIcon(_this.color[element[i].status], _this.vehicleModel[element[i].icon], element.plateNo);
            ...
            _this.mapService.fitBoundsForCluster(_this.map);
            _this.commonService.dismissLoader();
        });
    };
    BusStopComponent.prototype.loadMarker = function () {
        var _this = this;
        var myLatlng;
        this.obj.forEach(function (element) {
            _this.liveTrackModel = _this.getLiveTrackIcon(_this.color["Running"], _this.vehicleModel["BUS"], element.stopName);
            var obj = {};
            obj["img"] = _this.getLiveTrackIcon(_this.color["Running"], _this.vehicleModel["BUS"], element.stopName);
            obj["plateNo"] = element.stopName;
            obj["status"] = "stop";
            obj["timeStamp"] = "";
            obj["lat"] = JSON.parse(element.latlng.split(",")[0]);
            ...
            _this.mapService.addClusteringMarkers(_this.map, myLatlng, obj);
        });
        this.mapService.setCenter(this.map, myLatlng);
        this.commonService.dismissLoader();
    };
    BusStopComponent.prototype.loadMarkers = function () {
        var _this = this;
        var googleMapLatLng = [];
        var googleMapMarkerObj = [];
        if (this.status != "Vin") {
            Object.values(this.obj).forEach(function (element) {
                if (element.status == _this.status || _this.status == "All") {
                    if (element.status !== "Yet_to_transmit") {
                        var latLng = {
                            lat: _this.obj[0].latlng.split(",")[0],
                            lng: _this.obj[0].latlng.split(",")[1],
                        };
                        var obj = {};
                        obj["img"] =
    ...
    BusStopComponent.prototype.closeInfo = function () {
        this.markerInfo.show = false;
    };
    BusStopComponent.prototype.ngOnInit = function () {
        this.companyDetail = {
            branchID: localStorage.getItem("corpId"),
            companyID: localStorage.getItem("corpId"),
            userId: localStorage.getItem("userName"),
    ...
    BusStopComponent.prototype.ngOnChanges = function () {
        this.getData();
    };
    BusStopComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
...
var RouteAddtionalComponent = /** @class */ (function () {
    function RouteAddtionalComponent(modalController, formBuilder, ajaxService, commonService, geolocation, mapService) {
        var _this = this;
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.ajaxService = ajaxService;
    ...
    RouteAddtionalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    RouteAddtionalComponent.prototype.loadMark = function () {
        var _this = this;
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            ...
            _this.status == "ad";
            _this.mapService.clearClusteringMarkers(_this.map, [1]);
            var liveData = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["storageVariable"].dashboardData.liveDatas;
            var googleMapLatLng = [];
            var googleMapMarkerObj = [];
            if (_this.status != "Vin") {
                for (var i = 0; i < _this.obj; i++) {
                ...
                _this.obj.forEach(function (element, index) {
                    if (element.status !== "Yet_to_transmit") {
                        ...
                        _this.liveTrackModel = _this.getLiveTrackIcon(_this.color["Running"], _this.vehicleModel["GENERATOR"], element.stopName);
                        _this.mapService.addMarker(_this.map, latLng, "livetrack", _this.liveTrackModel);
                        if (localStorage.map == "GoogleMap") {
                            googleMapLatLng.push(latLng);
                            googleMapMarkerObj.push(obj);
                        }
    ...
    RouteAddtionalComponent.prototype.submit = function () {
        var _this = this;
        if (this.serviceName != "available") {
            var data = {
            ...
            Object.keys(data).forEach(function (key) { return (data[key] == null || data[key] == "") && delete data[key]; });
            data["tripId"] = this.value;
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/routetrip/addBusstop";
            this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) {
                if (res.message == "Added Successfully") {
                    _this.commonService.presentToast("Bus Stop Details Added successfully.");
                    _this.modalController.dismiss();
                    _this.loadMark();
                    _this.getLiveTrackIcon;
                }
                else {
                    _this.commonService.presentToast("Please check the values.");
                }
            });
        }
        else if (this.serviceName == "available") {
            ...
            Object.keys(datas).forEach(function (key) { return (datas[key] == null || datas[key] == "") && delete datas[key]; });
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/routetrip/updateBusstop";
            this.ajaxService.ajaxPostMethod(url, datas).subscribe(function (res) {
                if (res.message == "Updated Successfully") {
                    _this.commonService.presentToast("Bus Stop Details Updated Successfully.");
                    _this.stopDetails.reset();
                    _this.modalController.dismiss();
                }
                else {
                    _this.commonService.presentToast("Try again later.");
                }
            });
        }
    };
    RouteAddtionalComponent.prototype.createForm = function () {
    ...
    RouteAddtionalComponent.prototype.editForm = function () {
        if (this.value) {
            if (this.value.submit == "available") {
                this.serviceName = "available";
    ...
    RouteAddtionalComponent.prototype.currentLocation = function (mode) {
        var _this = this;
        this.geolocation
            .getCurrentPosition()
            .then(function (resp) {
            _this.stopDetails.patchValue({
                latlng: resp.coords.latitude + "," + resp.coords.longitude,
            });
        })
            .catch(function (error) { });
    };
    RouteAddtionalComponent.prototype.mapLocation = function (mode) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function () { return _this.mapReturnFunction(mode); });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    RouteAddtionalComponent.prototype.mapReturnFunction = function (mode) {
        this.stopDetails.patchValue({
            latlng: localStorage.getItem("mapLocationPicker"),
        });
        this.geoFenceForRef = localStorage.latLongPickerGeoFence;
    };
    RouteAddtionalComponent.prototype.ngOnInit = function () {
        this.companyDetail = {
            branchID: localStorage.getItem("corpId"),
            companyID: localStorage.getItem("corpId"),
            userId: localStorage.getItem("userName"),
    ...
    RouteAddtionalComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
    ...
    return RouteAddtionalComponent;
}());
...
var RouteCommonComponent = /** @class */ (function () {
    function RouteCommonComponent(modalController, formBuilder, platform, commonService, ajaxService, alertController, ete) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.platform = platform;
        this.commonService = commonService;
    ...
    RouteCommonComponent.prototype.deletebtn = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    //     newWindow.print();
    // };
    RouteCommonComponent.prototype.openBusStopModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RouteCommonComponent.prototype.routeAdditionalModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    RouteCommonComponent.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
    };
    RouteCommonComponent.prototype.editRouteModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    RouteCommonComponent.prototype.openRouteModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    RouteCommonComponent.prototype.getData = function () {
        var _this = this;
        var companyDetail = {
            branchID: localStorage.getItem("corpId"),
            companyID: localStorage.getItem("corpId"),
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            ...
            _this.source = { localdata: _this.obj };
            _this.dataAdapter = new jqx.dataAdapter(_this.source);
            _this.columns = [
                {
                    text: "Route Name",
                ...
                },
                {
                    ...
                    buttonclick: function (row) {
                        _this.openBusStopModel();
                    },
                },
            ];
        });
    };
    RouteCommonComponent.prototype.ngAfterViewInit = function () {
        this.getData();
        this.myGrid.showloadelement();
    };
    RouteCommonComponent.prototype.ngOnInit = function () {
        this.myPlatform = this.platform.platforms()[0];
        if (this.myPlatform == "tablet") {
            this.myPlatform = "desktop";
        }
    ...
    RouteCommonComponent.prototype.getBack = function () {
        this.modalController.dismiss();
    };
    RouteCommonComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
var RouteFormComponent = /** @class */ (function () {
    function RouteFormComponent(modalController, formBuilder, http, sktService, ajaxService, commonService) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.http = http;
        this.sktService = sktService;
    ...
    RouteFormComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    RouteFormComponent.prototype.clearModel = function () {
        this.radioSelection = "PickUp";
        this.selectedValue = "PickUp";
    };
    RouteFormComponent.prototype.close = function () {
        this.modalController.dismiss();
    };
    RouteFormComponent.prototype.clear = function () {
    ...
    RouteFormComponent.prototype.createForm = function () {
    ...
    RouteFormComponent.prototype.editForm = function () {
        if (this.value) {
            this.addshow = false;
            if (this.value.submit == "available") {
                this.serviceName = "available";
    ...
    RouteFormComponent.prototype.getVehiclename = function (tripId) {
        var _this = this;
        var PlateNo = "";
        var Action = localStorage.getItem("Action").toString();
        if (Action == "Edit") {
            PlateNo = localStorage.getItem("PlateNo").toString();
            if (PlateNo.trim() == "-") {
                PlateNo = "";
            }
            var trips = localStorage.getItem("trip").toString();
            if (tripId != trips) {
                PlateNo = "";
            }
        }
        ...
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            _this.vehicletype = res;
        });
    };
    RouteFormComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.serviceName != "available") {
            var data = {
                schoolId: this.companyDetail.companyID,
            ...
            Object.keys(data).forEach(function (key) { return (data[key] == null || data[key] == "") && delete data[key]; });
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/routetrip/addroute";
            this.ajaxService.ajaxPostWithString(url, data).subscribe(function (res) {
                if (JSON.parse(res).message == "Added Successfully") {
                    _this.commonService.presentToast("Added successfully");
                    _this.routeTripLogin.reset();
                    _this.modalController.dismiss();
                }
                else {
                    _this.commonService.presentToastwithmoretime(JSON.parse(res).message);
                }
            });
        }
        else if (this.serviceName == "available") {
            if (this.routeTripLogin.value.routeName.trim().length == 0) {
                ...
                Object.keys(details).forEach(function (key) {
                    return (details[key] == null || details[key] == "") && delete details[key];
                });
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/routetrip/updateroute";
                this.ajaxService.ajaxPostWithString(url, details).subscribe(function (res) {
                    if (JSON.parse(res).message == "Updated Successfully") {
    ...
    RouteFormComponent.prototype.selectPickDrop = function (event) {
    ...
    RouteFormComponent.prototype.ngOnInit = function () {
        this.companyDetail = {
            branchID: localStorage.getItem("corpId"),
            companyID: localStorage.getItem("corpId"),
            userId: localStorage.getItem("userName"),
    ...
    RouteFormComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
...
var SktComponentsModule = /** @class */ (function () {
    function SktComponentsModule() {
    }
...
var AddAlertsComponent = /** @class */ (function () {
    function AddAlertsComponent(modalController, ajaxService, formBuilder, commonService) {
        this.modalController = modalController;
        this.ajaxService = ajaxService;
        this.formBuilder = formBuilder;
        this.commonService = commonService;
    ...
    AddAlertsComponent.prototype.createForm = function () {
        this.studentDetails = this.formBuilder.group({
            alertoption: ['']
        });
    };
    AddAlertsComponent.prototype.submit = function () {
        var _this = this;
        var values = [];
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + "/student/config/studentalert";
        this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) {
            if (res.message == "success") {
                _this.commonService.presentToast('Student Details Alert Info Updated Sucessfully');
                _this.modalController.dismiss();
            }
            else {
                _this.commonService.presentToast('Please contact support team');
    ...
    AddAlertsComponent.prototype.getBack = function () {
        this.modalController.dismiss();
    };
    AddAlertsComponent.prototype.getAlert = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + '/student/getPreferences?key=Sktalert&companyId=demo';
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            _this.alertOption = res;
        });
    };
    AddAlertsComponent.prototype.getAlerttype = function () {
        var _this = this;
        var urls = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + '/report/getAlerttype';
        this.ajaxService.ajaxGet(urls).subscribe(function (res) {
            _this.alerts = res;
        });
        this.alerts;
    };
    AddAlertsComponent.prototype.selectData = function (a_alerts, s_alert) {
    ...
    AddAlertsComponent.prototype.editmethod = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + '/student/get/studentdetails?stin=' + this.value;
        this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
            _this.alertinfo = JSON.parse(res);
            _this.studentDetails.patchValue({
                alertoption: _this.alertinfo.alertinfo.alertmode.toString(),
            });
            _this.alertinfo.alertinfo.alerts;
            _this.alerts;
            for (var i = 0; i < _this.alerts.length; i++) {
                for (var j = 0; j < _this.alertinfo.alertinfo.alerts.length; j++) {
                    if (_this.alerts[i].key == _this.alertinfo.alertinfo.alerts[j]) {
                        _this.alerts[i].ischecked = true;
                        _this.selectedArray.push(_this.alerts[i]);
                    }
                    else {
                    }
                }
    ...
    AddAlertsComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
var AddRouteComponent = /** @class */ (function () {
    function AddRouteComponent(modalController, formBuilder, mapService, nav, gMapService, olMapService, menuController, platform, alertController, commonService, ajaxService) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.mapService = mapService;
        this.nav = nav;
        ...
        this.calculateRadius = function (south, west, north, east) {
            var R = 6378.137;
            var dLat = ((north - south) * Math.PI) / 180;
            var dLon = ((east - west) * Math.PI) / 180;
    ...
    AddRouteComponent.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    AddRouteComponent.prototype.closeModel = function () {
        this.modalController.dismiss();
    };
    AddRouteComponent.prototype.ionViewWillLeave = function () {
        this.subscription.unsubscribe();
    };
    AddRouteComponent.prototype.createMap = function (mode) {
        var _this = this;
        ...
        var latLng;
        if (mode === "edit") {
            var Stop = this.studentDetails.value.dropstop;
            if (Stop == "") {
                Stop = this.studentDetails.value.pickupstop;
            }
            if (Stop != "") {
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + "/student/getstudent/geofence?routeid=" + Stop;
                this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
                    _this.result = res.latlng;
                    var detailsString = _this.result;
                    var getLatLng = detailsString.split("|");
                    var southwest = getLatLng[0].split(",");
                    var northeast = getLatLng[1].split(",");
                    var south = parseFloat(southwest[0].split(",")[0]);
                    var west = parseFloat(southwest[1].split(",")[0]);
                    var north = parseFloat(northeast[0].split(",")[0]);
                    var east = parseFloat(northeast[1].split(",")[0]);
                    latLng = { lat: south, lng: west };
                    _this.range = _this.calculateRadius(north, east, south, west);
                    _this.mapService.addMarker(_this.map, latLng, "studentroute", "assets/vtstrackhisIcon/Idle.png");
                    _this.mapService.createCircle(_this.map, latLng, _this.range, "");
                    _this.mapService.fitBounds(_this.map, 2);
                });
            }
        }
    };
    AddRouteComponent.prototype.setRange = function (range) {
        this.range = range;
        this.mapService.setCircleRadius(this.range);
    };
    AddRouteComponent.prototype.getpickuptrip = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web +
            ...
            localStorage.getItem("corpId");
        this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
            _this.tripdetails = JSON.parse(res);
            console.log(_this.tripdetails);
            _this.pickuptrip = Object.keys(_this.tripdetails["PickUp"]);
        });
    };
    AddRouteComponent.prototype.getpickuproute = function (ev) {
    ...
    AddRouteComponent.prototype.getpickupstop = function (ev) {
        this.studentDetails.patchValue({
            pickupstop: "",
        });
        this.pickupstop =
    ...
    AddRouteComponent.prototype.selectpickupstop = function () {
        var _this = this;
        this.mapService.clearLayers(this.map, [1, 2]);
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web +
        ...
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            _this.result = res.latlng;
            _this.mapService.setCenter(_this.map, { lat: 13.029373, lng: 80.271928 });
            var latLng;
            var detailsStrings = _this.result;
            var getLatLng = detailsStrings.split("|");
            var southwest = getLatLng[0].split(",");
            var northeast = getLatLng[1].split(",");
            var south = parseFloat(southwest[0].split(",")[0]);
            var west = parseFloat(southwest[1].split(",")[0]);
    ...
    AddRouteComponent.prototype.selectDropstop = function () {
        var _this = this;
        this.mapService.clearLayers(this.map, [1, 2]);
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web +
            "/student/getstudent/geofence?routeid=" +
        ...
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            ...
            _this.mapService.setCenter(_this.map, { lat: 13.029373, lng: 80.271928 });
            var latLng;
            var detailsString1 = _this.result;
            var getLatLng = detailsString1.split("|");
            var southwest = getLatLng[0].split(",");
            var northeast = getLatLng[1].split(",");
            var south = parseFloat(southwest[0].split(",")[0]);
            var west = parseFloat(southwest[1].split(",")[0]);
    ...
    AddRouteComponent.prototype.getdroptrip = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web +
            "/student/route/details?schoolId=" +
            localStorage.getItem("corpId") +
        ...
        this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
            _this.tripdetails = JSON.parse(res);
            _this.droptrip = Object.keys(_this.tripdetails["Drop"]);
        });
    };
    AddRouteComponent.prototype.getdroproute = function (ev) {
        this.studentDetails.patchValue({
            droproute: "",
        });
    ...
    AddRouteComponent.prototype.getdropstop = function (ev) {
        this.studentDetails.patchValue({
            dropstop: "",
        });
        this.dropstop =
    ...
    AddRouteComponent.prototype.getAddressLatlng = function (address) {
        var _this = this;
        if (address != "") {
            var data = parseFloat(address.split(",")[0]);
            if (data.toString() != "NaN") {
    ...
    AddRouteComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    AddRouteComponent.prototype.deletePickup = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AddRouteComponent.prototype.deletepickup = function () {
        ...
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            ...
            if (res.message == "Successfully Deleted") {
                ...
                _this.commonService.showConfirm("PickUp " + res.message.toString());
            }
        });
    };
    AddRouteComponent.prototype.deleteDrop = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AddRouteComponent.prototype.deletedrop = function () {
        ...
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            ...
            if (res.message == "Successfully Deleted") {
                ...
                _this.commonService.showConfirm("Drop " + res.message.toString());
            }
        });
    };
    AddRouteComponent.prototype.submit = function () {
        var _this = this;
        if (this.studentDetails.value.pickuptrip == "" &&
            ...
            if (validation == true) {
                ...
                this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        if (res.message == "success") {
    ...
    AddRouteComponent.prototype.editmethod = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["serverUrl"].web + "/student/get/studentdetails?stin=" + this.value;
        this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
            _this.routeinfo = JSON.parse(res);
            _this.update = "available";
            if (_this.tripdetails["PickUp"].hasOwnProperty(_this.routeinfo.routeinfo.pickupTrip)) {
                _this.pickuproute = Object.keys(_this.tripdetails["PickUp"][_this.routeinfo.routeinfo.pickupTrip]);
                _this.pickupstop =
                    _this.tripdetails["PickUp"][_this.routeinfo.routeinfo.pickupTrip][_this.routeinfo.routeinfo.pickupRoute];
            }
            if (_this.tripdetails["Drop"].hasOwnProperty(_this.routeinfo.routeinfo.dropTrip)) {
                _this.droproute = Object.keys(_this.tripdetails["Drop"][_this.routeinfo.routeinfo.dropTrip]);
                _this.dropstop =
                    _this.tripdetails["Drop"][_this.routeinfo.routeinfo.dropTrip][_this.routeinfo.routeinfo.dropRoute];
            }
            _this.studentDetails.patchValue({
                pickuptrip: _this.routeinfo.routeinfo.pickupTrip,
                pickuproute: _this.routeinfo.routeinfo.pickupRoute,
                pickupstop: _this.routeinfo.routeinfo.pickupStop,
                droptrip: _this.routeinfo.routeinfo.dropTrip,
                droproute: _this.routeinfo.routeinfo.dropRoute,
                dropstop: _this.routeinfo.routeinfo.dropStop,
            });
            _this.sel_pickuptrip = _this.routeinfo.routeinfo.pickupTrip;
            _this.sel_droptrip = _this.routeinfo.routeinfo.dropTrip;
        });
    };
    AddRouteComponent.prototype.createForm = function () {
        this.studentDetails = this.formBuilder.group({
            pickuproute: [""],
            pickuptrip: [""],
            pickupstop: [""],
    ...
    AddRouteComponent.prototype.ngOnInit = function () {
        ...
        this.type = this.mode;
        setTimeout(function () {
            _this.createMap(_this.type);
        }, 2000);
    };
    AddRouteComponent.prototype.onClickLocationGetter = function () {
        var _this = this;
        this.map.on("click", function (evt) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
...
var AddStudentComponent = /** @class */ (function () {
    function AddStudentComponent(modalController, formBuilder, mapService, ajaxService, commonService, alertController) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.mapService = mapService;
        this.ajaxService = ajaxService;
    ...
    AddStudentComponent.prototype.editmethod = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/student/get/studentdetails?stin=" + this.value;
        this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
            _this.studentinfo = JSON.parse(res);
            _this.update = "available";
            _this.editTextbox = true;
            _this.sectionIds =
                _this.classsectionid[_this.studentinfo.studentinfo.classId];
            _this.studentDetails.patchValue({
                rollno: _this.studentinfo.studentinfo.rollNo,
                firstname: _this.studentinfo.studentinfo.studentName1,
                gender: _this.studentinfo.studentinfo.sex,
                parentName: _this.studentinfo.studentinfo.parentId,
                sectionId: _this.studentinfo.studentinfo.sectionId,
                classId: _this.studentinfo.studentinfo.classId,
                tagId: _this.studentinfo.studentinfo.tagId,
                // lastname:this.studentinfo.studentinfo.studentName2,
                dob: _this.studentinfo.studentinfo.dob,
                address: _this.studentinfo.studentinfo.address,
                state: _this.studentinfo.studentinfo.state,
                district: _this.studentinfo.studentinfo.district,
                pincode: _this.studentinfo.studentinfo.pincode,
            });
        });
    };
    AddStudentComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    AddStudentComponent.prototype.createForm = function () {
        this.studentDetails = this.formBuilder.group({
    ...
    AddStudentComponent.prototype.submit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var datas, url;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this.update != "available") {
                    url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/student/add/studentdetails";
                ...
                this.ajaxService.ajaxPostMethod(url, datas).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        if (res.message == "success") {
    ...
    AddStudentComponent.prototype.genderSelection = function (ev) {
    ...
    AddStudentComponent.prototype.getdetails = function () {
        var _this = this;
        var companyDatas = {
            schoolId: localStorage.getItem("corpId"),
            branchId: localStorage.getItem("corpId"),
        ...
        data.forEach(function (element) {
            if (Object.keys(element)[0] !== "tagId") {
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + Object.values(element);
                _this.ajaxService.ajaxGet(url).subscribe(function (res) {
                    if (Object.keys(element)[0] == "pickupRoute") {
                        _this.pickuproute = _this.droproute = res;
                    }
                    else if (Object.keys(element)[0] == "pickuptrip") {
                        _this.pickuptrip = _this.droptrip = res;
                    }
                    else if (Object.keys(element)[0] == "pickupStop") {
                        _this.pickupstop = _this.dropstop = res;
                    }
                ...
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
                    ...
                    "&branchId=" +
                    localStorage.getItem("corpId");
                _this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
                    _this.selecttagid = JSON.parse(res);
                });
            }
        });
    };
    AddStudentComponent.prototype.getAlerts = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web + "/student/getPreferences?key=Sktalert&companyId=demo";
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            _this.alertOption = res;
        });
    };
    AddStudentComponent.prototype.getclassIds = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
            ...
            localStorage.getItem("corpId");
        this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
            _this.classsectionid = JSON.parse(res);
            _this.classid = Object.keys(_this.classsectionid);
        });
    };
    AddStudentComponent.prototype.parentNames = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["serverUrl"].web +
            "/student/getParentname?companyId=" +
            localStorage.getItem("corpId");
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.parentDetailsList = res;
        });
    };
    AddStudentComponent.prototype.getsectionId = function (ev) {
        this.studentDetails.patchValue({
            sectionId: "",
        });
...
var StudentAddtionalComponent = /** @class */ (function () {
    function StudentAddtionalComponent(modalController, formBuilder, mapService, ajaxService, commonService) {
        var _this = this;
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.mapService = mapService;
    ...
    StudentAddtionalComponent.prototype.openDetailsModel = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal, modal, modal, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(data == "classDetails")) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.modalController.create({
                    ...
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        if (!(data == "parentDetails")) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.modalController.create({
                    ...
                    case 6:
                        if (!(data == "tagDetails")) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.modalController.create({
                    ...
                    case 9:
                        if (!(data == "routeandTrip")) return [3 /*break*/, 12];
                        return [4 /*yield*/, this.modalController.create({
    ...
    StudentAddtionalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    StudentAddtionalComponent.prototype.selectDetails = function (data, value) {
    ...
    StudentAddtionalComponent.prototype.closeCircle = function (data, value) {
        if (data == "parentDetails") {
            this.parentDetails = value;
        }
        else if (data == "tagdetails") {
    ...
    StudentAddtionalComponent.prototype.submit = function () {
        var _this = this;
        var datas = {
    ...
    StudentAddtionalComponent.prototype.genderSelection = function (ev) {
    ...
    StudentAddtionalComponent.prototype.createForm = function () {
        this.studentDetails = this.formBuilder.group({
            rollno: ['',],
            firstname: ['',],
            contactno: ['',],
    ...
    StudentAddtionalComponent.prototype.ionViewWillEnter = function () {
        var _this = this;
        setTimeout(function () {
            if (_this.map.setTarget)
                _this.map.setTarget(_this.mapElement.nativeElement);
    ...
    StudentAddtionalComponent.prototype.getdetails = function () {
        var _this = this;
        var companyDatas = {
            schoolId: localStorage.getItem('corpId'),
            branchId: localStorage.getItem('corpId')
        };
        var data = [{ "classId": '/student/classIds?schoolId=' + companyDatas.schoolId + '&branchId=' + companyDatas.branchId },
        ...
        data.forEach(function (element) {
            if (Object.keys(element)[0] !== "tagId") {
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["serverUrl"].web + Object.values(element);
                _this.ajaxService.ajaxGet(url).subscribe(function (res) {
                    if (Object.keys(element)[0] == "classId") {
                        _this.classid = res;
                    }
                    else if (Object.keys(element)[0] == "sectionIds") {
                        _this.sectionIds = res;
                    }
                ...
                //   this.selecttagid = res;
                // })
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["serverUrl"].web + '/tag/tagId?schoolId=' + localStorage.getItem('corpId') + '&branchId=' + localStorage.getItem('corpId');
                _this.ajaxService.ajaxGetObject(url).subscribe(function (res) {
                    _this.selecttagid = JSON.parse(res);
                });
            }
    ...
    StudentAddtionalComponent.prototype.getAlerts = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["serverUrl"].web + '/student/getPreferences?key=Sktalert&companyId=demo';
        this.ajaxService.ajaxGetPerference(url).subscribe(function (res) {
            _this.alertOption = res;
        });
    };
    StudentAddtionalComponent.prototype.parentNames = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["serverUrl"].web + '/student/getParentname?companyId=' + localStorage.getItem('corpId');
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.parentDetailsList = res;
        });
    };
    // yasir code for alerts
    StudentAddtionalComponent.prototype.selectData = function (alertchecks) {
    ...
    StudentAddtionalComponent.prototype.submitData = function () {
        var postDatas = [];
        for (var i = 0; i < this.selectedArray.length; i++) {
    ...
    //
    StudentAddtionalComponent.prototype.ngOnInit = function () {
        this.parentNames();
        this.getAlerts();
        this.getdetails();
        this.loadMap();
    ...
    StudentAddtionalComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: src_app_services_auth_map_service__WEBPACK_IMPORTED_MODULE_8__["AuthMapService"] },
    ...
    return StudentAddtionalComponent;
}());
...
var StudentClassAdditionalComponent = /** @class */ (function () {
    function StudentClassAdditionalComponent() {
    }
    StudentClassAdditionalComponent.prototype.ngOnInit = function () { };
    ...
    return StudentClassAdditionalComponent;
}());
...
_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"];
var TagAdditionalComponent = /** @class */ (function () {
    function TagAdditionalComponent(modalController, formBuilder, ajaxService, commonService) {
        this.modalController = modalController;
        this.formBuilder = formBuilder;
        this.ajaxService = ajaxService;
        this.commonService = commonService;
    ...
    TagAdditionalComponent.prototype.closeModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.modalController.dismiss();
                return [2 /*return*/];
    ...
    TagAdditionalComponent.prototype.createForm = function () {
        this.tagLogin = this.formBuilder.group({
            tagId: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            tagType: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
    };
    TagAdditionalComponent.prototype.getTagTypes = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + ("/login/getPreferences?key=Tagtype&companyId=" + this.companyDetail.companyID);
        this.ajaxService.ajaxGetPerference(url)
            .subscribe(function (res) {
            _this.tagTypes = res;
        });
    };
    TagAdditionalComponent.prototype.ngOnInit = function () {
        this.companyDetail = {
            branchID: localStorage.getItem('corpId'),
            companyID: localStorage.getItem('corpId'),
            userId: localStorage.getItem('userName')
    ...
    TagAdditionalComponent.prototype.submitBtn = function () {
        var _this = this;
        var data = {
        ...
        this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) {
            if (res.message == "Added Successfully") {
                _this.commonService.presentToast('Tag Details Added Successfully');
                _this.modalController.dismiss();
            }
            else if (res.message == "Updated Successfully") {
                _this.modalController.dismiss();
                _this.commonService.presentToast('Tag Details Updated Successfully');
            }
            else {
                _this.commonService.presentToast('Contact Support team');
            }
    ...
    TagAdditionalComponent.ctorParameters = function () { return [
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_5__["AjaxService"] },
        { type: src_app_services_common_service__WEBPACK_IMPORTED_MODULE_4__["CommonService"] }
...
//# sourceMappingURL=default~skt-broad-broadcast-sms-broadcast-sms-module~skt-classdetails-class-table-class-table-module~9126c301-es5.js.map