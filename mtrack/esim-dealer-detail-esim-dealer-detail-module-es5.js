...
var EsimDealerDetailPageModule = /** @class */ (function () {
    function EsimDealerDetailPageModule() {
    }
    ...
    return EsimDealerDetailPageModule;
}());
...
var EsimDealerDetailPage = /** @class */ (function () {
    function EsimDealerDetailPage(platform, formBuilder, modalController, ajaxService, alertController, commonService, ete) {
        var _this = this;
        ...
        this.getinvoicelist = function (event) {
            if (event.value)
                _this.DealerForm.value.InvoiceNo = event.value;
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
                ...
                _this.DealerForm.value.InvoiceNo;
        ...
        this.getseriallist = function (event) {
            if (event.value)
                _this.DealerForm.value.SerialNo = event.value;
        };
    }
    EsimDealerDetailPage.prototype.scrollToTop = function () {
        this.content.scrollToTop(500);
    };
    EsimDealerDetailPage.prototype.scrollToBottom = function () {
        this.content.scrollToBottom(500);
    };
    EsimDealerDetailPage.prototype.logScrolling = function (ev) {
    ...
    EsimDealerDetailPage.prototype.clear = function (d) {
    ...
    EsimDealerDetailPage.prototype.reset = function () {
        this.DealerForm.patchValue({
            SerialNo: "",
        });
    };
    EsimDealerDetailPage.prototype.getdealerlist = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web +
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            if (data.data.data == "CA Request Saved Successfully") {
                                ...
                                _this.data = "CA Request Saved Successfully";
                                _this.show = false;
                                _this.clear();
                                _this.SearchData();
                            }
    ...
    //   }
    // });
    EsimDealerDetailPage.prototype.SearchData = function () {
        var _this = this;
    ...
    EsimDealerDetailPage.prototype.myGridOnRowSelect = function (event) {
    ...
    EsimDealerDetailPage.prototype.newfunc = function () {
    ...
    EsimDealerDetailPage.prototype.ngOnInit = function () {
    ...
    EsimDealerDetailPage.prototype.ngAfterViewInit = function () {
        this.myGrid.horizontalscrollbarstep(["70"]);
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    EsimDealerDetailPage.prototype.ionViewWillEnter = function () {
        this.data = undefined;
        this.clear();
        this.getdealerlist();
        this.SearchData();
    };
    EsimDealerDetailPage.ctorParameters = function () { return [
...
var RequestDetailsComponent = /** @class */ (function () {
    function RequestDetailsComponent(platform, formBuilder, modalController, ajaxService, commonService) {
        this.platform = platform;
        this.formBuilder = formBuilder;
        this.modalController = modalController;
        this.ajaxService = ajaxService;
    ...
    RequestDetailsComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    RequestDetailsComponent.prototype.createForm = function () {
        this.confirmForm = this.formBuilder.group({
            validity: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
    };
    RequestDetailsComponent.prototype.submitBtn = function () {
        var _this = this;
        this.commonService.presentLoader();
        this.button = true;
        var arr = [];
        this.value.map(function (data) {
            arr.push(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { validityperiod: _this.confirmForm.value.validity }));
        });
...
//# sourceMappingURL=esim-dealer-detail-esim-dealer-detail-module-es5.js.map