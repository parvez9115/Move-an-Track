...
@Component({
  ...
  templateUrl: './forgotpassdealer.component.html',
  styleUrls: ['./forgotpassdealer.component.scss'],
})
export class ForgotpassdealerComponent implements OnInit {
  forgetPass: any;
  appName: string;
  color ={
  ...
  submitPass() {
    ...
    let url = serverUrl.web + "/login/company/branch/dealer/forgetpassword";
