...
var RsuIccidDetailsPageModule = /** @class */ (function () {
    function RsuIccidDetailsPageModule() {
    }
    ...
    return RsuIccidDetailsPageModule;
}());
...
var RsuIccidDetailsPage = /** @class */ (function () {
    function RsuIccidDetailsPage(formBuilder, commonService, ajaxService) {
        this.formBuilder = formBuilder;
        this.commonService = commonService;
        this.ajaxService = ajaxService;
    }
    RsuIccidDetailsPage.prototype.clear = function () {
        this.rsuForm.patchValue({
            fileupload: "",
        });
    };
    RsuIccidDetailsPage.prototype.onFileChange = function (ev) {
        var _this = this;
        ...
        if (this.name == true) {
            ...
            reader_1.onload = function (event) {
                ...
                for (var i = 0; i < jsonData_1["Sheet1"].length; i++) {
                    jsonData_1["Sheet1"][i]["iccidno"] = jsonData_1["Sheet1"][i]["iccidno"].toString();
                    jsonData_1["Sheet1"][i]["imeino"] = jsonData_1["Sheet1"][i]["imeino"].toString();
    ...
    RsuIccidDetailsPage.prototype.SearchData = function () {
        var _this = this;
        if (this.dataString.length == 0) {
            ...
            if (this.name == true && this.excellKeyValid == true) {
                ...
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + '/sensorise/saveSensoriseRSUICCID';
    ...
    RsuIccidDetailsPage.prototype.getrsudetails = function () {
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.tableData = res.icciddetail;
            ...
            _this.columns = [
                { text: 'ICCID No', datafield: 'iccidno', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 630 },
                { text: 'IMEI No', datafield: 'imeino', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center', width: 630 },
            ];
        });
    };
    RsuIccidDetailsPage.prototype.ngOnInit = function () {
        this.createForm();
        this.getrsudetails();
    };
    RsuIccidDetailsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=rsu-iccid-details-rsu-iccid-details-module-es5.js.map