...
let AddTransportDetailsComponent = class AddTransportDetailsComponent {
    constructor(platform, formBuilder, modalController, alertController, commonService, ajaxService, pdfLogoService) {
        ...
        this.getinvoicelist = (event) => {
            if (event.value)
                this.tansportForm.value.distributor = event.value;
    ...
    edit(data) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (data == "edit") {
                ...
                const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["serverUrl"].web + "/esim/saveEsimTrasnsportDetails";
...
AddTransportDetailsComponent.ctorParameters = () => [
...
let EsimTransportDetailsPageModule = class EsimTransportDetailsPageModule {
};
...
let EsimTransportDetailsPage = class EsimTransportDetailsPage {
...
EsimTransportDetailsPage.ctorParameters = () => [
...
//# sourceMappingURL=esim-transport-details-esim-transport-details-module-es2015.js.map