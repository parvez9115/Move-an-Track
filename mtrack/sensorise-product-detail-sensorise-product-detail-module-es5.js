...
var SensoriseProductDetailPageModule = /** @class */ (function () {
    function SensoriseProductDetailPageModule() {
    }
    ...
    return SensoriseProductDetailPageModule;
}());
...
var SensoriseProductDetailPage = /** @class */ (function () {
    function SensoriseProductDetailPage(commonService, formBuilder, ajaxService, ete, platform) {
    ...
    SensoriseProductDetailPage.prototype.createForm = function () {
        var now = new Date();
    ...
    SensoriseProductDetailPage.prototype.clear = function () {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        var today = now.getFullYear() + "-" + month + "-" + day;
    ...
    SensoriseProductDetailPage.prototype.add = function () {
        var _this = this;
        this.button = true;
        var data;
        data = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/sensorise/saveSensoriseProductDetails";
    ...
    SensoriseProductDetailPage.prototype.setValue = function () {
        var _this = this;
        this.button = false;
        this.hideSerialNo = true;
        this.commonService.presentLoader();
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/sensorise/getSensoriseProducts";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.editvalue = res;
            _this.commonService.dismissLoader();
            _this.productdetails.patchValue({
                actionname: _this.selectedRow.actionname,
                productname: _this.selectedRow.productname,
                price: _this.selectedRow.price,
                latefees: _this.selectedRow.latefees,
            });
            var data = _this.editvalue.filter(function (f) { return f.itemname == _this.selectedRow.zohoproductname; });
            _this.product = data[0];
        });
    };
    SensoriseProductDetailPage.prototype.edit = function () {
        var _this = this;
        this.button = true;
        var data;
        data = {
    ...
    SensoriseProductDetailPage.prototype.getdatas = function () {
        var _this = this;
        this.commonService.presentLoader();
    ...
    SensoriseProductDetailPage.prototype.getproductname = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/sensorise/getSensoriseProducts";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.books = res;
    ...
    SensoriseProductDetailPage.prototype.selectvalue = function (ev) {
    ...
    SensoriseProductDetailPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    SensoriseProductDetailPage.prototype.ngAfterViewInit = function () {
        this.myGrid.pagesizeoptions(["100", "200", "500", "1000"]);
    };
    SensoriseProductDetailPage.prototype.ngOnInit = function () {
    ...
    SensoriseProductDetailPage.prototype.ionViewWillEnter = function () {
        this.getdatas();
        this.clear();
        this.getproductname();
    };
    SensoriseProductDetailPage.ctorParameters = function () { return [
    ...
    return SensoriseProductDetailPage;
}());
...
//# sourceMappingURL=sensorise-product-detail-sensorise-product-detail-module-es5.js.map