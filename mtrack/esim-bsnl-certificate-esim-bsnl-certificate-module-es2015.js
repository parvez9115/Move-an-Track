...
let EsimBsnlCertificatePageModule = class EsimBsnlCertificatePageModule {
};
...
let EsimBsnlCertificatePage = class EsimBsnlCertificatePage {
    ...
    invoicepop() {
        if (this.zohocount != 0) {
            ...
            this.commonService.presentLoader();
            const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["serverUrl"].web + "/esim/getcertificatezohobookproductdetails";
            this.ajaxService.ajaxPostWithBody(url, data).subscribe((res) => {
                this.commonService.dismissLoader();
...
EsimBsnlCertificatePage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"] },
...
//# sourceMappingURL=esim-bsnl-certificate-esim-bsnl-certificate-module-es2015.js.map