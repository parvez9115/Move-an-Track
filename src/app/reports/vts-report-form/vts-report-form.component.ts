...
export class VtsReportFormComponent implements OnChanges {
  ...
  onsubmit() {
    ...
    let router: string;
    if (
      this.reportsTitle == "Executive summary report" ||
      this.reportsTitle == "Driver behaviour report" ||
      this.reportsTitle == "Alert report" ||
      this.reportsTitle == "Fuel consumption report"
    ) {
      this.vin = "All";
    }
    ...
    switch (this.reportsTitle) {
      case "Overall summary report":
        if (
          this.vin == undefined ||
          this.reports.value.fromDate == "" ||
          this.reports.value.toDate == ""
        ) {
          this.commonService.presentToast("Please select the valid data");
          return null;
        } else {
          if (typeof this.vin == "object") {
            this.vin = this.vin.plateNo;
          } else {
            this.vin;
          }
      ...
      case "Engine Hours summary report":
        if (
          ...
          this.reports.value.fromDate == "" ||
          this.reports.value.toDate == "" ||
          this.reports.value.fromTime == "" ||
          this.reports.value.toTime == ""
        ) {
          this.commonService.presentToast("Please select the valid data");
          return null;
        } else {
          ...
          body["company"] = localStorage.corpId;
          body["fromDate"] =
            this.reports.value.fromDate.split("T")[0] +
            " " +
            this.reports.value.fromTime;
          body["toDate"] =
            this.reports.value.toDate.split("T")[0] +
            " " +
            this.reports.value.toTime;
      ...
      case "Speed report":
        if (this.vin == undefined || this.reports.value.fromDate == "") {
          ...
          body["vin"] = this.vin;
          body["fromDate"] =
            this.reports.value.fromDate.split("T")[0] + " 00:00:00 AM";
          body["toDate"] =
            this.reports.value.fromDate.split("T")[0] + " 11:59:59 PM";
          body["userId"] = localStorage.userName;
      ...
      case "Movement report":
        if (this.vin == undefined || this.reports.value.fromDate == "") {
          ...
          body["vin"] = this.vin;
          body["fromDate"] =
            this.reports.value.fromDate.split("T")[0] + " " + "00:00:00";
          body["toDate"] =
            this.reports.value.fromDate.split("T")[0] + " " + "23:59:59";
          body["userID"] = localStorage.userName;
          body["branchID"] = localStorage.corpId;
          body["companyID"] = localStorage.corpId;
      ...
      case "Temperature report":
        if (
          ...
          body["fromDate"] =
            this.reports.value.fromDate.split("T")[0] + " 00:00:00";
          body["toDate"] =
            this.reports.value.toDate.split("T")[0] + " 23:59:59";
          body["userId"] = localStorage.userName;
          body["branchId"] = localStorage.corpId;
          body["companyId"] = localStorage.corpId;
      ...
      case "Student Alert Report":
        if (
          this.reports.value.fromDate == undefined ||
          this.reports.value.fromDate == "" ||
          this.reports.value.toDate == undefined ||
          this.reports.value.toDate == ""
        ) {
          this.commonService.presentToast("Please select the valid data");
          return null;
      ...
      case "Attendance report":
        if (
          this.reports.value.date == undefined ||
          this.reports.value.date == ""
        ) {
      ...
      case "Fms Trip Report":
        if (
          this.reports.value.vin == undefined ||
          this.reports.value.vin == "" ||
          this.reports.value.tripname == "" ||
          this.reports.value.fromDate == "" ||
          this.reports.value.toDate == ""
        ) {
          this.commonService.presentToast("Please select the valid data");
    ...
    this.ajaxService.ajaxReportServices(
      mode,
      body,
      router,
    ...
    if (res == undefined) {
          ...
          for (let i = 0; i < this.objValues.length; i++) {
            if (this.reportsTitle == "Movement report") {
              ...
              this.odj.push([
                ...
                this.objValues[i].speed,
                this.objValues[i].status,
                this.objValues[i].timeStamp,
              ...
              this.odj.push([
                this.objValues[i].plateNo,
                this.objValues[i].begin,
                this.objValues[i].beginLocation,
                this.objValues[i].end,
                this.objValues[i].endLocation,
                this.objValues[i].maxSpeed,
                this.objValues[i].odometer,
                this.objValues[i].runningDuration,
                this.objValues[i].stopDuration,
                this.objValues[i].idleDuration,
                this.objValues[i].towedDuration,
              ]);
              ...
              this.odj.push([
                this.objValues[i].plateNo,
                this.objValues[i].startTime,
                this.objValues[i].startAddress,
                this.objValues[i].endTime,
                this.objValues[i].stopAddress,
                this.objValues[i].odometer,
                this.objValues[i].runningDuration,
                this.objValues[i].idleDuration,
              ]);
              ...
              this.odj.push([
                ...
                this.objValues[i].speed,
                this.objValues[i].timeStamp,
                this.objValues[i].dateStamp,
                this.objValues[i].operator,
              ...
              this.odj.push([
                this.objValues[i]["Plate No"],
                this.objValues[i].Odometer,
                this.objValues[i].Begin,
                this.objValues[i]["Begin At"],
                this.objValues[i].End,
                this.objValues[i]["End At"],
                this.objValues[i].Stop,
                this.objValues[i].Towed,
                this.objValues[i].Running,
                this.objValues[i].Idle,
              ]);
              //////console.log(this.odj, "----------Odj");
              ...
              this.odj.push([
                ...
                this.objValues[i].start,
                this.objValues[i].end,
                this.objValues[i].min,
                this.objValues[i].max,
                this.objValues[i].avg,
              ]);
              //////console.log(this.odj, "----------Odj");
              ...
              if (this.objValues[i].TEMPERATURESENSOR4) {
                ...
                this.excelTitle = {
                  "Plate No": 0,
                  Timestamp: 1,
                  "Temprature Sensor 1": 2,
                  "Temprature Sensor 2": 3,
                  "Temprature Sensor 3": 4,
                ...
                this.odj.push([
                  ...
                  this.objValues[i].TimeStamp,
                  "Name:" +
                    this.objValues[i].TEMPERATURESENSOR1.name +
                    ", Min:" +
                    this.objValues[i].TEMPERATURESENSOR1.min +
                    ", Max:" +
                    this.objValues[i].TEMPERATURESENSOR1.max +
                    ", Value:" +
                    this.objValues[i].TEMPERATURESENSOR1value,
                  "Name:" +
                    this.objValues[i].TEMPERATURESENSOR2.name +
                    ", Min:" +
                    this.objValues[i].TEMPERATURESENSOR2.min +
                    ", Max:" +
                    this.objValues[i].TEMPERATURESENSOR2.max +
                    ", Value:" +
                    this.objValues[i].TEMPERATURESENSOR2value,
                  "Name:" +
                    this.objValues[i].TEMPERATURESENSOR3.name +
                    ", Min:" +
                    this.objValues[i].TEMPERATURESENSOR3.min +
                    ", Max:" +
                    this.objValues[i].TEMPERATURESENSOR3.max +
                    ", Value:" +
                    this.objValues[i].TEMPERATURESENSOR3value,
                  "Name:" +
                    this.objValues[i].TEMPERATURESENSOR4.name +
                    ", Min:" +
                    this.objValues[i].TEMPERATURESENSOR4.min +
                    ", Max:" +
                    this.objValues[i].TEMPERATURESENSOR4.max +
                    ", Value:" +
                    this.objValues[i].TEMPERATURESENSOR4value,
                ]);
              ...
              this.odj.push([
                this.objValues[i].plateNo,
                this.objValues[i].DoorStatus,
                this.objValues[i].timeDuration,
                this.objValues[i].startTimeStamp,
                this.objValues[i].endTimeStamp,
              ]);
              //////console.log(this.odj, "----------Odj");
              ...
              this.odj.push([
                this.objValues[i].plateNo,
                this.objValues[i].date,
                this.objValues[i].beginLocation,
                this.objValues[i].endLocation,
                this.objValues[i].consumePrice,
                this.objValues[i].odometer,
                this.objValues[i].fuelType,
                this.objValues[i].price,
                this.objValues[i].consumeQuantity,
                this.objValues[i].mileage,
              ]);
              //////console.log(this.odj, "----------Odj");
              ...
              this.excelTitle = {
                ...
                Odometer: 1,
                "Last maintanance": 2,
                "Last maintenance time": 3,
                "Due kilometer": 4,
                Status: 5,
              };
              this.odj.push([
                this.objValues[i].plateno,
                this.objValues[i].currentOdometer,
                this.objValues[i].lastmaintenance,
                this.objValues[i].lastmaintenancetime,
                this.objValues[i].duekilometer,
                this.objValues[i].status,
              ]);
              ...
              this.odj.push(
                [
                  this.objValues[i].StudentName,
                  this.objValues[i].ContactNo,
                ].concat(arr)
              );
              ...
              this.odj.push([
                this.objValues[i].rollNo,
                this.objValues[i].firstName,
                this.objValues[i].classId,
                this.objValues[i].sectionId,
                this.objValues[i].mode,
              ]);
              ...
              this.odj.push([
                this.objValues[i].vin,
                this.objValues[i].startlocation,
                this.objValues[i].startdate,
                this.objValues[i].starttime,
                this.objValues[i].endlocation,
                this.objValues[i].enddate,
                this.objValues[i].endtime,
                this.objValues[i].duration,
                this.objValues[i].distance,
              ]);
              ...
              this.odj.push([
                this.objValues[i].PlateNo,
                this.objValues[i].Driver,
                this.objValues[i].StartDate,
                this.objValues[i].StartTime,
                this.objValues[i].EndDate,
                this.objValues[i].EndTime,
                this.objValues[i].tripname,
                this.objValues[i].Total.TotalIncome,
                this.objValues[i].Total.TotalExpense,
                this.objValues[i].Total.AmountRemained,
              ]);
              ...
              this.odj.push([
                this.objValues[1].Income,
                this.objValues[1].Expense,
                Object.keys(this.objValues[2]) +
                  ":" +
                  Object.values(this.objValues[2]),
              ]);
            }
          }
      ...
      if (validation) {
        if (this.reportsTitle != "Movement report") {
          ...
          adminLocalStorage.reportData = JSON.stringify(res);
        }
        this.test = res;
        if (this.myPlatform != "desktop") {
          this.router.navigateByUrl(
            "reports/" + this.plateNo + "/" + outputRouter,
            { state: { data: res } }
          );
          this.getBack();
        } else {
  ...
  portChange = (event: { component: IonicSelectableComponent; value: any }) => {
    if (event.value.vin) this.vin = event.value.vin;
    else this.vin = event.value;
    var url =
      serverUrl.fmsUrl +
      "/trip/getFmsReportTrip?companyid=" +
  ...
  porttrip = (event: { component: IonicSelectableComponent; value: any }) => {
    if (event.value) this.tripname = event.value;
    if (this.tripname == 0) {
  ...
  ngOnChanges() {
    ...
    if (app.appName != "FMS") {
      ...
      if (this.d == "All") {
        this.dashboarData.splice(0, 0, { plateNo: "All" });
      } else {
        this.dashboarData.slice(0);
      }
    ...
    if (this.plateNo !== "null") {
      ...
      if (
        this.reportsTitle == "Executive summary report" ||
        this.reportsTitle == "Driver behaviour report" ||
        this.reportsTitle == "Door count report" ||
        this.reportsTitle == "Fuel consumption report" ||
        this.reportsTitle == "Alert report" ||
        this.reportsTitle == "Student Alert Report" ||
        this.reportsTitle == "Attendance report"
      ) {
        this.vin = "All";
      }
    }
    if (
      this.reportsTitle == "Alarm report" ||
      this.reportsTitle == "Temperature report" ||
      this.reportsTitle == "Door open report" ||
      this.reportsTitle == "Door summary report" ||
      this.reportsTitle == "Door count report" ||
      this.reportsTitle == "Alarm report"
    ) {
      let today = new Date();
  ...
  getRoutetype() {
    ...
    var url =
      serverUrl.web +
      `/routetrip/getRoutename?compId=${companyDetail.companyID}&branchId=${companyDetail.branchID}`;
  ...
  getvehicletype() {
    var url =
      serverUrl.fmsUrl +
      "/dashboard/getVehicleList?companyid=" +
      localStorage.getItem("corpId") +
      "&userid=" +
