...
export class AddCertificateComponent implements OnInit {
            ...
            this.ajaxService.ajaxPutMethod(url, testData).subscribe((res) => {
              ...
              if (res.message == "Success") {
                ...
                this.router.navigateByUrl(
                  "/tabs-login/certificate-generation",
                  {
                    state: {
                      imeiNumber: this.certificatedetails.value.imeiNumber,
                    },
  ...
  createform() {
    this.certificatedetails = this.formBuilder.group({
      ...
      distributerAddress: ["", Validators.required],
      distributerNo: ["", Validators.required],
      uniqueno: ["", Validators.required],
      ccid: ["", Validators.required],
      tagno: ["", Validators.required],
      paniccount: ["0"],
      validupto: ["", Validators.required],
      warrantyupto: ["", Validators.required],
