...
var AisDashboardPageModule = /** @class */ (function () {
    function AisDashboardPageModule() {
    }
...
var AisDashboardPage = /** @class */ (function () {
    function AisDashboardPage(ajaxService, router, commonService, websocketService, modalController, firebaseX, device, authenticationService, udid, platform, statusBar, network, menuController, alertController, appVersion, market, locat) {
        var _this = this;
    ...
    AisDashboardPage.prototype.loadExternalScript = function () {
        var _this = this;
    ...
    AisDashboardPage.prototype.wsResponse = function (json) {
        ...
        if (data) {
            ...
            var data_1 = [];
            for (var i = 0; i < Object.keys(json.liveDatas).length; i++) {
                var currentCount = Object.values(json.liveDatas)[i];
    ...
    AisDashboardPage.prototype.wsOnError = function () {
        var _this = this;
        setTimeout(function () {
            _this.websocketService.connectSocket(JSON.parse(localStorage.dashboardWebSocketData), "livetrack");
        }, 60000);
    };
    AisDashboardPage.prototype.updateData = function (json) {
        var e_1, _a;
    ...
    AisDashboardPage.prototype.restartApp = function () {
    ...
    AisDashboardPage.prototype.pushNotificationConfig = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var pushDetails;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AisDashboardPage.prototype.ionViewWillEnter = function () {
    ...
    //   }
    // }
    AisDashboardPage.prototype.routerModal = function (count, type) {
        if (count > 0) {
    ...
    //   });
    // }
    AisDashboardPage.prototype.bellRouter = function () {
        this.router.navigateByUrl('/tabs/alerts/All');
    };
    AisDashboardPage.prototype.alertConfiguration = function () {
    ...
    AisDashboardPage.prototype.appUpdate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    AisDashboardPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AisDashboardPage.prototype.alertCountHeader = function () {
        var _this = this;
    ...
    AisDashboardPage.prototype.backButtonExit = function () {
        var _this = this;
    ...
    AisDashboardPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/];
            });
    ...
    AisDashboardPage.prototype.ionViewWillLeave = function () {
        //console.log('leave')
        //  this.subscription.unsubscribe();
    };
    AisDashboardPage.prototype.totalVehicleCount = function () {
    ...
    AisDashboardPage.prototype.totalHrsDistributionChart = function (chartData, text, colors) {
    ...
    AisDashboardPage.prototype.totalHrsDistributionSummary = function (data) {
        var _this = this;
        var commonService = this.commonService;
        var firstChartWord = "";
        var secondChartWord = "";
    ...
    AisDashboardPage.prototype.vehicleStatus = function (statusType, categories, data, color, format) {
        var count = 0;
    ...
    AisDashboardPage.prototype.overspeedStatus = function (data) {
        var _this = this;
    ...
    AisDashboardPage.prototype.unUsedAssert = function (data) {
        var _this = this;
    ...
    AisDashboardPage.prototype.engineHours = function (data) {
        var _this = this;
        var engineHoursName = [];
    ...
    AisDashboardPage.prototype.vehicleOdometer = function (data) {
        var _this = this;
    ...
    AisDashboardPage.prototype.vehicleSummaries = function (statusType, categories, data, color) {
        var res = this.res;
        var i = 0;
        var xText = "";
        var yText = "";
        ...
        var table = function (datas) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(datas != '')) return [3 /*break*/, 3];
                            return [4 /*yield*/, modal.create({
                        ...
                        case 1:
                            pmodal = _a.sent();
                            pmodal.onDidDismiss().then(function () {
                            });
                            return [4 /*yield*/, pmodal.present()];
                    ...
                    events: {
                        click: function (event) {
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                                var ev_name;
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    ev_name = event.point.options.name;
    ...
    AisDashboardPage.prototype.table = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AisDashboardPage.prototype.alertsAndCounts = function (data) {
        var alertsType = [];
        var basicAlertsAndCount = { 'Overspeed': '', 'Idle': '', 'Stop': '', 'Engine On': '' };
        var alertsCount = [];
        var reqJson;
    ...
    AisDashboardPage.prototype.odometer = function (data) {
        var _this = this;
        var speedRatio = [];
        var odometer = {};
        var speedVehicle = [];
    ...
    AisDashboardPage.prototype.speedometer = function (data) {
        var _this = this;
        var speedRatio = [];
        var speedometer = {};
        var speedVehicle = [];
    ...
    AisDashboardPage.prototype.unUsedVehicleStatus = function (data) {
        var _this = this;
        var speedRatio = [];
    ...
    AisDashboardPage.prototype.noOfDoorOpen = function (data) {
        var _this = this;
    ...
    AisDashboardPage.prototype.noOfPowerFail = function (data) {
        var _this = this;
    ...
    AisDashboardPage.prototype.vehicleSummary3d = function (statusType, categories, data) {
        var router = this.router;
        var commonService = this.commonService;
        highcharts_highcharts_3d_src__WEBPACK_IMPORTED_MODULE_13___default()(highcharts__WEBPACK_IMPORTED_MODULE_12__);
        highcharts__WEBPACK_IMPORTED_MODULE_12__["chart"](statusType, {
    ...
    AisDashboardPage.ctorParameters = function () { return [
...
//# sourceMappingURL=ais-dashboard-ais-dashboard-module-es5.js.map