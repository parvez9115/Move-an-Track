...
var AddSaleComponent = /** @class */ (function () {
    function AddSaleComponent(formBuilder, modalController, ajaxService, commonService) {
        var _this = this;
        ...
        this.tableData = [];
        this.today = new Date();
        this.getdealerlist = function (event) {
            if (event.value)
                _this.salesForm.value.distributor = event.value;
        };
    }
    AddSaleComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    AddSaleComponent.prototype.submitBtn = function () {
        var _this = this;
        var data;
        data = {
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/sensorise/saveSensoriseSales";
    ...
    AddSaleComponent.prototype.click = function (event) {
        var _this = this;
    ...
    AddSaleComponent.prototype.deleteAnalogRow = function (row) {
        this.tableData.splice(row, 1);
        this.source = { localdata: this.tableData };
        this.dataAdapter = new jqx.dataAdapter(this.source);
    };
    AddSaleComponent.prototype.reset = function () {
        this.salesForm.patchValue({
            SerialNo: "",
        });
    };
    AddSaleComponent.prototype.createForm = function () {
        var now = new Date();
    ...
    AddSaleComponent.prototype.getDealer = function () {
        var _this = this;
    ...
    AddSaleComponent.ctorParameters = function () { return [
...
var SalesDetailPageModule = /** @class */ (function () {
...
var SalesDetailPage = /** @class */ (function () {
    function SalesDetailPage(platform, modalController, alertController, commonService, ajaxService) {
    ...
    SalesDetailPage.prototype.getDatas = function () {
        var _this = this;
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + '/sensorise/getSensoriseSalesAll?companyid=' + localStorage.getItem('corpId');
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            ...
            _this.dataAdapter = new jqx.dataAdapter(_this.source);
            _this.columns = [
                { text: 'Invoice Number', datafield: 'invoiceno', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Sales Distributor', datafield: 'saledistributor', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Sales Date', datafield: 'saledate', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Sales Quantity', datafield: 'totalquantity', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
    ...
    SalesDetailPage.prototype.viewModel = function () {
    ...
    SalesDetailPage.prototype.openModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SalesDetailPage.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
    };
    SalesDetailPage.prototype.ngOnInit = function () {
        this.getDatas();
    };
    SalesDetailPage.ctorParameters = function () { return [
...
var ViewSerialDetailsComponent = /** @class */ (function () {
    function ViewSerialDetailsComponent(ajaxService, modalController) {
        this.ajaxService = ajaxService;
        this.modalController = modalController;
    }
    ViewSerialDetailsComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    ViewSerialDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + '/sensorise/getSensoriseSerialNoImeiNo?companyid=' + localStorage.getItem('corpId') + '&serialno=' + this.value;
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.tableData = res;
            _this.renderer = function (row, column, value) {
                if (value == "" || null || undefined || value == ",") {
            ...
            _this.dataAdapter = new jqx.dataAdapter(_this.source);
            _this.columns = [
                { text: 'Iccid Number', datafield: 'iccidno', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Imei Number', datafield: 'imei', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
            ];
        });
    };
    ViewSerialDetailsComponent.ctorParameters = function () { return [
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return ViewSerialDetailsComponent;
}());
...
var ViewSerialdetailComponent = /** @class */ (function () {
    function ViewSerialdetailComponent(ajaxService, modalController) {
        this.ajaxService = ajaxService;
        this.modalController = modalController;
    }
    ViewSerialdetailComponent.prototype.cancelBtn = function () {
        this.modalController.dismiss();
    };
    ViewSerialdetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + '/sensorise/getSensoriseSerialNoInvoiceNo?companyid=' + localStorage.getItem('corpId') + '&invoiceno=' + this.value;
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.tableData = res;
            _this.renderer = function (row, column, value) {
                if (value == "" || null || undefined || value == ",") {
            ...
            _this.columns = [
                { text: 'Invoice Number', datafield: 'invoiceno', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'Serial Number', datafield: 'serialno', cellsrenderer: _this.renderer, cellsalign: 'center', align: 'center' },
                { text: 'View Detail', datafield: 'View Detail', columntype: 'button', cellsalign: 'center', align: 'center',
                    cellsrenderer: function () {
                        return 'View Detail';
                    },
    ...
    ViewSerialdetailComponent.prototype.viewModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ViewSerialdetailComponent.prototype.myGridOnRowSelect = function (event) {
        this.selectedRow = event.args.row;
    };
    ViewSerialdetailComponent.ctorParameters = function () { return [
        { type: src_app_services_ajax_service__WEBPACK_IMPORTED_MODULE_4__["AjaxService"] },
        { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return ViewSerialdetailComponent;
}());
...
//# sourceMappingURL=sales-detail-sales-detail-module-es5.js.map