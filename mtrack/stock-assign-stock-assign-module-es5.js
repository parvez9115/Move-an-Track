...
var DealerDetailsComponent = /** @class */ (function () {
    function DealerDetailsComponent(modalController, ajaxService, router, commonService, alertController) {
    ...
    DealerDetailsComponent.prototype.closeModal = function () {
    ...
    DealerDetailsComponent.prototype.removeCheckedFromArray = function (checkbox) {
        return this.selectedArray.findIndex(function (category) {
            return category === checkbox;
        });
    };
    DealerDetailsComponent.prototype.updateAnswer = function (event, index, name, company) {
        this.companyID = name;
        this.assign(company.name);
    };
    DealerDetailsComponent.prototype.assign = function (name) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var text, alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                        ...
                                        handler: function (confirm) {
                                            ...
                                            _this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) {
                                                ...
                                                if (responseData.message == "updated") {
                                                    ...
                                                    _this.modalController.dismiss("Updated Successfully");
                                                }
                                            });
                                        },
                                    },
...
var StockAssignPageModule = /** @class */ (function () {
    function StockAssignPageModule() {
    }
...
var StockAssignPage = /** @class */ (function () {
    function StockAssignPage(platform, modalController, alertController, commonService, ajaxService) {
    ...
    StockAssignPage.prototype.typeSelector = function (data) {
        var _this = this;
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/global/getImeiNoDetail";
        this.ajaxService.ajaxPostWithBody(url, companySuffix).subscribe(function (res) {
            _this.showList = res;
    ...
    StockAssignPage.prototype.openModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var arr, i, modal, text, alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        text = "Are you sure? You want to re-assign this stock to your company ";
                        return [4 /*yield*/, this.alertController.create({
                                header: "Assign Stock",
                                backdropDismiss: false,
                                message: text,
                                buttons: [
                                    ...
                                    },
                                    {
                                        text: "Confirm",
                                        handler: function (confirm) {
                                            for (var i = 0; i < _this.selectedRow.length; i++) {
                                                var currentSuffix = localStorage.getItem("companySuffix");
                                                var data = {
                                                    fromDelar: _this.myGrid["attrSource"]["originaldata"][_this.selectedRow[i]].currentAgency,
                                                    toDelar: _this.myGrid["attrSource"]["originaldata"][_this.selectedRow[i]].previousAgency,
                                                    imeiNo: [
                                                        _this.myGrid["attrSource"]["originaldata"][_this.selectedRow[i]].imei,
                                                    ],
                                                };
                                                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/simcard/update/asset/manager";
                                                _this.ajaxService.ajaxPostMethod(url, data).subscribe(function (res) {
    ...
    StockAssignPage.prototype.getDelar = function () {
        var _this = this;
        var suffix = localStorage.getItem("companySuffix");
        var companyUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["serverUrl"].web + "/global/getdealerlist?suffix=" + suffix;
        this.ajaxService.ajaxGet(companyUrl).subscribe(function (res) {
            _this.companyList = res;
        });
    };
    StockAssignPage.prototype.getDatas = function () {
    ...
    StockAssignPage.prototype.myGridOnRowSelect = function (event) {
    ...
    StockAssignPage.prototype.ngOnInit = function () { };
    StockAssignPage.prototype.ionViewWillEnter = function () {
        this.showList = [];
        this.companyList;
    ...
    StockAssignPage.ctorParameters = function () { return [
...
var SearchDealerStockPipe = /** @class */ (function () {
    function SearchDealerStockPipe() {
    }
    SearchDealerStockPipe.prototype.transform = function (items, terms) {
        if (!items)
            return [];
        if (!terms)
            return items;
...
//# sourceMappingURL=stock-assign-stock-assign-module-es5.js.map