...
var WhitelistingDetailsPageModule = /** @class */ (function () {
    function WhitelistingDetailsPageModule() {
    }
    ...
    return WhitelistingDetailsPageModule;
}());
...
/* harmony import */ var jqwidgets_ng_jqxgrid__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! jqwidgets-ng/jqxgrid */ "./node_modules/jqwidgets-ng/fesm5/jqwidgets-ng-jqxgrid.js");
...
var WhitelistingDetailsPage = /** @class */ (function () {
    function WhitelistingDetailsPage(platform, formBuilder, ajaxService, commonService, ete) {
    ...
    WhitelistingDetailsPage.prototype.createForm = function () {
    ...
    WhitelistingDetailsPage.prototype.clear = function () {
        this.whitelistform.patchValue({
            fileupload: "",
            dealername: "",
        });
    };
    WhitelistingDetailsPage.prototype.dealer = function () {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web + "/global/getesimdealerlist";
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this.dealerlist = res;
        });
    };
    WhitelistingDetailsPage.prototype.onFileChange = function (ev) {
        var _this = this;
    ...
    WhitelistingDetailsPage.prototype.submit = function () {
        var _this = this;
            ...
            if (this.name == true && this.excellKeyValid == true) {
                ...
                this.ajaxService
                    ...
                    if (Object.keys(res).length == 0) {
                        _this.commonService.showConfirm("Invalid ICCID No");
                        _this.clear();
                        _this.button = false;
                    }
                    else {
                        ...
                        _this.ete.exportExcel(reportData);
                        _this.button = false;
                        _this.clear();
                    }
                });
    ...
    WhitelistingDetailsPage.prototype.getdatas = function () {
        this.show = false;
    ...
    WhitelistingDetailsPage.prototype.myGridOnRowclick = function (event) {
        this.selectedRow = event.args.row.bounddata;
    };
    WhitelistingDetailsPage.prototype.ngOnInit = function () {
    ...
    WhitelistingDetailsPage.ctorParameters = function () { return [
    ...
    return WhitelistingDetailsPage;
}());
...
//# sourceMappingURL=whitelisting-details-whitelisting-details-module-es5.js.map