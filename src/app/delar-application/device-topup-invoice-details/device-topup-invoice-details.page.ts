...
@Component({
  ...
  templateUrl: "./device-topup-invoice-details.page.html",
  styleUrls: ["./device-topup-invoice-details.page.scss"],
})
export class DeviceTopupInvoiceDetailsPage implements OnInit {
    ...
    if (this.topupinvoiceForm.value.fileupload == "") {
      ...
      if (this.dataString.length == 0) {
        ...
        if (this.name == true && this.excellKeyValid == true) {
          ...
          const url = serverUrl.web + "/esim/saveEsimTopupInvoiceHeader";
