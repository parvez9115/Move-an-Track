...
var AlertsModalPage = /** @class */ (function () {
    function AlertsModalPage(modalController) {
        this.modalController = modalController;
        this.totalAlert = 0;
        this.showSearch = false;
        this.initialHeader = true;
    }
    AlertsModalPage.prototype.searchActivity = function (task) {
        if (task == "open") {
    ...
    AlertsModalPage.prototype.totalAlerts = function (event) {
        this.totalAlert = event;
    };
    AlertsModalPage.prototype.scroll = function (event) {
    ...
    AlertsModalPage.prototype.getBack = function () {
        this.modalController.dismiss();
    };
    AlertsModalPage.prototype.ngOnInit = function () {
    ...
    AlertsModalPage.ctorParameters = function () { return [
...
var GridFilterPage = /** @class */ (function () {
    function GridFilterPage(platform, modalController, menuController) {
        this.platform = platform;
        this.modalController = modalController;
        this.menuController = menuController;
    }
    GridFilterPage.prototype.getBack = function (final) {
        if (final == 'close') {
            localStorage.removeItem('modalFilterData');
        }
        this.modalController.dismiss();
    };
    GridFilterPage.prototype.ionViewWillLeave = function () {
        this.subscription.unsubscribe();
    };
    GridFilterPage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    GridFilterPage.ctorParameters = function () { return [
...
var GridviewTabPageModule = /** @class */ (function () {
    function GridviewTabPageModule() {
    }
    ...
    // }
    GridviewTabPageModule.prototype.ngOnInit = function () {
    ...
    return GridviewTabPageModule;
}());

var ActionModePageModule = /** @class */ (function () {
    function ActionModePageModule() {
    }
    return ActionModePageModule;
}());

var AlertsModalPageModule = /** @class */ (function () {
    function AlertsModalPageModule() {
    }
    return AlertsModalPageModule;
}());
...
var GridviewTabPage = /** @class */ (function () {
    function GridviewTabPage(router, ajaxService, commonService, activatedRoute, menuController, modalController, platform, websocketService) {
        this.router = router;
    ...
    GridviewTabPage.prototype.showModal = function (data) {
    ...
    GridviewTabPage.prototype.hideModal = function () {
        document.getElementById("modal").style.bottom = "-280px";
    };
    GridviewTabPage.prototype.scroll = function (event) {
        if (event.detail.scrollTop > 0) {
            this.initialHeader = false;
        }
        else {
    ...
    GridviewTabPage.prototype.searchActivity = function (task) {
        if (task == "open") {
            this.showSearch = true;
        }
        else {
    ...
    GridviewTabPage.prototype.handleChange = function (value) {
        this.searchInput = value.detail.value;
    };
    GridviewTabPage.prototype.dashboardCountLoader = function () {
        if (src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["storageVariable"].upDatedJsonData) {
            var data = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["storageVariable"].upDatedJsonData;
            this.vehicleCount = data.statusCount;
            this.statusBarOthers = Object.keys(this.vehicleCount);
        }
    };
    GridviewTabPage.prototype.vehicleAlert = function (event) {
        this.totalAlertCount = event;
    };
    GridviewTabPage.prototype.openModalAddAsset = function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function () {
                            _this.websocketService.reSendRequest(JSON.parse(localStorage.dashboardWebSocketData));
                        });
    ...
    GridviewTabPage.prototype.changeGridView = function (data) {
        this.filter = [];
        if (data) {
            if (data.count > 0) {
                localStorage.removeItem("modalFilterData");
    ...
    //gokul model
    GridviewTabPage.prototype.openModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var today, hours, modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        today = new Date();
    ...
    GridviewTabPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        ...
        this.ajaxService.ajaxGet(url).subscribe(function (res) {
            ...
            if (!JSON.parse(localStorage.getItem("SubscriptionDate")) &&
                _this.VehicleDetails.message == "Expired") {
                _this.openModel();
            }
            else if (currenttime >= parseInt(_this.VehicleDetails.interval)) {
                //  var oldDate = JSON.parse(localStorage.getItem('SubscriptionDate'));
                _this.openModel();
            }
        });
    };
    GridviewTabPage.prototype.temperature = function () {
        this.filter = [];
        this.temperatureData = !this.temperatureData;
        this.data = localStorage.getItem("statusChanger");
    };
    GridviewTabPage.prototype.ngOnInit = function () {
        this.companyDetail = {
    ...
    GridviewTabPage.ctorParameters = function () { return [
...
var VtsgridComponent = /** @class */ (function () {
    function VtsgridComponent(websocketService, commonService, router, mapService, activatedRoute, ajaxService, modalController, socialSharing, clipboard, websocketliveService, platform, menuController, firebaseX, device, udid, network, alertController, appVersion, authenticationService, market) {
        var _this = this;
        this.websocketService = websocketService;
        this.commonService = commonService;
        this.router = router;
        ...
        this.updateCache = function () {
            if (_this.cacheAddress && _this.liveDatas) {
                Object.keys(_this.cacheAddress).forEach(function (vin) {
                    _this.liveDatas[vin]["location"] = _this.cacheAddress[vin];
                });
            }
        ...
        this.addressResult = function (type) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/];
            });
        }); };
        this.loadMoreData = function (event) {
            setTimeout(function () {
                ...
                var data = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData;
        ...
        this.getLiveTrackIcon = function (color, path) {
        ...
        this.successCallback = function (res, outputRouter) {
            if (res) {
                ...
                if (validation) {
                    ...
                    _this.chartAndSummaryCard();
                }
                else {
                    _this.commonService.presentToast("No data available");
                    _this.executiveCard = res;
    ...
    VtsgridComponent.prototype.bellRouter = function () {
        this.router.navigateByUrl("/tabs/alerts/All");
    };
    VtsgridComponent.prototype.swipeNext = function () {
        this.slides.slideTo(9, 500);
    };
    VtsgridComponent.prototype.swipePrevious = function () {
        this.slides.slideTo(0, 500);
    };
    VtsgridComponent.prototype.wsResponse = function (res) {
        if (this.commonService.isLoading) {
            // this.commonService.dismissLoader();
            this.loader = false;
        }
        if (res.hasOwnProperty("mode")) {
            var latlngList = res.locations;
            ...
            if (data) {
                ...
                var data_1 = Object.entries(this.updatedJsonData.liveDatas)
                    .map(function (_a) {
                    var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](_a, 2), key = _b[0], value = _b[1];
                    return value["status"] || "No Transmission";
                })
                    .sort();
                var current = null;
                var cnt = 0;
                ...
                for (var i = 0; i < Object.keys(res.statusCount).length; i++) {
                    if (!data_1.includes(Object.keys(res.statusCount)[i]) &&
                ...
                if (this.myPlatform != "desktop") {
                    ...
                    var data_2 = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData;
                    this.vehicleCount = data_2.statusCount;
                    this.statusBarOthers = Object.keys(this.vehicleCount);
                }
    ...
    VtsgridComponent.prototype.wsOnError = function () {
        var _this = this;
        setTimeout(function () {
    ...
    VtsgridComponent.prototype.openActionModal = function (mode, selectedVin) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    VtsgridComponent.prototype.itemHeightFn = function (item, index) {
        var size = item.icon == "REFRIGERATOR" && item.isTempSensor == false
            ? 90
    ...
    VtsgridComponent.prototype.openAlertsModal = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    VtsgridComponent.prototype.filterRowUpdate = function (statusCount) {
        var backupData = this.dataFilter;
        var countNodata = 0;
        var countRunning = 0;
        for (var x in backupData) {
            for (var w in statusCount) {
    ...
    VtsgridComponent.prototype.initFilterRow = function () {
        if (localStorage.dataFilter) {
            var filterData = localStorage.dataFilter != ""
    ...
    VtsgridComponent.prototype.showModal = function (data) {
        if (this.myPlatform != "desktop") {
            var gridCardOption = JSON.parse(JSON.parse(localStorage.getItem("loginData"))[1].cardmenu);
    ...
    VtsgridComponent.prototype.hideModal = function () {
        this.showSwipeModal = "false";
    };
    VtsgridComponent.prototype.filterGrid = function (typeOfFilter) {
        this.showSkeletonLoader = true;
        if (typeOfFilter == localStorage.filterActive) {
            typeOfFilter = "All";
        }
    };
    VtsgridComponent.prototype.checkSocket = function () {
        var checkSocket = this.websocketService.isAlive("livetrack")
            ? 1
            : 0;
        var checkStorage = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].dashboardData ? 1 : 0;
        var check = checkSocket + "" + checkStorage;
        switch (check) {
            case "11":
    ...
    VtsgridComponent.prototype.identify = function (index, vehicleData) {
        return vehicleData.vin;
    };
    // ngDoCheck() {
    //   //console.log("changes identified")
    // }
    VtsgridComponent.prototype.delay = function (milliseconds) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    VtsgridComponent.prototype.doRefresh = function ($event) {
        this.loader = true;
    ...
    VtsgridComponent.prototype.openModel = function () { };
    VtsgridComponent.prototype.openGridModel = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function () { return _this.filterPage(null); });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    VtsgridComponent.prototype.returnFilterAndSort = function () {
        if (localStorage.modalFilterData) {
            this.manualFilter = JSON.parse(localStorage.modalFilterData);
        }
    };
    VtsgridComponent.prototype.filterPage = function (selected) {
        if (localStorage.modalFilterData) {
            this.manualFilter = JSON.parse(localStorage.modalFilterData);
        }
        else {
            ...
            var filter = Object.values(src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData["liveDatas"]);
    ...
    VtsgridComponent.prototype.loadExternalScript = function () {
        var _this = this;
        return new Promise(function (resolve) {
            var scriptElement = document.createElement("script");
            scriptElement.src =
                "https://maps.googleapis.com/maps/api/js?key=" +
                    _this.applicationSettings.GoogleMapKey;
            scriptElement.className = "googleMap";
            scriptElement.id = _this.applicationSettings.GoogleMapKey;
            scriptElement.onload = resolve;
            document.body.appendChild(scriptElement);
        });
    };
    VtsgridComponent.prototype.copyLinkClip = function () {
        var latlng = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData["liveDatas"][this.selectedVin.vin];
    ...
    VtsgridComponent.prototype.navigateToGoogle = function () {
        var latlng = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData["liveDatas"][this.selectedVin.vin];
    ...
    VtsgridComponent.prototype.shareLocation = function () {
        var company;
    ...
    VtsgridComponent.prototype.addMarker = function () {
        if (this.map) {
            this.mapService.clearLayers(this.map, [1, 2]);
            var icon = this.getLiveTrackIcon(this.color[this.selectedVin.status], this.vehicleModel[this.selectedVin.icon.toUpperCase()]);
            var myLatlng = {
    ...
    VtsgridComponent.prototype.todayAlerts = function () {
        var _this = this;
        var localData = this.selectedVin;
        var date = new Date();
        var data = {
            address: "false",
            vin: localData.vin,
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["serverUrl"].web + "/alert/mobileAlert";
        this.ajaxService.ajaxPostWithBody(url, data).subscribe(function (res) {
            //console.log(res);
            if (res != "" && res != []) {
                _this.alertData = res;
                _this.alertCount = res.length;
                _this.NoDataImage = false;
                _this.vehicleAlertCount.emit(_this.alertCount);
            }
            else {
                _this.NoDataImage = true;
                // this.commonService.presentToast("No alerts for this vehicle");
                _this.vehicleAlertCount.emit(0);
                _this.alertCount = 0;
                _this.alertData = [];
            }
        });
    };
    VtsgridComponent.prototype.executiveSummary = function () {
        this.addMarker();
        var body = {};
        var mode;
    ...
    VtsgridComponent.prototype.chartAndSummaryCard = function () {
        ...
        var datas;
        try {
            for (var _d = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](Object.values(this.reportData[0].alertCount)), _e = _d.next(); !_e.done; _e = _d.next()) {
                datas = _e.value;
                addition += datas;
            }
        }
        ...
        try {
            for (var _f = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.format["summary"]), _g = _f.next(); !_g.done; _g = _f.next()) {
                var i = _g.value;
                var obj = {};
                obj["type"] = i.status;
        ...
        for (var i = 0; i < this.reportData.length; i++) {
            var addition_1 = 0, datas_1 = void 0;
            try {
                for (var _h = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](Object.values(this.reportData[i].alertCount)), _j = _h.next(); !_j.done; _j = _h.next()) {
                    datas_1 = _j.value;
                    addition_1 += parseInt(datas_1);
                }
            }
            ...
            this.reportData[i]["totalCount"] = addition_1;
        }
        this.executiveCard = this.reportData[0];
        // this.plateNum =this.executiveCard.plateNo;
        var xAxis = new Array();
        var yAxis = new Array();
        for (var x in this.resultedSummaryList) {
    ...
    VtsgridComponent.prototype.changeGridView = function (data) {
        this.manualFilter = [];
        if (data) {
            if (data.count > 0) {
                localStorage.removeItem("modalFilterData");
    ...
    VtsgridComponent.prototype.changeOtherStatusView = function (data) {
        //console.log(data)
    };
    VtsgridComponent.prototype.openFilter = function (data) {
        if (data == "close") {
            this.filterIconClose = false;
        }
        else if (data == "funnel") {
    ...
    VtsgridComponent.prototype.armoronVehicleModal = function (data) {
    ...
    VtsgridComponent.prototype.armoronVehiclePaint = function (data) {
        var icon = data.icon.toUpperCase();
    ...
    VtsgridComponent.prototype.eventEmmiter = function (data) {
        this.gridView.emit(data);
    };
    VtsgridComponent.prototype.vehicleFunctionClick = function (event) {
        var _this = this;
        var currentPage = this.pageSeleter;
    ...
    VtsgridComponent.prototype.livetrackWeb = function ($event) {
        // this.traveVinData = $event;
    };
    VtsgridComponent.prototype.vehicleAlert = function (event) {
        this.totalAlertCount = event;
    };
    VtsgridComponent.prototype.restartApp = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    VtsgridComponent.prototype.pushNotificationConfig = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var pushDetails;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.platform.ready().then(function (res) {
                    if (_this.platform.is("ios")) {
                        _this.firebaseX.grantPermission().then(function (success) {
                            if (success) {
                            }
                        });
                    }
                    if (_this.network.type !== "none") {
                        if (/(android)/i.test(navigator.userAgent)) {
                            _this.firebaseX
                                ...
                                localStorage.setItem("imeiNo", _this.device.uuid);
                                localStorage.setItem("deviceToken", token);
                                localStorage.setItem("notificationStatus", "true");
                                pushDetails = {
                                    imeiNo: _this.device.uuid,
                                ...
                                //console.log(token);
                                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["serverUrl"].web + "/alert/pushnotification";
                                _this.ajaxService
                                ...
                                _this.commonService.presentToast("Something went wrong!!Push notification won't recieve");
                            });
                        }
                        ...
                        _this.network.onDisconnect().subscribe(function () {
                            ...
                            _this.commonService.presentToast("Poor network connection");
                        });
                    }
                });
                return [2 /*return*/];
    ...
    VtsgridComponent.prototype.armoronFunctionality = function (routerData, vehicle) {
    ...
    VtsgridComponent.prototype.showLocation = function (data) {
        // dt.location = "bhdsh"
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["serverUrl"].web +
    ...
    VtsgridComponent.prototype.backButtonExit = function () {
        if (this.subscription) {
            this.subscription.unsubscribe();
        }
        var thisKey = this;
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(window.location.hash == "#/tabs/gridview/All")) return [3 /*break*/, 3];
                            event.stopImmediatePropagation();
                            event.stopPropagation();
                            event.preventDefault();
    ...
    VtsgridComponent.prototype.gridCardIssueRecursion = function () {
        var _this = this;
        var data = {
            companyID: localStorage.corpId,
            branchID: localStorage.corpId,
        ...
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["serverUrl"].web + "/Dashboarddata/dashboard";
        this.ajaxService.ajaxPostWithBody(url, data).subscribe(function (res) {
            if (res != undefined) {
                ...
                for (var i = 0; i < Object.keys(_this.updatedJsonData.liveDatas).length; i++) {
                    ...
                    data_3.push(currentCount.status);
                    // }
                    Object.values(_this.updatedJsonData.liveDatas)[i]["odometer"] =
                        parseInt(Object.values(_this.updatedJsonData.liveDatas)[i]["odometer"]) / 1000;
                }
                data_3.sort();
                var current = null;
                var cnt = 0;
                ...
                for (var i = 0; i < Object.keys(res.statusCount).length; i++) {
                    if (!data_3.includes(Object.keys(res.statusCount)[i]) &&
                        Object.keys(res.statusCount)[i] != "Total") {
                        res.statusCount[Object.keys(res.statusCount)[i]] = 0;
                    }
                }
                ...
                res["statusCount"]["Total"] = Object.keys(res.liveDatas).length;
                src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].dashboardData = _this.updatedJsonData;
                src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData = _this.updatedJsonData;
                if (_this.liveDatas) {
                    ...
                    _this.initFilterRow();
                    _this.showSkeletonLoader = false;
                }
                res["statusCount"]["Total"] = Object.keys(_this.updatedJsonData.liveDatas).length;
                src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].dashboardData = _this.updatedJsonData;
                src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData = _this.updatedJsonData;
                _this.updateCache();
                _this.addressResult("websocketUpdate");
                if (_this.myPlatform != "desktop") {
                    _this.headerValue.emit(JSON.stringify(res));
                }
                else {
                    var data_4 = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData;
                    _this.vehicleCount = data_4.statusCount;
                    _this.statusBarOthers = Object.keys(_this.vehicleCount);
                    if (Object.values(_this.updatedJsonData.liveDatas)[0])
                        _this.selectedVin = Object.values(_this.updatedJsonData.liveDatas)[0];
                    localStorage.setItem("selectedVin", JSON.stringify(_this.selectedVin));
                    _this.addMarker();
                    _this.todayAlerts();
                    if (_this.gridCardOption[_this.selectedVin.icon] == null) {
                        _this.executiveSummary();
                    }
                }
            }
            else {
    ...
    VtsgridComponent.prototype.serverTest = function () {
        var _this = this;
        this.ajaxService
    ...
    VtsgridComponent.prototype.appUpdate = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var currentVersion, appSettingsVersion, alert_2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!/(android|iPhone|iPad|iPod)/i.test(navigator.userAgent)) return [3 /*break*/, 3];
                        if (!localStorage.appSettings) return [3 /*break*/, 3];
                        currentVersion = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["app"].appVersion;
                        appSettingsVersion = JSON.parse(localStorage.appSettings)["appComVersion"][src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["app"].appName];
                        if (!(appSettingsVersion > currentVersion)) return [3 /*break*/, 3];
                                ...
                                buttons: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (data) {
                                            ...
                                            _this.market.open(src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["app"].package);
                                        },
                                    },
                                ],
                            })];
    ...
    VtsgridComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.appUpdate();
        ...
        this.router.events.subscribe(function (event) {
            _this.watchFilter = false;
            _this.batteryStatusFilter = false;
            _this.gsmStatusFilter = false;
            _this.transmissionFilter = false;
            _this.gpsFilter = false;
            _this.subscriptionFilter = false;
            if (_this.filterValue === "Vin") {
                _this.statusGrid = JSON.parse(localStorage.getItem("vinGridViewData")).data;
            }
            else {
                _this.statusGrid = [];
            }
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_5__["NavigationStart"]) {
                if (event.url.indexOf("gridview") !== -1) {
                    _this.websocketService.setProductService(_this);
                    _this.checkSocket();
                    _this.addressResult("websocketUpdate");
                }
                else {
                    ...
                    if (_this.websocketService.isAlive("livetrack")) {
                        // this.websocketService.disConnectSocket("livetrack");
                        //console.log("left from router");
                    }
                    if (_this.websocketService.isAlive("alertsmanagerendpoint")) {
                        _this.websocketService.disConnectSocket("alertsmanagerendpoint");
                    }
                }
            }
            if (_this.myPlatform == "desktop" && localStorage.gridData != "[]") {
                // new changes by gokul
                // this.count = Object.values(JSON.parse(localStorage.dashboardData)["liveDatas"]).length
                var data = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["storageVariable"].upDatedJsonData;
                _this.vehicleCount = data.statusCount;
                _this.statusBarOthers = Object.keys(_this.vehicleCount);
                // upto this
                _this.gridCardOption = JSON.parse(JSON.parse(localStorage.getItem("loginData"))[1].cardmenu);
                if (_this.pageSeleter == "gridview") {
                    _this.selectedVin = JSON.parse(localStorage.gridData)[0];
                    localStorage.setItem("selectedVin", JSON.stringify(_this.selectedVin));
                    if (_this.map) {
                        _this.addMarker();
                    }
                    if (_this.selectedVin.vin != JSON.parse(localStorage.gridData)[0].vin) {
                        if (_this.gridCardOption[_this.selectedVin.icon] == null)
                            _this.executiveSummary();
                        _this.todayAlerts();
                    }
        ...
        var ele = document.querySelector(".googleMap");
        if (ele === null) {
    ...
    VtsgridComponent.ctorParameters = function () { return [
...
var FilterPipe = /** @class */ (function () {
    ...
    FilterPipe.prototype.transform = function (items, terms, count, statusGrid, manualFilter) {
        if (!items)
            return [];
        if (terms) {
            if (manualFilter.length > 0) {
                ...
                if (terms !== "All" && terms !== "Vin") {
                    ...
                    for (var i = 0; i < statusGrid.length; i++) {
                        _loop_1(i);
                    }
                    data = vinData_1;
                }
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var queueing_subject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! queueing-subject */ "./node_modules/queueing-subject/lib.es5m/index.js");
...
var WebsocketliveService = /** @class */ (function () {
    function WebsocketliveService(webSocketInstance) {
        this.webSocketInstance = webSocketInstance;
        this.input$ = new queueing_subject__WEBPACK_IMPORTED_MODULE_2__["QueueingSubject"]();
    }
    WebsocketliveService.prototype.setProductService = function (ws) {
        this.webSocketInstance = ws;
    };
    WebsocketliveService.prototype.isAlive = function (type) {
        var status = false;
    ...
    //       }
    //     }
    WebsocketliveService.prototype.connectSocket = function (input, type) {
        var _this = this;
        switch (type) {
            case "dashboard":
        ...
        this.subject$.subscribe(function (res) {
            if (_this.webSocketInstance) {
                _this.webSocketInstance.wsResponse(res);
            }
            else {
            ...
            if (_this.webSocketInstance) {
                _this.webSocketInstance.wsOnError();
            }
            console.log(err);
        }, function (close) {
            console.log("Websocket closed");
    ...
    WebsocketliveService.prototype.reSendRequest = function (input) {
        this.subject$.next(input);
    };
    ;
    WebsocketliveService.prototype.disConnectSocket = function (type) {
        // let subject : any;
        // if(type = 'dashboard'){
    ...
    WebsocketliveService.ctorParameters = function () { return [
...
//# sourceMappingURL=gridview-tab-gridview-tab-module-es5.js.map