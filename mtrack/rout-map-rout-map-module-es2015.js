...
let RoutMapPageModule = class RoutMapPageModule {
};
...
let RoutMapPage = class RoutMapPage {
    ...
    constructor(location, ajaxService, router, commonService) {
    ...
    getRoutesDatas() {
        ...
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["serverUrl"].web +
...
//# sourceMappingURL=rout-map-rout-map-module-es2015.js.map